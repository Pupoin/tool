...
int plot3()
{
  ...
  chain_70->Project("hist_70", "ht");
  chain_100->Project("hist_100", "ht");
  chain_200->Project("hist_200", "ht");
  chain_400->Project("hist_400", "ht");
  chain_600->Project("hist_600", "ht");
  chain_800->Project("hist_800", "ht");
  chain_1200->Project("hist_1200", "ht");
  chain_2500->Project("hist_2500", "ht");
  chain_inclusive->Project("hist_inclusive", "ht");
...
double factor[9] ={1314.157819 , 1411.051147 , 414.652901 , 58.93422 , 15.348104 , 7.016852 , 1.738243 , 0.041597 , 3344.844953 };
  ...
  hist_binned->Draw("HIST");
  hist_inclusive->Draw("e same");
  // hist_inclusive->SetMarkerStyle(kFullCircle);

  // hist_70->Draw("HIST same");
  // hist_100->Draw("HIST same");
  // hist_200->Draw("ht>>hist_200 same");
  // hist_400->Draw("ht>>hist_400 same");
  // hist_600->Draw("ht>>hist_600 same");
  // hist_800->Draw("ht>>hist_800 same");
  // hist_1200->Draw("ht>>hist_1200 same");
  // hist_2500->Draw("ht>>hist_2500 same");
  ...
  canv->SaveAs("/stash/user/zhyuan/public/svg/stiching_inclusive3_265_wjet_ht.svg");
