...
int plot_Gen_HT()
{
     ...
     chain_0j->Add("../anaHTRoot/0j_*root");
     chain_1j->Add("../anaHTRoot/1j_*root");
     chain_2j->Add("../anaHTRoot/2j_*root");
     chain_inclusive->Add("../anaHTRoot/012j_*root");
    ...
    // hist_binned->SetBinError(nbins, erroverflow);
     ...
     hstack->GetXaxis()->SetNdivisions(110);
     ...
     canv->SaveAs("/stash/user/zhyuan/public/svg/nanogen_265_Gen_HT.svg");
