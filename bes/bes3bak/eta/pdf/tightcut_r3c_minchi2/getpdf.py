...
cut_sig = "(M_BC_r3c>=2.25) &&  (chi2_min_r3c<17 && np!=0 && npbar !=0 )"
cut_ref = "(M_BC_r3c>=2.25) &&  (chi2_min_r3c<17 && np!=0 && npbar !=0 ) && (dipim<0.44 || dipim>0.52)"
...
can.Divide(2, 7)
sig_fileDirPath="/publicfs/ucas/user/yuanchy8/7.0.6/eta/shape_new/cutmassroot/tightcut_r3c_minchi2/"
...
# for i in range(0, 1):
    ...
    wspace_sig.writeToFile(sig_fileDirPath + "../../../pdf/tightcut_r3c_minchi2//{}_sig_shapepdf.root".format(str(energy[i])))
