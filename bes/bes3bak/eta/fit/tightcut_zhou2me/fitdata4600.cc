...
int fitdata4600()
{
  ...
  // TCut cut_mass = "(etam>0.5&&etam<0.56 && pi0m>0.115&&pi0m<0.15 && sigmam>1.174&&sigmam<1.2 && etam>0.946 && etam<0.968)";
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/data/cutmassroot/tightcut_zhou2me/4600data_removedouble.root");
  ...
  RooRealVar sigma("sigma", "sigma", 8.4505e-06, -0.0, 0.001);
  RooRealVar mean("mean", "mean", 0, -0.0001, 0.0001);
