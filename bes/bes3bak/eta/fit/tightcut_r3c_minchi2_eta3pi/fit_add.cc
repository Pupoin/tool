...
int fit_add()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/data/cutmassroot/tightcut_r3c_minchi2_eta3pi/*selB.root");
  TTree *tree_cut = chain_data->CopyTree(cut_sum1, "", 100000000, 0);
    
  TChain *chain_data_nominal = new TChain("tree");
  chain_data_nominal->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/data/cutmassroot/tightcut_r3c_minchi2/data.root");
  TTree *tree_cut_nominal = chain_data_nominal->CopyTree(cut_mbc && "(chi2_min_r3c< 17) " && cut_np , "", 100000000, 0);
