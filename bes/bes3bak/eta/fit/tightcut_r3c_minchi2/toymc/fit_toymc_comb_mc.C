...
RooRealVar Bratio("Bratio", "Br of sig/ref", 0.464912, 0.3, 0.6);	
...
// int fit_toymc_comb()
{
    ...
    // orignal
    RooRealVar mean_all_toy("mean_all", "mean_all",  8.3358e-05 );
    RooRealVar sigma_all_toy("sigma_all", "sigma_all",  2.9431e-04);
    ...
    RooRealVar m0_sig_toy("m0_sig", "m0_sig", 2.299765);   RooRealVar c0_sig_toy("c0_sig", "c0_sig", -1.5469e+01 );    RooArgusBG argus0_sig_toy("argus0_sig", "argus0 sig", *var_4600, m0_sig_toy, c0_sig_toy);
    RooRealVar m1_sig_toy("m1_sig", "m1_sig", 2.30579);    RooRealVar c1_sig_toy("c1_sig", "c1_sig", -1.2743e+01 );    RooArgusBG argus1_sig_toy("argus1_sig", "argus1 sig", *var_4612, m1_sig_toy, c1_sig_toy);
    RooRealVar m2_sig_toy("m2_sig", "m2_sig", 2.31387);    RooRealVar c2_sig_toy("c2_sig", "c2_sig", -7.6351e+00 );    RooArgusBG argus2_sig_toy("argus2_sig", "argus2 sig", *var_4620, m2_sig_toy, c2_sig_toy);
    RooRealVar m3_sig_toy("m3_sig", "m3_sig", 2.320255);   RooRealVar c3_sig_toy("c3_sig", "c3_sig", -8.0365e+00 );    RooArgusBG argus3_sig_toy("argus3_sig", "argus3 sig", *var_4640, m3_sig_toy, c3_sig_toy);
    RooRealVar m4_sig_toy("m4_sig", "m4_sig", 2.33046);    RooRealVar c4_sig_toy("c4_sig", "c4_sig", -2.9408e+00 );    RooArgusBG argus4_sig_toy("argus4_sig", "argus4 sig", *var_4660, m4_sig_toy, c4_sig_toy);
    RooRealVar m5_sig_toy("m5_sig", "m5_sig", 2.34079);    RooRealVar c5_sig_toy("c5_sig", "c5_sig", -3.9057e+00 );    RooArgusBG argus5_sig_toy("argus5_sig", "argus5 sig", *var_4680, m5_sig_toy, c5_sig_toy);
    RooRealVar m6_sig_toy("m6_sig", "m6_sig", 2.34919);    RooRealVar c6_sig_toy("c6_sig", "c6_sig",  7.2880e-02 );    RooArgusBG argus6_sig_toy("argus6_sig", "argus6 sig", *var_4700, m6_sig_toy, c6_sig_toy);

    // ____________________ sig argus background 3pi
    RooRealVar m0_3pi_sig_toy("m0_3pi_sig", "m0_3pi_sig", 2.299765);   RooRealVar c0_3pi_sig_toy("c0_3pi_sig", "c0_3pi_sig",  7.2304e+00);    RooArgusBG argus0_3pi_sig_toy("argus0_3pi_sig", "argus0 _3pi sig", *var_4600, m0_3pi_sig_toy, c0_3pi_sig_toy);
    RooRealVar m1_3pi_sig_toy("m1_3pi_sig", "m1_3pi_sig", 2.30579);    RooRealVar c1_3pi_sig_toy("c1_3pi_sig", "c1_3pi_sig", -5.1479e+00);    RooArgusBG argus1_3pi_sig_toy("argus1_3pi_sig", "argus1 _3pi sig", *var_4612, m1_3pi_sig_toy, c1_3pi_sig_toy);
    RooRealVar m2_3pi_sig_toy("m2_3pi_sig", "m2_3pi_sig", 2.31387);    RooRealVar c2_3pi_sig_toy("c2_3pi_sig", "c2_3pi_sig",  3.1108e-01);    RooArgusBG argus2_3pi_sig_toy("argus2_3pi_sig", "argus2 _3pi sig", *var_4620, m2_3pi_sig_toy, c2_3pi_sig_toy);
    RooRealVar m3_3pi_sig_toy("m3_3pi_sig", "m3_3pi_sig", 2.320255);   RooRealVar c3_3pi_sig_toy("c3_3pi_sig", "c3_3pi_sig",  6.0674e-01);    RooArgusBG argus3_3pi_sig_toy("argus3_3pi_sig", "argus3 _3pi sig", *var_4640, m3_3pi_sig_toy, c3_3pi_sig_toy);
    RooRealVar m4_3pi_sig_toy("m4_3pi_sig", "m4_3pi_sig", 2.33046);    RooRealVar c4_3pi_sig_toy("c4_3pi_sig", "c4_3pi_sig",  1.3072e+00);    RooArgusBG argus4_3pi_sig_toy("argus4_3pi_sig", "argus4 _3pi sig", *var_4660, m4_3pi_sig_toy, c4_3pi_sig_toy);
    RooRealVar m5_3pi_sig_toy("m5_3pi_sig", "m5_3pi_sig", 2.34079);    RooRealVar c5_3pi_sig_toy("c5_3pi_sig", "c5_3pi_sig",  6.1658e-01);    RooArgusBG argus5_3pi_sig_toy("argus5_3pi_sig", "argus5 _3pi sig", *var_4680, m5_3pi_sig_toy, c5_3pi_sig_toy);
    RooRealVar m6_3pi_sig_toy("m6_3pi_sig", "m6_3pi_sig", 2.34919);    RooRealVar c6_3pi_sig_toy("c6_3pi_sig", "c6_3pi_sig", -4.0673e+00);    RooArgusBG argus6_3pi_sig_toy("argus6_3pi_sig", "argus6 _3pi sig", *var_4700, m6_3pi_sig_toy, c6_3pi_sig_toy);


    // ____________________ ref argus background
    RooRealVar m0_toy("m0", "m0", 2.299765);   RooRealVar c0_toy("c0", "c0", -7.8705e+00 );    RooArgusBG argus0_toy("argus0", "argus0", *var_4600, m0_toy, c0_toy);
    RooRealVar m1_toy("m1", "m1", 2.30579);    RooRealVar c1_toy("c1", "c1", -1.2432e+01 );    RooArgusBG argus1_toy("argus1", "argus1", *var_4612, m1_toy, c1_toy);
    RooRealVar m2_toy("m2", "m2", 2.31387);    RooRealVar c2_toy("c2", "c2", -9.2376e+00 );    RooArgusBG argus2_toy("argus2", "argus2", *var_4620, m2_toy, c2_toy);
    RooRealVar m3_toy("m3", "m3", 2.320255);   RooRealVar c3_toy("c3", "c3", -5.1768e+00 );    RooArgusBG argus3_toy("argus3", "argus3", *var_4640, m3_toy, c3_toy);
    RooRealVar m4_toy("m4", "m4", 2.33046);    RooRealVar c4_toy("c4", "c4", -1.5620e+00 );    RooArgusBG argus4_toy("argus4", "argus4", *var_4660, m4_toy, c4_toy);
    RooRealVar m5_toy("m5", "m5", 2.34079);    RooRealVar c5_toy("c5", "c5", -2.0249e+00 );    RooArgusBG argus5_toy("argus5", "argus5", *var_4680, m5_toy, c5_toy);
    RooRealVar m6_toy("m6", "m6", 2.34919);    RooRealVar c6_toy("c6", "c6", -2.1848e+00 );    RooArgusBG argus6_toy("argus6", "argus6", *var_4700, m6_toy, c6_toy);

    // ____________________ ref signal and bkg num
    RooRealVar nsig_mode0_toy("nsig_mode0_toy", "signal of mode0", 1.0516e+03  );    RooRealVar nbkg0_toy("nbkg0_toy", "bkg number of mode0", 5.2813e+02   );
    RooRealVar nsig_mode1_toy("nsig_mode1_toy", "signal of mode1", 1.7659e+02  );    RooRealVar nbkg1_toy("nbkg1_toy", "bkg number of mode1", 1.0814e+02   );	
    RooRealVar nsig_mode2_toy("nsig_mode2_toy", "signal of mode2", 9.0248e+02  );    RooRealVar nbkg2_toy("nbkg2_toy", "bkg number of mode2", 6.3922e+02   );
    RooRealVar nsig_mode3_toy("nsig_mode3_toy", "signal of mode3", 8.9494e+02  );    RooRealVar nbkg3_toy("nbkg3_toy", "bkg number of mode3", 7.6330e+02   );
    RooRealVar nsig_mode4_toy("nsig_mode4_toy", "signal of mode4", 9.4095e+02  );    RooRealVar nbkg4_toy("nbkg4_toy", "bkg number of mode4", 6.8434e+02   );
    RooRealVar nsig_mode5_toy("nsig_mode5_toy", "signal of mode5", 2.6676e+03  );    RooRealVar nbkg5_toy("nbkg5_toy", "bkg number of mode5", 2.6189e+03   );
    RooRealVar nsig_mode6_toy("nsig_mode6_toy", "signal of mode6", 7.7493e+02  );    RooRealVar nbkg6_toy("nbkg6_toy", "bkg number of mode6", 8.8479e+02   );
    ...
    RooRealVar Bratio_toy("Bratio_toy", "Br of sig/ref", 0.464912);	

    // sig sig num
    RooFormulaVar nsig_mode0_sig_toy("nsig_mode0_sig_toy", "signal of mode0 sig", "Bratio_toy * nsig_mode0_toy* 0.200845266  *0.0927/  0.503631863  /0.0991", RooArgSet(Bratio_toy, nsig_mode0_toy ));	RooRealVar nbkg0_sig_toy("nbkg0_sig", "bkg number of mode0 sig", 3.9786e+02 );
    RooFormulaVar nsig_mode1_sig_toy("nsig_mode1_sig_toy", "signal of mode1 sig", "Bratio_toy * nsig_mode1_toy* 0.200845266  *0.0908/  0.503631863  /0.0979", RooArgSet(Bratio_toy, nsig_mode1_toy ));	RooRealVar nbkg1_sig_toy("nbkg1_sig", "bkg number of mode1 sig", 7.8462e+01 );
    RooFormulaVar nsig_mode2_sig_toy("nsig_mode2_sig_toy", "signal of mode2 sig", "Bratio_toy * nsig_mode2_toy* 0.200845266  *0.0884/  0.503631863  /0.0964", RooArgSet(Bratio_toy, nsig_mode2_toy ));	RooRealVar nbkg2_sig_toy("nbkg2_sig", "bkg number of mode2 sig", 4.5524e+02 );
    RooFormulaVar nsig_mode3_sig_toy("nsig_mode3_sig_toy", "signal of mode3 sig", "Bratio_toy * nsig_mode3_toy* 0.200845266  *0.0875/  0.503631863  /0.0952", RooArgSet(Bratio_toy, nsig_mode3_toy ));	RooRealVar nbkg3_sig_toy("nbkg3_sig", "bkg number of mode3 sig", 5.1480e+02 );
    RooFormulaVar nsig_mode4_sig_toy("nsig_mode4_sig_toy", "signal of mode4 sig", "Bratio_toy * nsig_mode4_toy* 0.200845266  *0.0851/  0.503631863  /0.0951", RooArgSet(Bratio_toy, nsig_mode4_toy ));	RooRealVar nbkg4_sig_toy("nbkg4_sig", "bkg number of mode4 sig", 5.4021e+02 );
    RooFormulaVar nsig_mode5_sig_toy("nsig_mode5_sig_toy", "signal of mode5 sig", "Bratio_toy * nsig_mode5_toy* 0.200845266  *0.0830/  0.503631863  /0.0922", RooArgSet(Bratio_toy, nsig_mode5_toy ));	RooRealVar nbkg5_sig_toy("nbkg5_sig", "bkg number of mode5 sig", 1.8085e+03 );
    RooFormulaVar nsig_mode6_sig_toy("nsig_mode6_sig_toy", "signal of mode6 sig", "Bratio_toy * nsig_mode6_toy* 0.200845266  *0.0808/  0.503631863  /0.0919", RooArgSet(Bratio_toy, nsig_mode6_toy ));	RooRealVar nbkg6_sig_toy("nbkg6_sig", "bkg number of mode6 sig", 6.0410e+02 );
    // 3pi
    RooFormulaVar nsig_mode0_3pi_sig_toy("nsig_mode0_3pi_sig_toy", "signal of mode0_3pi sig", "Bratio_toy * nsig_mode0_toy* 0.115432423  *0.0444/  0.503631863  /0.0991", RooArgSet(Bratio_toy, nsig_mode0_toy ));	RooRealVar nbkg0_3pi_sig_toy("nbkg0_3pi_sig", "bkg number of mode0_3pi sig", 9.8139e+01);
    RooFormulaVar nsig_mode1_3pi_sig_toy("nsig_mode1_3pi_sig_toy", "signal of mode1_3pi sig", "Bratio_toy * nsig_mode1_toy* 0.115432423  *0.0418/  0.503631863  /0.0979", RooArgSet(Bratio_toy, nsig_mode1_toy ));	RooRealVar nbkg1_3pi_sig_toy("nbkg1_3pi_sig", "bkg number of mode1_3pi sig", 1.8308e+01);
    RooFormulaVar nsig_mode2_3pi_sig_toy("nsig_mode2_3pi_sig_toy", "signal of mode2_3pi sig", "Bratio_toy * nsig_mode2_toy* 0.115432423  *0.0407/  0.503631863  /0.0964", RooArgSet(Bratio_toy, nsig_mode2_toy ));	RooRealVar nbkg2_3pi_sig_toy("nbkg2_3pi_sig", "bkg number of mode2_3pi sig", 1.0149e+02);
    RooFormulaVar nsig_mode3_3pi_sig_toy("nsig_mode3_3pi_sig_toy", "signal of mode3_3pi sig", "Bratio_toy * nsig_mode3_toy* 0.115432423  *0.0398/  0.503631863  /0.0952", RooArgSet(Bratio_toy, nsig_mode3_toy ));	RooRealVar nbkg3_3pi_sig_toy("nbkg3_3pi_sig", "bkg number of mode3_3pi sig", 1.2808e+02);
    RooFormulaVar nsig_mode4_3pi_sig_toy("nsig_mode4_3pi_sig_toy", "signal of mode4_3pi sig", "Bratio_toy * nsig_mode4_toy* 0.115432423  *0.0390/  0.503631863  /0.0951", RooArgSet(Bratio_toy, nsig_mode4_toy ));	RooRealVar nbkg4_3pi_sig_toy("nbkg4_3pi_sig", "bkg number of mode4_3pi sig", 1.2075e+02);
    RooFormulaVar nsig_mode5_3pi_sig_toy("nsig_mode5_3pi_sig_toy", "signal of mode5_3pi sig", "Bratio_toy * nsig_mode5_toy* 0.115432423  *0.0375/  0.503631863  /0.0922", RooArgSet(Bratio_toy, nsig_mode5_toy ));	RooRealVar nbkg5_3pi_sig_toy("nbkg5_3pi_sig", "bkg number of mode5_3pi sig", 3.5061e+02);
    RooFormulaVar nsig_mode6_3pi_sig_toy("nsig_mode6_3pi_sig_toy", "signal of mode6_3pi sig", "Bratio_toy * nsig_mode6_toy* 0.115432423  *0.0370/  0.503631863  /0.0919", RooArgSet(Bratio_toy, nsig_mode6_toy ));	RooRealVar nbkg6_3pi_sig_toy("nbkg6_3pi_sig", "bkg number of mode6_3pi sig", 1.3619e+02);
    ...
    double times = randm->Rndm()*5;
    cout << "rand seed and times are : " <<  seed << " " << times << endl ;
    RooRandom::randomGenerator()->SetSeed(seed);

    RooDataSet *data0_sig = model0_sig_toy->generate(*var_4600, (182.429    + 397.864)     * times); //  new RooDataSet("data0_sig"," M_BC_r3c", tr_fit0_sig, RooArgSet(*var_4600));
    RooDataSet *data1_sig = model1_sig_toy->generate(*var_4612, (30.3725    + 78.4616)      * times); //  new RooDataSet("data1_sig", "M_BC_r3c", tr_fit1_sig, RooArgSet(*var_4612));
    RooDataSet *data2_sig = model2_sig_toy->generate(*var_4620, (153.474    + 455.244)    * times); //  new RooDataSet("data2_sig", "M_BC_r3c", tr_fit2_sig, RooArgSet(*var_4620));
    RooDataSet *data3_sig = model3_sig_toy->generate(*var_4640, (152.54    +  514.795)     * times); //  new RooDataSet("data3_sig", "M_BC_r3c", tr_fit3_sig, RooArgSet(*var_4640));
    RooDataSet *data4_sig = model4_sig_toy->generate(*var_4660, (156.147    + 540.207)      * times); //  new RooDataSet("data4_sig", "M_BC_r3c", tr_fit4_sig, RooArgSet(*var_4660));
    RooDataSet *data5_sig = model5_sig_toy->generate(*var_4680, (445.342    + 1808.46)      * times); //  new RooDataSet("data5_sig", "M_BC_r3c", tr_fit5_sig, RooArgSet(*var_4680));
    RooDataSet *data6_sig = model6_sig_toy->generate(*var_4700, (126.351    + 604.104)       * times); //  new RooDataSet("data6_sig", "M_BC_r3c", tr_fit6_sig, RooArgSet(*var_4700));

    // sig  eta3pi
    RooDataSet *data0_3pi_sig = model0_3pi_sig_toy->generate(*var_4600, ( 50.8164 + 98.1394)    * times); //  new RooDataSet("data0_sig"," M_BC_r3c", tr_fit0_sig, RooArgSet(*var_4600));
    RooDataSet *data1_3pi_sig = model1_3pi_sig_toy->generate(*var_4612, ( 8.13166 + 18.3085)   * times); //  new RooDataSet("data1_sig", "M_BC_r3c", tr_fit1_sig, RooArgSet(*var_4612));
    RooDataSet *data2_3pi_sig = model2_3pi_sig_toy->generate(*var_4620, ( 41.0946 + 101.493)    * times); //  new RooDataSet("data2_sig", "M_BC_r3c", tr_fit2_sig, RooArgSet(*var_4620));
    RooDataSet *data3_3pi_sig = model3_3pi_sig_toy->generate(*var_4640, ( 40.3523 + 128.084)    * times); //  new RooDataSet("data3_sig", "M_BC_r3c", tr_fit3_sig, RooArgSet(*var_4640));
    RooDataSet *data4_3pi_sig = model4_3pi_sig_toy->generate(*var_4660, ( 41.6177 + 120.753)    * times); //  new RooDataSet("data4_sig", "M_BC_r3c", tr_fit4_sig, RooArgSet(*var_4660));
    RooDataSet *data5_3pi_sig = model5_3pi_sig_toy->generate(*var_4680, ( 117.019 + 350.606)    * times); //  new RooDataSet("data5_sig", "M_BC_r3c", tr_fit5_sig, RooArgSet(*var_4680));
    RooDataSet *data6_3pi_sig = model6_3pi_sig_toy->generate(*var_4700, ( 33.6494 + 136.193)    * times); //  new RooDataSet("data6_sig", "M_BC_r3c", tr_fit6_sig, RooArgSet(*var_4700));


    RooDataSet *data0 = model0_toy->generate(*var_4600, (1051.64 + 528.127)   * times); // RooDataSet("data0", "M_BC_r3c", tr_fit0, RooArgSet(*var_4600));
    RooDataSet *data1 = model1_toy->generate(*var_4612, (176.586 + 108.144)   * times); // RooDataSet("data1", "M_BC_r3c", tr_fit1, RooArgSet(*var_4612));
    RooDataSet *data2 = model2_toy->generate(*var_4620, (902.482 + 639.224)   * times); // RooDataSet("data2", "M_BC_r3c", tr_fit2, RooArgSet(*var_4620));
    RooDataSet *data3 = model3_toy->generate(*var_4640, (894.939 + 763.301)  * times); // RooDataSet("data3", "M_BC_r3c", tr_fit3, RooArgSet(*var_4640));
    RooDataSet *data4 = model4_toy->generate(*var_4660, (940.947 + 684.34)   * times); // RooDataSet("data4", "M_BC_r3c", tr_fit4, RooArgSet(*var_4660));
    RooDataSet *data5 = model5_toy->generate(*var_4680, (2667.63 + 2618.95)   * times); // RooDataSet("data5", "M_BC_r3c", tr_fit5, RooArgSet(*var_4680));
    RooDataSet *data6 = model6_toy->generate(*var_4700, (774.929 + 884.785)   * times); // RooDataSet("data6", "M_BC_r3c", tr_fit6, RooArgSet(*var_4700));
