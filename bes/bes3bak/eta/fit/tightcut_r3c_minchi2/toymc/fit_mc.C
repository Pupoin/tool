...
RooRealVar Bratio("Bratio", "Br of sig/ref", 0.476, 0.3, 0.7);	
...
int fit_mc()
{
    ...
    // auto cutcut_io = "rndm<" + to_string(0.05*(io+1)) +  " && rndm>=" + to_string(0.05*io);
    auto cutcut_io = "rndm<0.5 && rndm>=0.3";
    // auto 
