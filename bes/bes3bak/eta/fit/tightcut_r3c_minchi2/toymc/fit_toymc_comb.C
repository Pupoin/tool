...
// int fit_toymc_comb()
{
    ...
    // orignal
    RooRealVar mean_all_toy("mean_all", "mean_all",  -1.1819e-04 );
    RooRealVar sigma_all_toy("sigma_all", "sigma_all",  2.3426e-04);
    ...
    RooRealVar m0_sig_toy("m0_sig", "m0_sig", 2.299765);   RooRealVar c0_sig_toy("c0_sig", "c0_sig", -8.5483e+00 );    RooArgusBG argus0_sig_toy("argus0_sig", "argus0 sig", *var_4600, m0_sig_toy, c0_sig_toy);
    RooRealVar m1_sig_toy("m1_sig", "m1_sig", 2.30579);    RooRealVar c1_sig_toy("c1_sig", "c1_sig", -1.1077e+01 );    RooArgusBG argus1_sig_toy("argus1_sig", "argus1 sig", *var_4612, m1_sig_toy, c1_sig_toy);
    RooRealVar m2_sig_toy("m2_sig", "m2_sig", 2.31387);    RooRealVar c2_sig_toy("c2_sig", "c2_sig", -7.1385e+00 );    RooArgusBG argus2_sig_toy("argus2_sig", "argus2 sig", *var_4620, m2_sig_toy, c2_sig_toy);
    RooRealVar m3_sig_toy("m3_sig", "m3_sig", 2.320255);   RooRealVar c3_sig_toy("c3_sig", "c3_sig", -4.7328e+00 );    RooArgusBG argus3_sig_toy("argus3_sig", "argus3 sig", *var_4640, m3_sig_toy, c3_sig_toy);
    RooRealVar m4_sig_toy("m4_sig", "m4_sig", 2.33046);    RooRealVar c4_sig_toy("c4_sig", "c4_sig", -1.7973e+01 );    RooArgusBG argus4_sig_toy("argus4_sig", "argus4 sig", *var_4660, m4_sig_toy, c4_sig_toy);
    RooRealVar m5_sig_toy("m5_sig", "m5_sig", 2.34079);    RooRealVar c5_sig_toy("c5_sig", "c5_sig", -1.0189e+01 );    RooArgusBG argus5_sig_toy("argus5_sig", "argus5 sig", *var_4680, m5_sig_toy, c5_sig_toy);
    RooRealVar m6_sig_toy("m6_sig", "m6_sig", 2.34919);    RooRealVar c6_sig_toy("c6_sig", "c6_sig", -7.7700e+00 );    RooArgusBG argus6_sig_toy("argus6_sig", "argus6 sig", *var_4700, m6_sig_toy, c6_sig_toy);

    // ____________________ sig argus background 3pi
    RooRealVar m0_3pi_sig_toy("m0_3pi_sig", "m0_3pi_sig", 2.299765);   RooRealVar c0_3pi_sig_toy("c0_3pi_sig", "c0_3pi_sig", -5.1633e+00);    RooArgusBG argus0_3pi_sig_toy("argus0_3pi_sig", "argus0 _3pi sig", *var_4600, m0_3pi_sig_toy, c0_3pi_sig_toy);
    ...
    RooRealVar m2_3pi_sig_toy("m2_3pi_sig", "m2_3pi_sig", 2.31387);    RooRealVar c2_3pi_sig_toy("c2_3pi_sig", "c2_3pi_sig",  3.0619e+01);    RooArgusBG argus2_3pi_sig_toy("argus2_3pi_sig", "argus2 _3pi sig", *var_4620, m2_3pi_sig_toy, c2_3pi_sig_toy);
    RooRealVar m3_3pi_sig_toy("m3_3pi_sig", "m3_3pi_sig", 2.320255);   RooRealVar c3_3pi_sig_toy("c3_3pi_sig", "c3_3pi_sig",  1.1056e+01);    RooArgusBG argus3_3pi_sig_toy("argus3_3pi_sig", "argus3 _3pi sig", *var_4640, m3_3pi_sig_toy, c3_3pi_sig_toy);
    RooRealVar m4_3pi_sig_toy("m4_3pi_sig", "m4_3pi_sig", 2.33046);    RooRealVar c4_3pi_sig_toy("c4_3pi_sig", "c4_3pi_sig",  9.6180e+00);    RooArgusBG argus4_3pi_sig_toy("argus4_3pi_sig", "argus4 _3pi sig", *var_4660, m4_3pi_sig_toy, c4_3pi_sig_toy);
    RooRealVar m5_3pi_sig_toy("m5_3pi_sig", "m5_3pi_sig", 2.34079);    RooRealVar c5_3pi_sig_toy("c5_3pi_sig", "c5_3pi_sig", -3.4276e-01);    RooArgusBG argus5_3pi_sig_toy("argus5_3pi_sig", "argus5 _3pi sig", *var_4680, m5_3pi_sig_toy, c5_3pi_sig_toy);
    RooRealVar m6_3pi_sig_toy("m6_3pi_sig", "m6_3pi_sig", 2.34919);    RooRealVar c6_3pi_sig_toy("c6_3pi_sig", "c6_3pi_sig",  1.4460e+01);    RooArgusBG argus6_3pi_sig_toy("argus6_3pi_sig", "argus6 _3pi sig", *var_4700, m6_3pi_sig_toy, c6_3pi_sig_toy);


    // ____________________ ref argus background
    RooRealVar m0_toy("m0", "m0", 2.299765);   RooRealVar c0_toy("c0", "c0", -2.3865e+00 );    RooArgusBG argus0_toy("argus0", "argus0", *var_4600, m0_toy, c0_toy);
    RooRealVar m1_toy("m1", "m1", 2.30579);    RooRealVar c1_toy("c1", "c1",  2.8215e+01 );    RooArgusBG argus1_toy("argus1", "argus1", *var_4612, m1_toy, c1_toy);
    RooRealVar m2_toy("m2", "m2", 2.31387);    RooRealVar c2_toy("c2", "c2",  2.7186e+00 );    RooArgusBG argus2_toy("argus2", "argus2", *var_4620, m2_toy, c2_toy);
    RooRealVar m3_toy("m3", "m3", 2.320255);   RooRealVar c3_toy("c3", "c3", -6.8193e+00 );    RooArgusBG argus3_toy("argus3", "argus3", *var_4640, m3_toy, c3_toy);
    RooRealVar m4_toy("m4", "m4", 2.33046);    RooRealVar c4_toy("c4", "c4", -1.7627e+00 );    RooArgusBG argus4_toy("argus4", "argus4", *var_4660, m4_toy, c4_toy);
    RooRealVar m5_toy("m5", "m5", 2.34079);    RooRealVar c5_toy("c5", "c5", -4.9006e+00 );    RooArgusBG argus5_toy("argus5", "argus5", *var_4680, m5_toy, c5_toy);
    RooRealVar m6_toy("m6", "m6", 2.34919);    RooRealVar c6_toy("c6", "c6", -6.4396e+00 );    RooArgusBG argus6_toy("argus6", "argus6", *var_4700, m6_toy, c6_toy);

    // ____________________ ref signal and bkg num
    RooRealVar nsig_mode0_toy("nsig_mode0_toy", "signal of mode0", 1.2720e+02  );    RooRealVar nbkg0_toy("nbkg0_toy", "bkg number of mode0", 1.1542e+02   );
    RooRealVar nsig_mode1_toy("nsig_mode1_toy", "signal of mode1", 2.0334e+01  );    RooRealVar nbkg1_toy("nbkg1_toy", "bkg number of mode1", 2.8921e+01   );	
    RooRealVar nsig_mode2_toy("nsig_mode2_toy", "signal of mode2", 1.0686e+02  );    RooRealVar nbkg2_toy("nbkg2_toy", "bkg number of mode2", 1.3181e+02   );
    RooRealVar nsig_mode3_toy("nsig_mode3_toy", "signal of mode3", 1.0021e+02  );    RooRealVar nbkg3_toy("nbkg3_toy", "bkg number of mode3", 1.6870e+02   );
    RooRealVar nsig_mode4_toy("nsig_mode4_toy", "signal of mode4", 1.1450e+02  );    RooRealVar nbkg4_toy("nbkg4_toy", "bkg number of mode4", 1.7537e+02   );
    RooRealVar nsig_mode5_toy("nsig_mode5_toy", "signal of mode5", 3.1216e+02  );    RooRealVar nbkg5_toy("nbkg5_toy", "bkg number of mode5", 6.4073e+02   );
    RooRealVar nsig_mode6_toy("nsig_mode6_toy", "signal of mode6", 8.9333e+01  );    RooRealVar nbkg6_toy("nbkg6_toy", "bkg number of mode6", 1.9845e+02   );
    ...
    RooRealVar Bratio_toy("Bratio_toy", "Br of sig/ref", 0.305185);	

    // sig sig num
    RooFormulaVar nsig_mode0_sig_toy("nsig_mode0_sig_toy", "signal of mode0 sig", "Bratio_toy * nsig_mode0_toy* 0.200845266  *0.0927/  0.503631863  /0.0991", RooArgSet(Bratio_toy, nsig_mode0_toy ));	RooRealVar nbkg0_sig_toy("nbkg0_sig", "bkg number of mode0 sig", 8.0145e+01 );
    RooFormulaVar nsig_mode1_sig_toy("nsig_mode1_sig_toy", "signal of mode1 sig", "Bratio_toy * nsig_mode1_toy* 0.200845266  *0.0908/  0.503631863  /0.0979", RooArgSet(Bratio_toy, nsig_mode1_toy ));	RooRealVar nbkg1_sig_toy("nbkg1_sig", "bkg number of mode1 sig", 1.0341e+01 );
    RooFormulaVar nsig_mode2_sig_toy("nsig_mode2_sig_toy", "signal of mode2 sig", "Bratio_toy * nsig_mode2_toy* 0.200845266  *0.0884/  0.503631863  /0.0964", RooArgSet(Bratio_toy, nsig_mode2_toy ));	RooRealVar nbkg2_sig_toy("nbkg2_sig", "bkg number of mode2 sig", 8.3908e+01 );
    RooFormulaVar nsig_mode3_sig_toy("nsig_mode3_sig_toy", "signal of mode3 sig", "Bratio_toy * nsig_mode3_toy* 0.200845266  *0.0875/  0.503631863  /0.0952", RooArgSet(Bratio_toy, nsig_mode3_toy ));	RooRealVar nbkg3_sig_toy("nbkg3_sig", "bkg number of mode3 sig", 8.1907e+01 );
    RooFormulaVar nsig_mode4_sig_toy("nsig_mode4_sig_toy", "signal of mode4 sig", "Bratio_toy * nsig_mode4_toy* 0.200845266  *0.0851/  0.503631863  /0.0951", RooArgSet(Bratio_toy, nsig_mode4_toy ));	RooRealVar nbkg4_sig_toy("nbkg4_sig", "bkg number of mode4 sig", 9.5973e+01 );
    RooFormulaVar nsig_mode5_sig_toy("nsig_mode5_sig_toy", "signal of mode5 sig", "Bratio_toy * nsig_mode5_toy* 0.200845266  *0.0830/  0.503631863  /0.0922", RooArgSet(Bratio_toy, nsig_mode5_toy ));	RooRealVar nbkg5_sig_toy("nbkg5_sig", "bkg number of mode5 sig", 3.3740e+02 );
    RooFormulaVar nsig_mode6_sig_toy("nsig_mode6_sig_toy", "signal of mode6 sig", "Bratio_toy * nsig_mode6_toy* 0.200845266  *0.0808/  0.503631863  /0.0919", RooArgSet(Bratio_toy, nsig_mode6_toy ));	RooRealVar nbkg6_sig_toy("nbkg6_sig", "bkg number of mode6 sig", 1.0633e+02 );
    // 3pi
    RooFormulaVar nsig_mode0_3pi_sig_toy("nsig_mode0_3pi_sig_toy", "signal of mode0_3pi sig", "Bratio_toy * nsig_mode0_toy* 0.115432423  *0.0444/  0.503631863  /0.0991", RooArgSet(Bratio_toy, nsig_mode0_toy ));	RooRealVar nbkg0_3pi_sig_toy("nbkg0_3pi_sig", "bkg number of mode0_3pi sig", 1.8767e+01);
    RooFormulaVar nsig_mode1_3pi_sig_toy("nsig_mode1_3pi_sig_toy", "signal of mode1_3pi sig", "Bratio_toy * nsig_mode1_toy* 0.115432423  *0.0418/  0.503631863  /0.0979", RooArgSet(Bratio_toy, nsig_mode1_toy ));	RooRealVar nbkg1_3pi_sig_toy("nbkg1_3pi_sig", "bkg number of mode1_3pi sig", 1.5007e+00);
    RooFormulaVar nsig_mode2_3pi_sig_toy("nsig_mode2_3pi_sig_toy", "signal of mode2_3pi sig", "Bratio_toy * nsig_mode2_toy* 0.115432423  *0.0407/  0.503631863  /0.0964", RooArgSet(Bratio_toy, nsig_mode2_toy ));	RooRealVar nbkg2_3pi_sig_toy("nbkg2_3pi_sig", "bkg number of mode2_3pi sig", 1.1342e+01);
    RooFormulaVar nsig_mode3_3pi_sig_toy("nsig_mode3_3pi_sig_toy", "signal of mode3_3pi sig", "Bratio_toy * nsig_mode3_toy* 0.115432423  *0.0398/  0.503631863  /0.0952", RooArgSet(Bratio_toy, nsig_mode3_toy ));	RooRealVar nbkg3_3pi_sig_toy("nbkg3_3pi_sig", "bkg number of mode3_3pi sig", 1.9039e+01);
    RooFormulaVar nsig_mode4_3pi_sig_toy("nsig_mode4_3pi_sig_toy", "signal of mode4_3pi sig", "Bratio_toy * nsig_mode4_toy* 0.115432423  *0.0390/  0.503631863  /0.0951", RooArgSet(Bratio_toy, nsig_mode4_toy ));	RooRealVar nbkg4_3pi_sig_toy("nbkg4_3pi_sig", "bkg number of mode4_3pi sig", 1.1404e+01);
    RooFormulaVar nsig_mode5_3pi_sig_toy("nsig_mode5_3pi_sig_toy", "signal of mode5_3pi sig", "Bratio_toy * nsig_mode5_toy* 0.115432423  *0.0375/  0.503631863  /0.0922", RooArgSet(Bratio_toy, nsig_mode5_toy ));	RooRealVar nbkg5_3pi_sig_toy("nbkg5_3pi_sig", "bkg number of mode5_3pi sig", 4.4628e+01);
    RooFormulaVar nsig_mode6_3pi_sig_toy("nsig_mode6_3pi_sig_toy", "signal of mode6_3pi sig", "Bratio_toy * nsig_mode6_toy* 0.115432423  *0.0370/  0.503631863  /0.0919", RooArgSet(Bratio_toy, nsig_mode6_toy ));	RooRealVar nbkg6_3pi_sig_toy("nbkg6_3pi_sig", "bkg number of mode6_3pi sig", 1.6812e+01);
    ...
    double times = randm->Rndm() ;
    cout << "rand seed and times are : " <<  seed << " " << times << endl ;
    RooRandom::randomGenerator()->SetSeed(seed);

    RooDataSet *data0_sig = model0_sig_toy->generate(*var_4600, (14.4813  + 80.1446)     * times); //  new RooDataSet("data0_sig"," M_BC_r3c", tr_fit0_sig, RooArgSet(*var_4600));
    RooDataSet *data1_sig = model1_sig_toy->generate(*var_4612, (2.29533  + 10.3414)      * times); //  new RooDataSet("data1_sig", "M_BC_r3c", tr_fit1_sig, RooArgSet(*var_4612));
    RooDataSet *data2_sig = model2_sig_toy->generate(*var_4620, (11.926  + 83.9076)    * times); //  new RooDataSet("data2_sig", "M_BC_r3c", tr_fit2_sig, RooArgSet(*var_4620));
    RooDataSet *data3_sig = model3_sig_toy->generate(*var_4640, (11.2097  + 81.9071)     * times); //  new RooDataSet("data3_sig", "M_BC_r3c", tr_fit3_sig, RooArgSet(*var_4640));
    RooDataSet *data4_sig = model4_sig_toy->generate(*var_4660, (12.4699  + 95.9729)      * times); //  new RooDataSet("data4_sig", "M_BC_r3c", tr_fit4_sig, RooArgSet(*var_4660));
    RooDataSet *data5_sig = model5_sig_toy->generate(*var_4680, (34.2006  + 337.401)      * times); //  new RooDataSet("data5_sig", "M_BC_r3c", tr_fit5_sig, RooArgSet(*var_4680));
    RooDataSet *data6_sig = model6_sig_toy->generate(*var_4700, (9.55912  + 106.329)       * times); //  new RooDataSet("data6_sig", "M_BC_r3c", tr_fit6_sig, RooArgSet(*var_4700));

    // sig  eta3pi
    RooDataSet *data0_3pi_sig = model0_3pi_sig_toy->generate(*var_4600, ( 3.98637 + 1.8767e+01)    * times); //  new RooDataSet("data0_sig"," M_BC_r3c", tr_fit0_sig, RooArgSet(*var_4600));
    RooDataSet *data1_3pi_sig = model1_3pi_sig_toy->generate(*var_4612, ( 0.607297 + 1.5007e+00)   * times); //  new RooDataSet("data1_sig", "M_BC_r3c", tr_fit1_sig, RooArgSet(*var_4612));
    RooDataSet *data2_3pi_sig = model2_3pi_sig_toy->generate(*var_4620, ( 3.15575 + 1.1342e+01)    * times); //  new RooDataSet("data2_sig", "M_BC_r3c", tr_fit2_sig, RooArgSet(*var_4620));
    RooDataSet *data3_3pi_sig = model3_3pi_sig_toy->generate(*var_4640, ( 2.93046 + 1.9039e+01)    * times); //  new RooDataSet("data3_sig", "M_BC_r3c", tr_fit3_sig, RooArgSet(*var_4640));
    RooDataSet *data4_3pi_sig = model4_3pi_sig_toy->generate(*var_4660, ( 3.28445 + 1.1404e+01)    * times); //  new RooDataSet("data4_sig", "M_BC_r3c", tr_fit4_sig, RooArgSet(*var_4660));
    RooDataSet *data5_3pi_sig = model5_3pi_sig_toy->generate(*var_4680, ( 8.88083 + 4.4628e+01)    * times); //  new RooDataSet("data5_sig", "M_BC_r3c", tr_fit5_sig, RooArgSet(*var_4680));
    RooDataSet *data6_3pi_sig = model6_3pi_sig_toy->generate(*var_4700, ( 2.51579 + 1.6812e+01)    * times); //  new RooDataSet("data6_sig", "M_BC_r3c", tr_fit6_sig, RooArgSet(*var_4700));


    RooDataSet *data0 = model0_toy->generate(*var_4600, (127.201+115.42)   * times); // RooDataSet("data0", "M_BC_r3c", tr_fit0, RooArgSet(*var_4600));
    RooDataSet *data1 = model1_toy->generate(*var_4612, (20.3343+28.9209)   * times); // RooDataSet("data1", "M_BC_r3c", tr_fit1, RooArgSet(*var_4612));
    RooDataSet *data2 = model2_toy->generate(*var_4620, (106.858+131.81)   * times); // RooDataSet("data2", "M_BC_r3c", tr_fit2, RooArgSet(*var_4620));
    RooDataSet *data3 = model3_toy->generate(*var_4640, (100.21+ 168.703)  * times); // RooDataSet("data3", "M_BC_r3c", tr_fit3, RooArgSet(*var_4640));
    RooDataSet *data4 = model4_toy->generate(*var_4660, (114.499+175.37)   * times); // RooDataSet("data4", "M_BC_r3c", tr_fit4, RooArgSet(*var_4660));
    RooDataSet *data5 = model5_toy->generate(*var_4680, (312.159+640.731)   * times); // RooDataSet("data5", "M_BC_r3c", tr_fit5, RooArgSet(*var_4680));
    RooDataSet *data6 = model6_toy->generate(*var_4700, (89.3326+198.452)   * times); // RooDataSet("data6", "M_BC_r3c", tr_fit6, RooArgSet(*var_4700));
