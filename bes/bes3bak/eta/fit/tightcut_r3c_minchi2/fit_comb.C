...
int fit_comb()
{
    ...
    RooFormulaVar nsig_mode0_sig("nsig_mode0_sig", "signal of mode0 sig", "Bratio * nsig_mode0* 0.200845266  *0.0927/  0.503631863  /0.0991", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", 0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries());
    RooFormulaVar nsig_mode1_sig("nsig_mode1_sig", "signal of mode1 sig", "Bratio * nsig_mode1* 0.200845266  *0.0908/  0.503631863  /0.0979", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", 0.05 * tr_fit1_sig->GetEntries(), 0, 1.2 * tr_fit1_sig->GetEntries());
    RooFormulaVar nsig_mode2_sig("nsig_mode2_sig", "signal of mode2 sig", "Bratio * nsig_mode2* 0.200845266  *0.0884/  0.503631863  /0.0964", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", 0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries());
    RooFormulaVar nsig_mode3_sig("nsig_mode3_sig", "signal of mode3 sig", "Bratio * nsig_mode3* 0.200845266  *0.0875/  0.503631863  /0.0952", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", 0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries());
    RooFormulaVar nsig_mode4_sig("nsig_mode4_sig", "signal of mode4 sig", "Bratio * nsig_mode4* 0.200845266  *0.0851/  0.503631863  /0.0951", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", 0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries());
    RooFormulaVar nsig_mode5_sig("nsig_mode5_sig", "signal of mode5 sig", "Bratio * nsig_mode5* 0.200845266  *0.0830/  0.503631863  /0.0922", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", 0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries());
    RooFormulaVar nsig_mode6_sig("nsig_mode6_sig", "signal of mode6 sig", "Bratio * nsig_mode6* 0.200845266  *0.0808/  0.503631863  /0.0919", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", 0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries());
    // 3pi
    RooFormulaVar nsig_mode0_3pi_sig("nsig_mode0_3pi_sig", "signal of mode0_3pi sig", "Bratio * nsig_mode0* 0.115432423  *0.0444/  0.503631863  /0.0991", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_3pi_sig("nbkg0_3pi_sig", "bkg number of mode0_3pi sig", 0.05 * tr_fit0_3pi_sig->GetEntries(), 0, 1.2 * tr_fit0_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode1_3pi_sig("nsig_mode1_3pi_sig", "signal of mode1_3pi sig", "Bratio * nsig_mode1* 0.115432423  *0.0418/  0.503631863  /0.0979", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_3pi_sig("nbkg1_3pi_sig", "bkg number of mode1_3pi sig", 0.05 * tr_fit1_3pi_sig->GetEntries(), 0, 1.2 * tr_fit1_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode2_3pi_sig("nsig_mode2_3pi_sig", "signal of mode2_3pi sig", "Bratio * nsig_mode2* 0.115432423  *0.0407/  0.503631863  /0.0964", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_3pi_sig("nbkg2_3pi_sig", "bkg number of mode2_3pi sig", 0.05 * tr_fit2_3pi_sig->GetEntries(), 0, 1.2 * tr_fit2_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode3_3pi_sig("nsig_mode3_3pi_sig", "signal of mode3_3pi sig", "Bratio * nsig_mode3* 0.115432423  *0.0398/  0.503631863  /0.0952", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_3pi_sig("nbkg3_3pi_sig", "bkg number of mode3_3pi sig", 0.05 * tr_fit3_3pi_sig->GetEntries(), 0, 1.2 * tr_fit3_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode4_3pi_sig("nsig_mode4_3pi_sig", "signal of mode4_3pi sig", "Bratio * nsig_mode4* 0.115432423  *0.0390/  0.503631863  /0.0951", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_3pi_sig("nbkg4_3pi_sig", "bkg number of mode4_3pi sig", 0.05 * tr_fit4_3pi_sig->GetEntries(), 0, 1.2 * tr_fit4_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode5_3pi_sig("nsig_mode5_3pi_sig", "signal of mode5_3pi sig", "Bratio * nsig_mode5* 0.115432423  *0.0375/  0.503631863  /0.0922", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_3pi_sig("nbkg5_3pi_sig", "bkg number of mode5_3pi sig", 0.05 * tr_fit5_3pi_sig->GetEntries(), 0, 1.2 * tr_fit5_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode6_3pi_sig("nsig_mode6_3pi_sig", "signal of mode6_3pi sig", "Bratio * nsig_mode6* 0.115432423  *0.0370/  0.503631863  /0.0919", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_3pi_sig("nbkg6_3pi_sig", "bkg number of mode6_3pi sig", 0.05 * tr_fit6_3pi_sig->GetEntries(), 0, 1.2 * tr_fit6_3pi_sig->GetEntries());
    ...
    if(1)
    {
        ...
        TPaveText *pt = new TPaveText(0.96-0.25, 1-0.16-0.15, 0.96, 1-0.16, "blNDC");      
        pt->SetBorderSize(0);
        pt->SetFillColor(0);
        // pt->SetLineColor(5);
        // pt->SetTextColor(5);
        ...
        TPaveText *pt_3pi = new TPaveText(0.96-0.25, 1-0.16-0.17, 0.96, 1-0.16, "blNDC");      
...
cout << __LINE__ << ".........................0................................."<< endl;
    double  nsig_mode0_r =  0.200845266  *0.0927/  0.503631863  /0.0991 ; //", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", 0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries());
    double  nsig_mode1_r =  0.200845266  *0.0908/  0.503631863  /0.0979 ; //", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", 0.05 * tr_fit1_sig->GetEntries(), 0, 1.2 * tr_fit1_sig->GetEntries());
    double  nsig_mode2_r =  0.200845266  *0.0884/  0.503631863  /0.0964 ; //", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", 0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries());
    double  nsig_mode3_r =  0.200845266  *0.0875/  0.503631863  /0.0952 ; //", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", 0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries());
    double  nsig_mode4_r =  0.200845266  *0.0851/  0.503631863  /0.0951 ; //", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", 0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries());
    double  nsig_mode5_r =  0.200845266  *0.0830/  0.503631863  /0.0922 ; //", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", 0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries());
    double  nsig_mode6_r =  0.200845266  *0.0808/  0.503631863  /0.0919 ; //", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", 0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries());
    // 3pi
    double nsig_mode0_3pi_r = 0.115432423  *0.0444/  0.503631863  /0.0991;//", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_3pi_sig("nbkg0_3pi_sig", "bkg number of mode0_3pi sig", 0.05 * tr_fit0_3pi_sig->GetEntries(), 0, 1.2 * tr_fit0_3pi_sig->GetEntries());
    double nsig_mode1_3pi_r = 0.115432423  *0.0418/  0.503631863  /0.0979;//", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_3pi_sig("nbkg1_3pi_sig", "bkg number of mode1_3pi sig", 0.05 * tr_fit1_3pi_sig->GetEntries(), 0, 1.2 * tr_fit1_3pi_sig->GetEntries());
    double nsig_mode2_3pi_r = 0.115432423  *0.0407/  0.503631863  /0.0964;//", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_3pi_sig("nbkg2_3pi_sig", "bkg number of mode2_3pi sig", 0.05 * tr_fit2_3pi_sig->GetEntries(), 0, 1.2 * tr_fit2_3pi_sig->GetEntries());
    double nsig_mode3_3pi_r = 0.115432423  *0.0398/  0.503631863  /0.0952;//", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_3pi_sig("nbkg3_3pi_sig", "bkg number of mode3_3pi sig", 0.05 * tr_fit3_3pi_sig->GetEntries(), 0, 1.2 * tr_fit3_3pi_sig->GetEntries());
    double nsig_mode4_3pi_r = 0.115432423  *0.0390/  0.503631863  /0.0951;//", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_3pi_sig("nbkg4_3pi_sig", "bkg number of mode4_3pi sig", 0.05 * tr_fit4_3pi_sig->GetEntries(), 0, 1.2 * tr_fit4_3pi_sig->GetEntries());
    double nsig_mode5_3pi_r = 0.115432423  *0.0375/  0.503631863  /0.0922;//", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_3pi_sig("nbkg5_3pi_sig", "bkg number of mode5_3pi sig", 0.05 * tr_fit5_3pi_sig->GetEntries(), 0, 1.2 * tr_fit5_3pi_sig->GetEntries());
    double nsig_mode6_3pi_r = 0.115432423  *0.0370/  0.503631863  /0.0919;//", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_3pi_sig("nbkg6_3pi_sig", "bkg number of mode6_3pi sig", 0.05 * tr_fit6_3pi_sig->GetEntries(), 0, 1.2 * tr_fit6_3pi_sig->GetEntries());


    cout << __LINE__ << ", 4600 sig nsig_modec_sig: "<< nsig_mode0_sig.getValV() << " " << nsig_mode0_r* sqrt( pow(Bratio.getVal()*nsig_mode0.getError(),2) +  pow(Bratio.getError()*nsig_mode0.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4612 sig nsig_modec_sig: "<< nsig_mode1_sig.getValV() << " " << nsig_mode1_r* sqrt( pow(Bratio.getVal()*nsig_mode1.getError(),2) +  pow(Bratio.getError()*nsig_mode1.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4620 sig nsig_modec_sig: "<< nsig_mode2_sig.getValV() << " " << nsig_mode2_r* sqrt( pow(Bratio.getVal()*nsig_mode2.getError(),2) +  pow(Bratio.getError()*nsig_mode2.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4640 sig nsig_modec_sig: "<< nsig_mode3_sig.getValV() << " " << nsig_mode3_r* sqrt( pow(Bratio.getVal()*nsig_mode3.getError(),2) +  pow(Bratio.getError()*nsig_mode3.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4660 sig nsig_modec_sig: "<< nsig_mode4_sig.getValV() << " " << nsig_mode4_r* sqrt( pow(Bratio.getVal()*nsig_mode4.getError(),2) +  pow(Bratio.getError()*nsig_mode4.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4680 sig nsig_modec_sig: "<< nsig_mode5_sig.getValV() << " " << nsig_mode5_r* sqrt( pow(Bratio.getVal()*nsig_mode5.getError(),2) +  pow(Bratio.getError()*nsig_mode5.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4700 sig nsig_modec_sig: "<< nsig_mode6_sig.getValV() << " " << nsig_mode6_r* sqrt( pow(Bratio.getVal()*nsig_mode6.getError(),2) +  pow(Bratio.getError()*nsig_mode6.getVal(),2)  ) << endl;
    cout << endl;
    cout << __LINE__ << ", 4600 sig nsig_mode0_3pi_sig: "<< nsig_mode0_3pi_sig.getVal() << " " << nsig_mode0_3pi_r* sqrt( pow(Bratio.getVal()*nsig_mode0.getError(),2) +  pow(Bratio.getError()*nsig_mode0.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4612 sig nsig_mode1_3pi_sig: "<< nsig_mode1_3pi_sig.getVal() << " " << nsig_mode1_3pi_r* sqrt( pow(Bratio.getVal()*nsig_mode1.getError(),2) +  pow(Bratio.getError()*nsig_mode1.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4620 sig nsig_mode2_3pi_sig: "<< nsig_mode2_3pi_sig.getVal() << " " << nsig_mode2_3pi_r* sqrt( pow(Bratio.getVal()*nsig_mode2.getError(),2) +  pow(Bratio.getError()*nsig_mode2.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4640 sig nsig_mode3_3pi_sig: "<< nsig_mode3_3pi_sig.getVal() << " " << nsig_mode3_3pi_r* sqrt( pow(Bratio.getVal()*nsig_mode3.getError(),2) +  pow(Bratio.getError()*nsig_mode3.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4660 sig nsig_mode4_3pi_sig: "<< nsig_mode4_3pi_sig.getVal() << " " << nsig_mode4_3pi_r* sqrt( pow(Bratio.getVal()*nsig_mode4.getError(),2) +  pow(Bratio.getError()*nsig_mode4.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4680 sig nsig_mode5_3pi_sig: "<< nsig_mode5_3pi_sig.getVal() << " " << nsig_mode5_3pi_r* sqrt( pow(Bratio.getVal()*nsig_mode5.getError(),2) +  pow(Bratio.getError()*nsig_mode5.getVal(),2)  ) << endl;
    cout << __LINE__ << ", 4700 sig nsig_mode6_3pi_sig: "<< nsig_mode6_3pi_sig.getVal() << " " << nsig_mode6_3pi_r* sqrt( pow(Bratio.getVal()*nsig_mode6.getError(),2) +  pow(Bratio.getError()*nsig_mode6.getVal(),2)  ) << endl;
...
cout << __LINE__ << ".........................................................."<< endl;
  ...
  //                           nsig_mode4_3pi_sig + 
  //                           nsig_mode5_3pi_sig + 
  //                           nsig_mode6_3pi_sig ).getVal()
  //         << " " << ""
  //         // nsig_mode6_3pi_sig.getPropagatedError(*result, RooArgSet(Bratio, nsig_mode0 )) 
  // << endl;
  
    // sig 3pi
    RooAddPdf *pdfSig_3pi = new RooAddPdf("pdfSig_3pi", "pdfSig_3pi", RooArgList(*sigpdf0_3pi_sig,   *sigpdf1_3pi_sig,  *sigpdf2_3pi_sig, *sigpdf4_3pi_sig, *sigpdf4_3pi_sig, *sigpdf5_3pi_sig, *sigpdf6_3pi_sig ));
    // // sig
    RooAddPdf *pdfSig = new RooAddPdf("pdfSig", "pdfSig", RooArgList(*sigpdf0_sig,   *sigpdf1_sig,  *sigpdf2_sig, *sigpdf4_sig, *sigpdf4_sig, *sigpdf5_sig, *sigpdf6_sig ));

    // RooAbsReal *isig_sigpdf6_3pi_sig = pdfSig_3pi->createIntegral(*var_4700, NormSet(*var_4700)/*, Range("calsignal")*/);

    cout << __LINE__ << "aaaa " << pdfSig_3pi->createIntegral(*var_4700, NormSet(*var_4700))
    //  << " " << pdfSig_3pi->getError()
      << endl;
    // cout << pdfSig->getVal() << " " << pdfSig.getError() << endl;
...
// RooAddPdf *model0_sig = new RooAddPdf("model0_sig", "model0_sig", RooArgList(*sigpdf0_sig, argus0_sig), RooArgList(nsig_mode0_sig, nbkg0_sig));
  ...
  RooAbsReal *isig_sigpdf0_3pi_sig = sigpdf0_3pi_sig->createIntegral(*var_4600, NormSet(*var_4600)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf1_3pi_sig = sigpdf1_3pi_sig->createIntegral(*var_4612, NormSet(*var_4612)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf2_3pi_sig = sigpdf2_3pi_sig->createIntegral(*var_4620, NormSet(*var_4620)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf3_3pi_sig = sigpdf3_3pi_sig->createIntegral(*var_4640, NormSet(*var_4640)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf4_3pi_sig = sigpdf4_3pi_sig->createIntegral(*var_4660, NormSet(*var_4660)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf5_3pi_sig = sigpdf5_3pi_sig->createIntegral(*var_4680, NormSet(*var_4680)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf6_3pi_sig = sigpdf6_3pi_sig->createIntegral(*var_4700, NormSet(*var_4700)/*, Range("calsignal")*/);

  RooAbsReal *isig_sigpdf0_sig = sigpdf0_sig->createIntegral(*var_4600, NormSet(*var_4600)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf1_sig = sigpdf1_sig->createIntegral(*var_4612, NormSet(*var_4612)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf2_sig = sigpdf2_sig->createIntegral(*var_4620, NormSet(*var_4620)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf3_sig = sigpdf3_sig->createIntegral(*var_4640, NormSet(*var_4640)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf4_sig = sigpdf4_sig->createIntegral(*var_4660, NormSet(*var_4660)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf5_sig = sigpdf5_sig->createIntegral(*var_4680, NormSet(*var_4680)/*, Range("calsignal")*/);
  RooAbsReal *isig_sigpdf6_sig = sigpdf6_sig->createIntegral(*var_4700, NormSet(*var_4700)/*, Range("calsignal")*/);
...
double total_sig_sig = 
                    isig_sigpdf0_sig->getVal()*nsig_mode0_sig.getVal()+
                    isig_sigpdf1_sig->getVal()*nsig_mode1_sig.getVal()+
                    isig_sigpdf2_sig->getVal()*nsig_mode2_sig.getVal()+
                    isig_sigpdf3_sig->getVal()*nsig_mode3_sig.getVal()+
                    isig_sigpdf4_sig->getVal()*nsig_mode4_sig.getVal()+
                    isig_sigpdf5_sig->getVal()*nsig_mode5_sig.getVal()+
                    isig_sigpdf6_sig->getVal()*nsig_mode6_sig.getVal();
