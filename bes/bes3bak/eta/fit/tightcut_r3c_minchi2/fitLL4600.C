...
int fitLL4600()
{
  ...
  TCut cut_sum1 = (cut_mbc && cut_chi2 && cut_np && "(dipim<0.44 || dipim>0.52) && (mode2==12 || mode3==12)" );
  

  // get the data ___________________________________
  TChain *chain_data = new TChain("tree");
  //chain_data->Add("4600data.root");
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/4600LL_adddipim.root"); 
  // chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/4600hadron_rmLc.root");
  ...
  // chain_shape->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/shape/cutmassroot/tightcut_r3c/4600shape_removedouble.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4600_sig_shapepdf.root");
  ...
  RooRealVar mean("mean", "mean", 0, -0.00, 0.001);
