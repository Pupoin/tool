...
int fitone()
{
    ...
    TChain *tr_data4_sig = new TChain("tree");	  tr_data4_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/4660LL.root");  tr_data4_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/4660hadron_selB.root");
    TChain *tr_data4_3pi_sig = new TChain("tree");    tr_data4_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/4660LL.root");	tr_data4_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/4660hadron_selB.root");   

    TChain *tr_data4 = new TChain("tree");	  tr_data4->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/4660LL_adddipim.root");      tr_data4->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/4660hadron_selB.root");
    ...
    double Br_sig_inter = 0.199983303; // 0.9880 * 0.5157 * 0.3941
    double Br_sig_3pi_inter = 0.11678006; // 0.5157 * 0.9880 * 0.2292
    double Br_ref_inter = 0.50339746;  // 0.5157 * 0.9880 * 0.9880

    // RooFormulaVar nsig_mode0_sig("nsig_mode0_sig", "signal of mode0 sig", "Bratio * nsig_mode0* 0.200845266  *0.0861/  0.50339746  /0.0991", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", 0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries());
    // RooFormulaVar nsig_mode1_sig("nsig_mode1_sig", "signal of mode1 sig", "Bratio * nsig_mode1* 0.200845266  *0.0845/  0.50339746  /0.0979", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", 0.05 * tr_fit1_sig->GetEntries(), 0, 1.2 * tr_fit1_sig->GetEntries());
    // RooFormulaVar nsig_mode2_sig("nsig_mode2_sig", "signal of mode2 sig", "Bratio * nsig_mode2* 0.200845266  *0.0830/  0.50339746  /0.0964", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", 0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries());
    // RooFormulaVar nsig_mode3_sig("nsig_mode3_sig", "signal of mode3 sig", "Bratio * nsig_mode3* 0.200845266  *0.0818/  0.50339746  /0.0956", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", 0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries());
    RooFormulaVar nsig_mode4_sig("nsig_mode4_sig", "signal of mode4 sig", "Bratio * nsig_mode4* 0.200845266  *0.0799/  0.50339746  /0.0951", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", 0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries());
    // RooFormulaVar nsig_mode5_sig("nsig_mode5_sig", "signal of mode5 sig", "Bratio * nsig_mode5* 0.200845266  *0.0787/  0.50339746  /0.0922", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", 0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries());
    // RooFormulaVar nsig_mode6_sig("nsig_mode6_sig", "signal of mode6 sig", "Bratio * nsig_mode6* 0.200845266  *0.0771/  0.50339746  /0.0920", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", 0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries());
    // // 3pi
    // RooFormulaVar nsig_mode0_3pi_sig("nsig_mode0_3pi_sig", "signal of mode0_3pi sig", "Bratio * nsig_mode0* 0.11678006  *0.0408/  0.50339746  /0.0991", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_3pi_sig("nbkg0_3pi_sig", "bkg number of mode0_3pi sig", 0.05 * tr_fit0_3pi_sig->GetEntries(), 0, 1.2 * tr_fit0_3pi_sig->GetEntries());
    // RooFormulaVar nsig_mode1_3pi_sig("nsig_mode1_3pi_sig", "signal of mode1_3pi sig", "Bratio * nsig_mode1* 0.11678006  *0.0383/  0.50339746  /0.0979", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_3pi_sig("nbkg1_3pi_sig", "bkg number of mode1_3pi sig", 0.05 * tr_fit1_3pi_sig->GetEntries(), 0, 1.2 * tr_fit1_3pi_sig->GetEntries());
    // RooFormulaVar nsig_mode2_3pi_sig("nsig_mode2_3pi_sig", "signal of mode2_3pi sig", "Bratio * nsig_mode2* 0.11678006  *0.0376/  0.50339746  /0.0964", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_3pi_sig("nbkg2_3pi_sig", "bkg number of mode2_3pi sig", 0.05 * tr_fit2_3pi_sig->GetEntries(), 0, 1.2 * tr_fit2_3pi_sig->GetEntries());
    // RooFormulaVar nsig_mode3_3pi_sig("nsig_mode3_3pi_sig", "signal of mode3_3pi sig", "Bratio * nsig_mode3* 0.11678006  *0.0370/  0.50339746  /0.0956", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_3pi_sig("nbkg3_3pi_sig", "bkg number of mode3_3pi sig", 0.05 * tr_fit3_3pi_sig->GetEntries(), 0, 1.2 * tr_fit3_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode4_3pi_sig("nsig_mode4_3pi_sig", "signal of mode4_3pi sig", "Bratio * nsig_mode4* 0.11678006  *0.0364/  0.50339746  /0.0951", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_3pi_sig("nbkg4_3pi_sig", "bkg number of mode4_3pi sig", 0.05 * tr_fit4_3pi_sig->GetEntries(), 0, 1.2 * tr_fit4_3pi_sig->GetEntries());
    // RooFormulaVar nsig_mode5_3pi_sig("nsig_mode5_3pi_sig", "signal of mode5_3pi sig", "Bratio * nsig_mode5* 0.11678006  *0.0352/  0.50339746  /0.0922", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_3pi_sig("nbkg5_3pi_sig", "bkg number of mode5_3pi sig", 0.05 * tr_fit5_3pi_sig->GetEntries(), 0, 1.2 * tr_fit5_3pi_sig->GetEntries());
    // RooFormulaVar nsig_mode6_3pi_sig("nsig_mode6_3pi_sig", "signal of mode6_3pi sig", "Bratio * nsig_mode6* 0.11678006  *0.0356/  0.50339746  /0.0920", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_3pi_sig("nbkg6_3pi_sig", "bkg number of mode6_3pi sig", 0.05 * tr_fit6_3pi_sig->GetEntries(), 0, 1.2 * tr_fit6_3pi_sig->GetEntries());
    ...
    // ================================v========   D R A W  ====================================================================
    // ********************************************************************************
    TCanvas *can = new TCanvas("can", "simu fit", 400*3 * 1.8, 300* 1.8); //setPad();
    can->Divide(3, 1);
    can->SetFillColor(0);
        ...
        // RooAbsPdf *mode_ref[] = {model0, model1, model2, model3, model4, model5, model6}; 
            ...
            RooPlot *frame_mode0_sig = var_4660->frame(xmin, 2.33046, xbins);
            ...
            data4_sig->plotOn(frame_mode0_sig, LineWidth(2));
            model4_sig->plotOn(frame_mode0_sig, LineColor(kRed), LineWidth(3));
            model4_sig->plotOn(frame_mode0_sig, Components(TString::Format("sigpdf?_sig")), LineColor(kGreen), LineWidth(3), LineStyle(kDashed));
            model4_sig->plotOn(frame_mode0_sig, Components(TString::Format("argus?_sig")), LineColor(kBlue), LineWidth(3), LineStyle(kDashed));
            can->cd(0*3+1);  
            ...
            RooPlot *frame_mode0_3pi_sig = var_4660->frame(xmin, 2.33046, xbins);
            ...
            data4_3pi_sig->plotOn(frame_mode0_3pi_sig, LineWidth(2));
            model4_3pi_sig->plotOn(frame_mode0_3pi_sig, LineColor(kRed), LineWidth(3));
            model4_3pi_sig->plotOn(frame_mode0_3pi_sig, Components(TString::Format("sigpdf?_sig")), LineColor(kGreen), LineWidth(3), LineStyle(kDashed));
            model4_3pi_sig->plotOn(frame_mode0_3pi_sig, Components(TString::Format("argus?_sig")), LineColor(kBlue), LineWidth(3), LineStyle(kDashed));
            can->cd(+2);  
            ...
            RooPlot *frame_mode0 = var_4660->frame( xmin, 2.33046, xbins);
            ...
            data4->plotOn(frame_mode0, LineWidth(2));
            model4->plotOn(frame_mode0, LineColor(kRed), LineWidth(3));
            model4->plotOn(frame_mode0, Components(TString::Format("sigpdf?")), LineColor(kGreen), LineWidth(3), LineStyle(kDashed));
            model4->plotOn(frame_mode0, Components(TString::Format("argus?")), LineColor(kBlue), LineWidth(3), LineStyle(kDashed));
            can->cd(+3);  
            frame_mode0->Draw();
            gPad->Update();
