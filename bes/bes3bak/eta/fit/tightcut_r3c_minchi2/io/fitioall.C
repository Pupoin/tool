...
RooRealVar *rndm = new RooRealVar("rndm", "rndm", 0, 1);
// 27 3.7
// 25 3.65
// 20 3.8
// 15 3.9
...
RooRealVar Bratio("Bratio", "Br of sig/ref", 0.476, 0., 1);	
...
int fitioall()
{
    ...
    //
    // sig  0.17:0.3=0.57
    TChain *tr_data0_sig = new TChain("tree");    tr_data0_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/io/4600LL_io.root");  tr_data0_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/io/4600hadron_io.root"); 
    TChain *tr_data1_sig = new TChain("tree");    tr_data1_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/io/4612LL_io.root");  tr_data1_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/io/4612hadron_io.root");
    TChain *tr_data2_sig = new TChain("tree");    tr_data2_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/io/4620LL_io.root");  tr_data2_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/io/4620hadron_io.root");
    TChain *tr_data3_sig = new TChain("tree");	  tr_data3_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/io/4640LL_io.root");  tr_data3_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/io/4640hadron_io.root");
    TChain *tr_data4_sig = new TChain("tree");	  tr_data4_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/io/4660LL_io.root");  tr_data4_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/io/4660hadron_io.root");
    TChain *tr_data5_sig = new TChain("tree");	  tr_data5_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/io/4680LL_io.root");  tr_data5_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/io/4680hadron_io.root");
    TChain *tr_data6_sig = new TChain("tree");    tr_data6_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/io/4700LL_io.root");  tr_data6_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/io/4700hadron_io.root");

    // sig  eta3pi 0.17:0.3
    TChain *tr_data0_3pi_sig = new TChain("tree");    tr_data0_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4600LL_io.root");    tr_data0_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4600hadron_io.root");   
    TChain *tr_data1_3pi_sig = new TChain("tree");    tr_data1_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4612LL_io.root");    tr_data1_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4612hadron_io.root");   
    TChain *tr_data2_3pi_sig = new TChain("tree");    tr_data2_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4620LL_io.root");    tr_data2_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4620hadron_io.root");   
    TChain *tr_data3_3pi_sig = new TChain("tree");    tr_data3_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4640LL_io.root");	tr_data3_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4640hadron_io.root");   
    TChain *tr_data4_3pi_sig = new TChain("tree");    tr_data4_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4660LL_io.root");	tr_data4_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4660hadron_io.root");   
    TChain *tr_data5_3pi_sig = new TChain("tree");    tr_data5_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4680LL_io.root");	tr_data5_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4680hadron_io.root");   
    TChain *tr_data6_3pi_sig = new TChain("tree");    tr_data6_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4700LL_io.root");    tr_data6_3pi_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/io/4700hadron_io.root");   

    // ref 0.23:0.45=0.511
    TChain *tr_data0 = new TChain("tree");    tr_data0->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/io/4600LL_io.root");      tr_data0->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/io/4600hadron_io.root");
    TChain *tr_data1 = new TChain("tree");    tr_data1->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/io/4612LL_io.root");      tr_data1->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/io/4612hadron_io.root");
    TChain *tr_data2 = new TChain("tree");    tr_data2->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/io/4620LL_io.root");      tr_data2->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/io/4620hadron_io.root");
    TChain *tr_data3 = new TChain("tree");	  tr_data3->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/io/4640LL_io.root");      tr_data3->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/io/4640hadron_io.root");
    TChain *tr_data4 = new TChain("tree");	  tr_data4->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/io/4660LL_io.root");      tr_data4->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/io/4660hadron_io.root");
    TChain *tr_data5 = new TChain("tree");	  tr_data5->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/io/4680LL_io.root");      tr_data5->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/io/4680hadron_io.root");
    TChain *tr_data6 = new TChain("tree");    tr_data6->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/io/4700LL_io.root");      tr_data6->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/io/4700hadron_io.root");

    // ____________________ MC
    // auto cutcut_io = "rndm>=.0786&& rndm<.1036";
    auto cutcut_io = "";

    TTree *tr_fit0_sig = tr_data0_sig->CopyTree(cut_sig);    RooDataSet *data0_sig = new RooDataSet("data0_sig"," M_BC_r3c", tr_fit0_sig, RooArgSet(*var_4600, *rndm), cutcut_io);
    TTree *tr_fit1_sig = tr_data1_sig->CopyTree(cut_sig);    RooDataSet *data1_sig = new RooDataSet("data1_sig", "M_BC_r3c", tr_fit1_sig, RooArgSet(*var_4612, *rndm), cutcut_io);
    TTree *tr_fit2_sig = tr_data2_sig->CopyTree(cut_sig);    RooDataSet *data2_sig = new RooDataSet("data2_sig", "M_BC_r3c", tr_fit2_sig, RooArgSet(*var_4620, *rndm), cutcut_io);
    TTree *tr_fit3_sig = tr_data3_sig->CopyTree(cut_sig);    RooDataSet *data3_sig = new RooDataSet("data3_sig", "M_BC_r3c", tr_fit3_sig, RooArgSet(*var_4640, *rndm), cutcut_io);
    TTree *tr_fit4_sig = tr_data4_sig->CopyTree(cut_sig);    RooDataSet *data4_sig = new RooDataSet("data4_sig", "M_BC_r3c", tr_fit4_sig, RooArgSet(*var_4660, *rndm), cutcut_io);
    TTree *tr_fit5_sig = tr_data5_sig->CopyTree(cut_sig);    RooDataSet *data5_sig = new RooDataSet("data5_sig", "M_BC_r3c", tr_fit5_sig, RooArgSet(*var_4680, *rndm), cutcut_io);
    TTree *tr_fit6_sig = tr_data6_sig->CopyTree(cut_sig);    RooDataSet *data6_sig = new RooDataSet("data6_sig", "M_BC_r3c", tr_fit6_sig, RooArgSet(*var_4700, *rndm), cutcut_io);

    // ____________________ data eta3pi
    TTree *tr_fit0_3pi_sig = tr_data0_3pi_sig->CopyTree(cut_sig);    RooDataSet *data0_3pi_sig = new RooDataSet("data0_3pi_sig"," M_BC_r3c", tr_fit0_3pi_sig, RooArgSet(*var_4600, *rndm), cutcut_io);
    TTree *tr_fit1_3pi_sig = tr_data1_3pi_sig->CopyTree(cut_sig);    RooDataSet *data1_3pi_sig = new RooDataSet("data1_3pi_sig", "M_BC_r3c", tr_fit1_3pi_sig, RooArgSet(*var_4612, *rndm), cutcut_io);
    TTree *tr_fit2_3pi_sig = tr_data2_3pi_sig->CopyTree(cut_sig);    RooDataSet *data2_3pi_sig = new RooDataSet("data2_3pi_sig", "M_BC_r3c", tr_fit2_3pi_sig, RooArgSet(*var_4620, *rndm), cutcut_io);
    TTree *tr_fit3_3pi_sig = tr_data3_3pi_sig->CopyTree(cut_sig);    RooDataSet *data3_3pi_sig = new RooDataSet("data3_3pi_sig", "M_BC_r3c", tr_fit3_3pi_sig, RooArgSet(*var_4640, *rndm), cutcut_io);
    TTree *tr_fit4_3pi_sig = tr_data4_3pi_sig->CopyTree(cut_sig);    RooDataSet *data4_3pi_sig = new RooDataSet("data4_3pi_sig", "M_BC_r3c", tr_fit4_3pi_sig, RooArgSet(*var_4660, *rndm), cutcut_io);
    TTree *tr_fit5_3pi_sig = tr_data5_3pi_sig->CopyTree(cut_sig);    RooDataSet *data5_3pi_sig = new RooDataSet("data5_3pi_sig", "M_BC_r3c", tr_fit5_3pi_sig, RooArgSet(*var_4680, *rndm), cutcut_io);
    TTree *tr_fit6_3pi_sig = tr_data6_3pi_sig->CopyTree(cut_sig);    RooDataSet *data6_3pi_sig = new RooDataSet("data6_3pi_sig", "M_BC_r3c", tr_fit6_3pi_sig, RooArgSet(*var_4700, *rndm), cutcut_io);

    TTree *tr_fit0 = tr_data0->CopyTree(cut_ref);    RooDataSet *data0 = new RooDataSet("data0", "M_BC_r3c", tr_fit0, RooArgSet(*var_4600, *rndm), cutcut_io);
    TTree *tr_fit1 = tr_data1->CopyTree(cut_ref);    RooDataSet *data1 = new RooDataSet("data1", "M_BC_r3c", tr_fit1, RooArgSet(*var_4612, *rndm), cutcut_io);
    TTree *tr_fit2 = tr_data2->CopyTree(cut_ref);    RooDataSet *data2 = new RooDataSet("data2", "M_BC_r3c", tr_fit2, RooArgSet(*var_4620, *rndm), cutcut_io);
    TTree *tr_fit3 = tr_data3->CopyTree(cut_ref);    RooDataSet *data3 = new RooDataSet("data3", "M_BC_r3c", tr_fit3, RooArgSet(*var_4640, *rndm), cutcut_io);
    TTree *tr_fit4 = tr_data4->CopyTree(cut_ref);    RooDataSet *data4 = new RooDataSet("data4", "M_BC_r3c", tr_fit4, RooArgSet(*var_4660, *rndm), cutcut_io);
    TTree *tr_fit5 = tr_data5->CopyTree(cut_ref);    RooDataSet *data5 = new RooDataSet("data5", "M_BC_r3c", tr_fit5, RooArgSet(*var_4680, *rndm), cutcut_io);
    TTree *tr_fit6 = tr_data6->CopyTree(cut_ref);    RooDataSet *data6 = new RooDataSet("data6", "M_BC_r3c", tr_fit6, RooArgSet(*var_4700, *rndm), cutcut_io);

    // orignal
    RooRealVar mean_all("mean_all", "mean_all", 0, -0.001, 0.001);
    RooRealVar sigma_all("sigma_all", "sigma_all", 0.0001, 0, 0.001);
    ...
    double Br_sig_inter = 0.20079852; // 0.9880 * 0.5157 * 0.3941
    double Br_sig_3pi_inter = 0.11678006; // 0.5157 * 0.9880 * 0.2292
    double Br_ref_inter = 0.50339746;  // 0.5157 * 0.9880 * 0.9880

    RooFormulaVar nsig_mode0_sig("nsig_mode0_sig", "signal of mode0 sig", "Bratio * nsig_mode0* 0.20079852  *0.0927/  0.50339746  /0.0991", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", 0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries());
    RooFormulaVar nsig_mode1_sig("nsig_mode1_sig", "signal of mode1 sig", "Bratio * nsig_mode1* 0.20079852  *0.0908/  0.50339746  /0.0979", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", 0.05 * tr_fit1_sig->GetEntries(), 0, 1.2 * tr_fit1_sig->GetEntries());
    RooFormulaVar nsig_mode2_sig("nsig_mode2_sig", "signal of mode2 sig", "Bratio * nsig_mode2* 0.20079852  *0.0884/  0.50339746  /0.0964", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", 0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries());
    RooFormulaVar nsig_mode3_sig("nsig_mode3_sig", "signal of mode3 sig", "Bratio * nsig_mode3* 0.20079852  *0.0875/  0.50339746  /0.0952", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", 0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries());
    RooFormulaVar nsig_mode4_sig("nsig_mode4_sig", "signal of mode4 sig", "Bratio * nsig_mode4* 0.20079852  *0.0851/  0.50339746  /0.0951", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", 0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries());
    RooFormulaVar nsig_mode5_sig("nsig_mode5_sig", "signal of mode5 sig", "Bratio * nsig_mode5* 0.20079852  *0.0830/  0.50339746  /0.0922", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", 0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries());
    RooFormulaVar nsig_mode6_sig("nsig_mode6_sig", "signal of mode6 sig", "Bratio * nsig_mode6* 0.20079852  *0.0808/  0.50339746  /0.0919", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", 0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries());
    // 3pi
    RooFormulaVar nsig_mode0_3pi_sig("nsig_mode0_3pi_sig", "signal of mode0_3pi sig", "Bratio * nsig_mode0* 0.11678006  *0.0444/  0.50339746  /0.0991", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_3pi_sig("nbkg0_3pi_sig", "bkg number of mode0_3pi sig", 0.05 * tr_fit0_3pi_sig->GetEntries(), 0, 1.2 * tr_fit0_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode1_3pi_sig("nsig_mode1_3pi_sig", "signal of mode1_3pi sig", "Bratio * nsig_mode1* 0.11678006  *0.0418/  0.50339746  /0.0979", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_3pi_sig("nbkg1_3pi_sig", "bkg number of mode1_3pi sig", 0.05 * tr_fit1_3pi_sig->GetEntries(), 0, 1.2 * tr_fit1_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode2_3pi_sig("nsig_mode2_3pi_sig", "signal of mode2_3pi sig", "Bratio * nsig_mode2* 0.11678006  *0.0407/  0.50339746  /0.0964", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_3pi_sig("nbkg2_3pi_sig", "bkg number of mode2_3pi sig", 0.05 * tr_fit2_3pi_sig->GetEntries(), 0, 1.2 * tr_fit2_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode3_3pi_sig("nsig_mode3_3pi_sig", "signal of mode3_3pi sig", "Bratio * nsig_mode3* 0.11678006  *0.0398/  0.50339746  /0.0952", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_3pi_sig("nbkg3_3pi_sig", "bkg number of mode3_3pi sig", 0.05 * tr_fit3_3pi_sig->GetEntries(), 0, 1.2 * tr_fit3_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode4_3pi_sig("nsig_mode4_3pi_sig", "signal of mode4_3pi sig", "Bratio * nsig_mode4* 0.11678006  *0.0390/  0.50339746  /0.0951", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_3pi_sig("nbkg4_3pi_sig", "bkg number of mode4_3pi sig", 0.05 * tr_fit4_3pi_sig->GetEntries(), 0, 1.2 * tr_fit4_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode5_3pi_sig("nsig_mode5_3pi_sig", "signal of mode5_3pi sig", "Bratio * nsig_mode5* 0.11678006  *0.0375/  0.50339746  /0.0922", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_3pi_sig("nbkg5_3pi_sig", "bkg number of mode5_3pi sig", 0.05 * tr_fit5_3pi_sig->GetEntries(), 0, 1.2 * tr_fit5_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode6_3pi_sig("nsig_mode6_3pi_sig", "signal of mode6_3pi sig", "Bratio * nsig_mode6* 0.11678006  *0.0370/  0.50339746  /0.0919", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_3pi_sig("nbkg6_3pi_sig", "bkg number of mode6_3pi sig", 0.05 * tr_fit6_3pi_sig->GetEntries(), 0, 1.2 * tr_fit6_3pi_sig->GetEntries());
    ...
    allList.add(*nl_4620);
    allList.add(*nl_4640);
    allList.add(*nl_4660);//Br: 0.532227 +/- 0.0310699
    allList.add(*nl_4680); //Br: 0.51668 +/- 0.0157759
    allList.add(*nl_4700); // Br: 0.552696 +/- 0.0341396

    // allList.add(*nl_3pi_4600);
    // allList.add(*nl_3pi_4612);
    // allList.add(*nl_3pi_4620);
    // allList.add(*nl_3pi_4640);
    // allList.add(*nl_3pi_4660);//Br: 0.597769 +/- 0.0498165
    // allList.add(*nl_3pi_4680);// Br: 0.497115 +/- 0.0261426  ok 
    // allList.add(*nl_3pi_4700); //Br: 0.55585 +/- 0.0514877
    ...
    if(1)
    {
        ...
        can3_3pi->SaveAs("io_sig3pi_all.png");
