...
def cal_Costheta_sigma(file):
    ...
    rdf2 = rdf.Filter("M_BC_r3c>2.25 && chi2_min_r3c<17 && np!=0 && npbar!=0") \
                ...
                .Define("sigma_px", "pall_r3c[0]+gam3_r3c[0]+gam4_r3c[0]+p_pim_r3c[0] + p_pip_r3c[0]")\
                .Define("sigma_py", "pall_r3c[1]+gam3_r3c[1]+gam4_r3c[1]+p_pim_r3c[1] + p_pip_r3c[1]")\
                .Define("sigma_pz", "pall_r3c[2]+gam3_r3c[2]+gam4_r3c[2]+p_pim_r3c[2] + p_pip_r3c[2]")\
                .Define("sigma_e",  "pall_r3c[3]+gam3_r3c[3]+gam4_r3c[3]+p_pim_r3c[3] + p_pip_r3c[3]")\
