void removedouble_mindE4640()
{
  ...
  int run, event, np, npbar; double M_BC_c, deltaE_min_c, chi2_min_c;
  ...
  int run1, event1, np1, npbar1; double M_BC_c1, deltaE_min_c1, chi2_min_c1;
  int run2, event2, np2, npbar2; double M_BC_c2, deltaE_min_c2, chi2_min_c2;


  TFile f("4640data_removedouble.root", "recreate");
  TTree tree("tree", "tree");
  int m_run, m_event, m_np, m_npbar; double m_M_BC_c, m_deltaE_min_c, m_chi2_min_c;
