void removedouble_minchi2_allbranch4680()
{
  TChain c("tree");
  c.Add("4680data.root");
  ...
  int run1, event1, np1, npbar1; Double_t M_BC_r3c1, deltaE_min_r3c1, chi2_min_r3c1, E_beam1, pall_r3c1[4], gam1_r3c1[4], gam2_r3c1[4], gam3_r3c1[4], gam4_r3c1[4];
  int run2, event2, np2, npbar2; Double_t M_BC_r3c2, deltaE_min_r3c2, chi2_min_r3c2, E_beam2, pall_r3c2[4], gam1_r3c2[4], gam2_r3c2[4], gam3_r3c2[4], gam4_r3c2[4];


  TFile f("4680data_removedouble_allbranch.root", "recreate");
  TTree tree("tree", "tree");
  int m_run, m_event, m_np, m_npbar; Double_t m_M_BC_r3c, m_deltaE_min_r3c, m_chi2_min_r3c, m_E_beam, m_pall_r3c[4], m_gam1_r3c[4], m_gam2_r3c[4], m_gam3_r3c[4], m_gam4_r3c[4];
  ...
  tree.Branch("m_pall_r3c", m_pall_r3c, "m_pall_r3c[4]/D");
  tree.Branch("m_gam1_r3c", m_gam1_r3c, "m_gam1_r3c[4]/D");
  tree.Branch("m_gam2_r3c", m_gam2_r3c, "m_gam2_r3c[4]/D");
  tree.Branch("m_gam3_r3c", m_gam3_r3c, "m_gam3_r3c[4]/D");
  tree.Branch("m_gam4_r3c", m_gam4_r3c, "m_gam4_r3c[4]/D");
  ...
  for(int i = 0; i< c.GetEntries(); )
  {
    ...
    //       << endl;
    //   }
    // cout << m_pall_r3c[0] << " "<< m_pall_r3c[1] << " "<< m_pall_r3c[2] << " "<< m_pall_r3c[3] << endl;
    tree.Fill();
    // if (i>2) break;
  }
