...
int massSigma()
{
    ...
    // TTree *myTree = chain.CopyTree("M_BC_r3c>2.25 && sigmam_r3c>0.6&&sigmam_r3c<0.92 && (chi2_min_r3c<30 && np!=0 && npbar !=0 )", "", 1000000000, 0); 
    ...
    chain_massetap->Project("hist_massetap", "sigmam_r3c", "M_BC_r3c>2.25 && sigmam_r3c>1.12&&sigmam_r3c<1.24 && (chi2_min_r3c<17 && np!=0 && npbar !=0 )");
    ...
    TArrow *arrow1 = new TArrow(1.14, 120, 1.14, 0., 0.05, ">");
    arrow1 -> SetLineWidth(4);
    arrow1 -> SetLineColor(4);
    //arrow1 -> SetAngle(40);
    TArrow *arrow2 = new TArrow(1.16, 120, 1.16, 0., 0.05, ">");
    arrow2 -> SetLineWidth(4);
    arrow2 -> SetLineColor(4);
	arrow1 -> Draw();
	arrow2 -> Draw();
	TArrow *arrow3 = new TArrow(1.21, 120, 1.21, 0., 0.05, ">");
    arrow3 -> SetLineWidth(4);
    arrow3 -> SetLineColor(4);
    TArrow *arrow4 = new TArrow(1.23, 120, 1.23, 0., 0.05, ">");
    arrow4 -> SetLineWidth(4);
    arrow4 -> SetLineColor(4);
	arrow3 -> Draw();
	arrow4 -> Draw();
	TArrow *arrow5 = new TArrow(1.174, 120, 1.174, 0., 0.05, ">");
    arrow5 -> SetLineWidth(4);
    arrow5 -> SetLineColor(2);
    TArrow *arrow6 = new TArrow(1.2, 120, 1.2, 0., 0.05, ">");
