...
int plot_mbc4680()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_zhou2me/4680LL_removedouble.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/data/cutmassroot/tightcut_zhou2me/4680data_removedouble.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_zhou2me/4680hadron_removedouble_mode.root");
    ...
    TCut cut_deltaE = "((deltaE_min_c>-0.020) && (deltaE_min_c<0.015))";
    TCut cut_np = "(np!=0 && npbar != 0)";
    //TCut cut_chi2 = "(chi2_min_r1c<13)";
    TCut cut_mbc = "((M_BC_c>=2.25) && (M_BC_c<=2.3407900))";
