...
int plot_mbc4700()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_zhou2me/4700LL_removedouble.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/data/cutmassroot/tightcut_zhou2me/4700data_removedouble.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_zhou2me/4700hadron_removedouble_mode.root");
    ...
    TCut cut_mbc = "((M_BC_c>=2.25) && (M_BC_c<=2.34919))";
