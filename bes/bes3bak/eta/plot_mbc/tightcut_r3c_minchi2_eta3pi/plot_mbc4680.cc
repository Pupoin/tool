...
int plot_mbc4680()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/4680LL_selB.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/data/cutmassroot/tightcut_r3c_minchi2_eta3pi/4680data_selB.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/4680hadron_selB.root");
    ...
    legend->SetHeader(TString::Format("#sqrt{s} = %.3f GeV", 2.34079*2 ));
    ...
    canv1->Update();
    canv1->SaveAs("stack4680.pdf");
    canv1->SaveAs("stack4680.png");
    return 0;
}
