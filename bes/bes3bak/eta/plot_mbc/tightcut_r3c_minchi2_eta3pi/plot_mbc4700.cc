...
int plot_mbc4700()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/4700LL_selB.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/data/cutmassroot/tightcut_r3c_minchi2_eta3pi/4700data_selB.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2_eta2pipipi0/4700hadron_selB.root");
    ...
    legend->SetHeader(TString::Format("#sqrt{s} = %.3f GeV", 2.34919*2 ));
    ...
    canv1->Update();
    canv1->SaveAs("stack4700.pdf");
    canv1->SaveAs("stack4700.png");
    return 0;
}
