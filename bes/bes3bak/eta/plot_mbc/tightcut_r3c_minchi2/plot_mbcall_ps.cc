...
int plot_mbcall_ps()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2_sideband/LL.root");
    ...
    TCut eta_sideband="((etam<0.6&&etam>0.56) || (etam>0.46&&etam<0.5))";
    ...
    TCut eta_signalband="(etam<0.56&&etam>0.5)";
