...
int plot_mbc4600()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/io/4600LL_selB_split.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/data/cutmassroot/tightcut_r3c_minchi2/4600data_removedouble.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/io/4600hadron_removedouble_split.root");
    ...
    TCut cut_chi2 = "(chi2_min_r3c<16)";
    TCut cut_mbc = "((M_BC_r3c>=2.25) && (M_BC_r3c<=2.3))";
