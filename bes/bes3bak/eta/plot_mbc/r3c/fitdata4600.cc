...
int fitdata4600()
{
  ...
  chain_shape->Add("../shape/cutmassroot/4600shape_mass.root");
  ...
  RooRealVar mean("mean", "mean", 0.0002);
  ...
  chain_data->Add("../data/cutmassroot/4600data_mass.root");
  ...
  RooPlot *frame = M_BC->frame(xmin, 2.3, 20);
