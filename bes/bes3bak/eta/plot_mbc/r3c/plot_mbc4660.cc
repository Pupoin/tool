...
int plot_mbc4660()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/4660LL_mass.root");
    chain_data->Add("../data/cutmassroot/4660data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/4660hadron_mass.root");
