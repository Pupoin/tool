...
int plot_mbc4612()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/4612LL_mass.root");
    chain_data->Add("../data/cutmassroot/4612data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/4612hadron_mass.root");
