...
int plot_mbc4700()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/4700LL_mass.root");
    chain_data->Add("../data/cutmassroot/4700data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/4700hadron_mass.root");
