...
int plot_mbc4640()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/4640LL_mass.root");
    chain_data->Add("../data/cutmassroot/4640data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/4640hadron_mass.root");
