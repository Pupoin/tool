...
int plot_mbc4680()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/4680LL_mass.root");
    chain_data->Add("../data/cutmassroot/4680data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/4680hadron_mass.root");
