...
int massEta()
{
    ...
    chain_massEta->Project("hist_massEta", "etam",cut_mbc && cut_mass );
    ...
    // hist_massEta->SetMaxDigits(4)
    hist_massEta->Draw();
    

    TArrow *ar2 = new TArrow(0.50,1000,0.50,8000,0.02,"<|");
    ar2->SetAngle(40);
    ar2->SetLineWidth(2);
    ar2->SetLineColor(4);
    ar2->SetFillColor(4);
    ...
    TArrow *ar3 = new TArrow(0.56,1000,0.56,8000,0.02,"<|");
    ar3->SetAngle(40);
    ar3->SetLineWidth(2);
    ar3->SetLineColor(4);
    ar3->SetFillColor(4);
    ...
    canva1->SaveAs("m_eta.png");
    canva1->SaveAs("m_eta.pdf");
