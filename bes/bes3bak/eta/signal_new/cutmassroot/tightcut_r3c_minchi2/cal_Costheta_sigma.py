...
def cal_Costheta_sigma(file):
    ...
    rdf2 = rdf.Filter("M_BC_r3c>2.2").Filter("(ndaughterAp==8&&ndaughterAm!=8) || (ndaughterAp==8&&ndaughterAm==8 && rightflag==1)")\
    ...
    #.Filter("M_BC_r3c>2.25 && chi2_min_r3c<30 && np!=0 && npbar!=0 && etaprimemr3c>0.946 && etaprimemr3c<0.968")
    rdf3 = rdf.Filter("M_BC_r3c>2.2").Filter("(ndaughterAm==8&&ndaughterAp!=8 ) || (ndaughterAp==8&&ndaughterAm==8 && rightflag==-1)")\
