...
// root -l -b -q "bootstrap_3pi.C(2, \"a.root\")"

void bootstrap_3pi(int seed, string fileName)
{
    ...
    tc_eta_4600 -> Add("eta3pi/4600data_selB.root");
    tc_eta_4612 -> Add("eta3pi/4612data_selB.root");
    tc_eta_4620 -> Add("eta3pi/4620data_selB.root");
    tc_eta_4640 -> Add("eta3pi/4640data_selB.root");
    tc_eta_4660 -> Add("eta3pi/4660data_selB.root");
    tc_eta_4680 -> Add("eta3pi/4680data_selB.root");
    tc_eta_4700 -> Add("eta3pi/4700data_selB.root");
    ...
    RooDataSet *data_eta_4600 = new RooDataSet("data_eta3pi_4600", "", tc_eta_4600 -> CopyTree(cut_sig), RooArgSet(var_4600));
    RooDataSet *data_eta_4612 = new RooDataSet("data_eta3pi_4612", "", tc_eta_4612 -> CopyTree(cut_sig), RooArgSet(var_4612));
    RooDataSet *data_eta_4620 = new RooDataSet("data_eta3pi_4620", "", tc_eta_4620 -> CopyTree(cut_sig), RooArgSet(var_4620));
    RooDataSet *data_eta_4640 = new RooDataSet("data_eta3pi_4640", "", tc_eta_4640 -> CopyTree(cut_sig), RooArgSet(var_4640));
    RooDataSet *data_eta_4660 = new RooDataSet("data_eta3pi_4660", "", tc_eta_4660 -> CopyTree(cut_sig), RooArgSet(var_4660));
    RooDataSet *data_eta_4680 = new RooDataSet("data_eta3pi_4680", "", tc_eta_4680 -> CopyTree(cut_sig), RooArgSet(var_4680));
    RooDataSet *data_eta_4700 = new RooDataSet("data_eta3pi_4700", "", tc_eta_4700 -> CopyTree(cut_sig), RooArgSet(var_4700));
