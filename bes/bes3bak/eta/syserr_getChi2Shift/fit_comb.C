...
int fit_comb()
{
    ...
    // orignal
	RooRealVar mean_all("mean_all", "mean_all",  -9.8818e-05, -0.0001, 0.0001);
	RooRealVar sigma_all("sigma_all", "sigma_all",  2.4417e-06, 0, 0.00001);
	RooGaussModel guass_all("guass_all", "guass_all", *M_BC_r3c, mean_all, sigma_all);
	
	// RooRealVar mean_all("mean_all", "mean_all",  -9.5303e-05 + );
	// RooRealVar sigma_all("sigma_all", "sigma_all",  2.4417e-06, 0, 0.00001);
	// RooGaussModel guass_all("guass_all", "guass_all", *M_BC_r3c, mean_all, sigma_all);
    
	// sig-- shape
	TFile *pdf0_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2/4600_sig_shapepdf.root"); RooWorkspace *wspace0_sig = (RooWorkspace *)pdf0_sig->Get("wspace"); RooAbsPdf *shapepdf0_sig = wspace0_sig->pdf("modelPdf");
	TFile *pdf1_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2/4612_sig_shapepdf.root"); RooWorkspace *wspace1_sig = (RooWorkspace *)pdf1_sig->Get("wspace"); RooAbsPdf *shapepdf1_sig = wspace1_sig->pdf("modelPdf");
	TFile *pdf2_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2/4620_sig_shapepdf.root"); RooWorkspace *wspace2_sig = (RooWorkspace *)pdf2_sig->Get("wspace"); RooAbsPdf *shapepdf2_sig = wspace2_sig->pdf("modelPdf");
	TFile *pdf3_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2/4640_sig_shapepdf.root"); RooWorkspace *wspace3_sig = (RooWorkspace *)pdf3_sig->Get("wspace"); RooAbsPdf *shapepdf3_sig = wspace3_sig->pdf("modelPdf");
	TFile *pdf4_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2/4660_sig_shapepdf.root"); RooWorkspace *wspace4_sig = (RooWorkspace *)pdf4_sig->Get("wspace"); RooAbsPdf *shapepdf4_sig = wspace4_sig->pdf("modelPdf");
	TFile *pdf5_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2/4680_sig_shapepdf.root"); RooWorkspace *wspace5_sig = (RooWorkspace *)pdf5_sig->Get("wspace"); RooAbsPdf *shapepdf5_sig = wspace5_sig->pdf("modelPdf");
	TFile *pdf6_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2/4700_sig_shapepdf.root"); RooWorkspace *wspace6_sig = (RooWorkspace *)pdf6_sig->Get("wspace"); RooAbsPdf *shapepdf6_sig = wspace6_sig->pdf("modelPdf");

	// ref-- shape
	TFile *pdf0 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4612_ref_shapepdf.root"); RooWorkspace *wspace0 = (RooWorkspace *)pdf0->Get("wspace"); RooAbsPdf *shapepdf0 = wspace0->pdf("modelPdf");
	TFile *pdf1 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4612_ref_shapepdf.root"); RooWorkspace *wspace1 = (RooWorkspace *)pdf1->Get("wspace"); RooAbsPdf *shapepdf1 = wspace1->pdf("modelPdf");
	TFile *pdf2 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4620_ref_shapepdf.root"); RooWorkspace *wspace2 = (RooWorkspace *)pdf2->Get("wspace"); RooAbsPdf *shapepdf2 = wspace2->pdf("modelPdf");
	TFile *pdf3 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4640_ref_shapepdf.root"); RooWorkspace *wspace3 = (RooWorkspace *)pdf3->Get("wspace"); RooAbsPdf *shapepdf3 = wspace3->pdf("modelPdf");
	TFile *pdf4 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4660_ref_shapepdf.root"); RooWorkspace *wspace4 = (RooWorkspace *)pdf4->Get("wspace"); RooAbsPdf *shapepdf4 = wspace4->pdf("modelPdf");
	TFile *pdf5 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4680_ref_shapepdf.root"); RooWorkspace *wspace5 = (RooWorkspace *)pdf5->Get("wspace"); RooAbsPdf *shapepdf5 = wspace5->pdf("modelPdf");
	TFile *pdf6 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4700_ref_shapepdf.root"); RooWorkspace *wspace6 = (RooWorkspace *)pdf6->Get("wspace"); RooAbsPdf *shapepdf6 = wspace6->pdf("modelPdf");

	// sig-- shape x guass
	RooAbsPdf *sigpdf0_sig = new RooFFTConvPdf("sigpdf0_sig", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf0_sig, guass_all);
	RooAbsPdf *sigpdf1_sig = new RooFFTConvPdf("sigpdf1_sig", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf1_sig, guass_all);
	RooAbsPdf *sigpdf2_sig = new RooFFTConvPdf("sigpdf2_sig", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf2_sig, guass_all);
	RooAbsPdf *sigpdf3_sig = new RooFFTConvPdf("sigpdf3_sig", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf3_sig, guass_all);
	RooAbsPdf *sigpdf4_sig = new RooFFTConvPdf("sigpdf4_sig", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf4_sig, guass_all);
	RooAbsPdf *sigpdf5_sig = new RooFFTConvPdf("sigpdf5_sig", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf5_sig, guass_all);
	RooAbsPdf *sigpdf6_sig = new RooFFTConvPdf("sigpdf6_sig", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf6_sig, guass_all);


	// ref-- shape x guass
	RooAbsPdf *sigpdf0 = new RooFFTConvPdf("sigpdf0", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf0, guass_all);
	RooAbsPdf *sigpdf1 = new RooFFTConvPdf("sigpdf1", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf1, guass_all);
	RooAbsPdf *sigpdf2 = new RooFFTConvPdf("sigpdf2", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf2, guass_all);
	RooAbsPdf *sigpdf3 = new RooFFTConvPdf("sigpdf3", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf3, guass_all);
	RooAbsPdf *sigpdf4 = new RooFFTConvPdf("sigpdf4", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf4, guass_all);
	RooAbsPdf *sigpdf5 = new RooFFTConvPdf("sigpdf5", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf5, guass_all);
	RooAbsPdf *sigpdf6 = new RooFFTConvPdf("sigpdf6", "modelPdf (X) gauss", *M_BC_r3c, *shapepdf6, guass_all);
	...
	RooFormulaVar nsig_mode0_sig("nsig_mode0_sig", "signal of mode0 sig", "Bratio * nsig_mode0* 0.200845266  *0.087/  0.50339746  /0.098", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", 0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries());
	RooFormulaVar nsig_mode1_sig("nsig_mode1_sig", "signal of mode1 sig", "Bratio * nsig_mode1* 0.200845266  *0.081/  0.50339746  /0.093", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", 0.05 * tr_fit1_sig->GetEntries(), 0, 1.2 * tr_fit1_sig->GetEntries());
	RooFormulaVar nsig_mode2_sig("nsig_mode2_sig", "signal of mode2 sig", "Bratio * nsig_mode2* 0.200845266  *0.081/  0.50339746  /0.098", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", 0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries());
	RooFormulaVar nsig_mode3_sig("nsig_mode3_sig", "signal of mode3 sig", "Bratio * nsig_mode3* 0.200845266  *0.082/  0.50339746  /0.096", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", 0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries());
	RooFormulaVar nsig_mode4_sig("nsig_mode4_sig", "signal of mode4 sig", "Bratio * nsig_mode4* 0.200845266  *0.080/  0.50339746  /0.095", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", 0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries());
	RooFormulaVar nsig_mode5_sig("nsig_mode5_sig", "signal of mode5 sig", "Bratio * nsig_mode5* 0.200845266  *0.079/  0.50339746  /0.093", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", 0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries());
	RooFormulaVar nsig_mode6_sig("nsig_mode6_sig", "signal of mode6 sig", "Bratio * nsig_mode6* 0.200845266  *0.077/  0.50339746  /0.092", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", 0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries());
	// RooFormulaVar nsig_mode0_sig("nsig_mode0_sig", "signal of mode0 sig", "Bratio * nsig_mode0* 0.200845266  *0.034/  0.503631863  /0.043", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", 9., 0, 20          /*0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries()*/);
	// RooFormulaVar nsig_mode1_sig("nsig_mode1_sig", "signal of mode1 sig", "Bratio * nsig_mode1* 0.200845266  *0.032/  0.503631863  /0.040", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", 0 , -1, 1              /*0.05 * tr_fit1_sig->GetEntries(), 0, 1.1 * tr_fit1_sig->GetEntries()*/);
	// RooFormulaVar nsig_mode2_sig("nsig_mode2_sig", "signal of mode2 sig", "Bratio * nsig_mode2* 0.200845266  *0.032/  0.503631863  /0.039", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", 14, 0, 30           /*0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries()*/);
	// RooFormulaVar nsig_mode3_sig("nsig_mode3_sig", "signal of mode3 sig", "Bratio * nsig_mode3* 0.200845266  *0.032/  0.503631863  /0.039", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", 13, 0, 25           /*0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries()*/);
	// RooFormulaVar nsig_mode4_sig("nsig_mode4_sig", "signal of mode4 sig", "Bratio * nsig_mode4* 0.200845266  *0.031/  0.503631863  /0.038", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", 10, 0, 25            /*0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries()*/);
	// RooFormulaVar nsig_mode5_sig("nsig_mode5_sig", "signal of mode5 sig", "Bratio * nsig_mode5* 0.200845266  *0.031/  0.503631863  /0.038", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", 51, 0, 80           /*0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries()*/);
	// RooFormulaVar nsig_mode6_sig("nsig_mode6_sig", "signal of mode6 sig", "Bratio * nsig_mode6* 0.200845266  *0.031/  0.503631863  /0.038", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", 14, 0, 25            /*0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries()*/);
	...
	if(1)
    {
        ...
        frame_mode0->SetTitle("#Lambda_{c}^{+} #rightarrow #Sigma^{+} #pi_{0},    #sqrt{s}=4.600 GeV,     567 pb^{-1}");
        ...
        frame_mode1->SetTitle("#Lambda_{c}^{+} #rightarrow #Sigma^{+} #pi_{0},     #sqrt{s}=4.612 GeV,     102 pb^{-1}");
        ...
        frame_mode2->SetTitle("#Lambda_{c}^{+} #rightarrow #Sigma^{+} #pi_{0},     #sqrt{s}=4.628 GeV     517 pb^{-1}");
        ...
        frame_mode3->SetTitle("#Lambda_{c}^{+} #rightarrow #Sigma^{+} #pi_{0},     #sqrt{s}=4.641 GeV,     537 pb^{-1}");
        ...
        frame_mode4->SetTitle("#Lambda_{c}^{+} #rightarrow #Sigma^{+} #pi_{0},     #sqrt{s}=4.661 GeV,     523 pb^{-1}");
        ...
        frame_mode5->SetTitle("#Lambda_{c}^{+} #rightarrow #Sigma^{+} #pi_{0},     #sqrt{s}=4.682 GeV,     1657 pb^{-1}");
