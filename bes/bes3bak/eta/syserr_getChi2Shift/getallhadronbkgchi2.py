...
# can.Divide(2, 7)
LL_DirPath="/publicfs/ucas/user/yuanchy8/7.0.6/eta/LL/cutmassroot/tightcut_r3c_minchi2/"
hadron_DirPath="/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/"
#%% __ sig __

chain = TChain("tree")
chain.Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/hadron/cutmassroot/tightcut_r3c_minchi2/hadron.root")
...
shapepdf = RooKeysPdf("modelPdf", "", chi2_min_r3c, shape, RooKeysPdf.MirrorRight, 1.99)  
...
frame = chi2_min_r3c.frame(ROOT.RooFit.Title("eta chi2 hadron "))
shape.plotOn(frame)
