void removedouble_minchi24600()
{
  TChain c("tree");
  c.Add("4600hadron_mode.root");

  int run, event, np, npbar, signal, flag1; double M_BC_r3c, deltaE_min_r3c, chi2_min_r3c;
  ...
  c.SetBranchAddress("flag1", &flag1);

  int run1, event1, np1, npbar1, flag1_1; double M_BC_r3c1, deltaE_min_r3c1, chi2_min_r3c1, signal1;
  int run2, event2, np2, npbar2, flag1_2; double M_BC_r3c2, deltaE_min_r3c2, chi2_min_r3c2, signal2;

  TFile f("4600hadron_removedouble_mode.root", "recreate");
  TTree tree("tree", "tree");
  int m_run, m_event, m_np, m_npbar, m_flag1; double m_M_BC_r3c, m_deltaE_min_r3c, m_chi2_min_r3c, m_signal;
