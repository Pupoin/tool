...
int fitInclusive4700()
{
  ...
  RooRealVar sigma("sigma", "sigma", 8.45689e-07, 0, 8.45689e-07+(6.48031e-07*5));
  RooRealVar mean("mean", "mean", 0.000181394, 0.000181394-(1.58819e-07*5), 0.000181394+(1.58819e-07*5));
