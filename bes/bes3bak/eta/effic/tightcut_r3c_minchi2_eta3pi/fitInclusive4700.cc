...
int fitInclusive4700()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2_eta3pi/4700signal.root");
  ...
  RooRealVar sigma("sigma", "sigma", 3.70161e-06, 0, 3.70161e-06+(2.17138e-08*5));
  RooRealVar mean("mean", "mean", 7.15391e-05, 7.15391e-05-(1.36626e-05*5), 7.15391e-05+(1.36626e-05*5));
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4700_Lc2eta_3pi.pdf");
