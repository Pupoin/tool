...
int fitInclusive4640()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2_eta3pi/4640signal.root");
  ...
  // pt->SetLineColor(5);
  // pt->SetTextColor(5);
  pt->InsertText("#Lambda_{c}^{+} #rightarrow #Sigma^{+} #eta(#pi^{+}#pi^{-}#pi^{0})");
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4640_Lc2eta_3pi.pdf");
