...
RooRealVar *bothMassWeight = new RooRealVar("bothMassWeight", "bothMassWeight", 0, 2, "");
...
int fitInclusive4640()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2_eta3pi/4640signal_bothMassWeight.root");
  TTree *tree_cut = chain_data->CopyTree(cut_sum1, "", 100000000, 0);
  Int_t nentries = (Int_t)tree_cut->GetEntries();
  // --- Retrieve Data ---
  RooDataSet *data = new RooDataSet("data", "data", tree_cut, RooArgSet(*M_BC_r3c, *bothMassWeight),"", "bothMassWeight");

  // get the shape pdf_______________________________
  // TChain *chain_shape = new TChain("tree");
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minchi2_eta3pi/4640shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2_eta3pi/4640_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 0.000980781, 0, 0.000980781+(3.36629e-05*5));
  RooRealVar mean("mean", "mean", 0.000141856, 0.000141856-(1.84904e-05*5), 0.000141856+(1.84904e-05*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2_eta3pi/4640signal.root");
