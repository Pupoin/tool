...
int fitInclusive_energy_()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2_eta3pi/_energy_signal.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minchi2_eta3pi/_energy_shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2_eta3pi/_energy__sig_shapepdf.root");
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2_eta3pi/_energy_signal.root");
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic_energy__Lc2eta_3pi.pdf");
