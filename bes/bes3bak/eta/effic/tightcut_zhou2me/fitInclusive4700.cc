...
int fitInclusive4700()
{
  ...
  chain_data->Add("../../signal/cutmassroot/zhou2me/4700signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/zhou2me/4700shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("../../pdf/zhou2me/4700_sig_shapepdf.root");
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/zhou2me/4700signal.root");
