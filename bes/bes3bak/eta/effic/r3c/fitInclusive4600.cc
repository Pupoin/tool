...
int fitInclusive4600()
{
  ...
  chain_shape->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/shape/cutmassroot/update_r3c/4600shape.root");
  ...
  RooRealVar mean("mean", "mean", 0.0002, -0.001, 0.001);
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal/cutmassroot/update_r3c/4600signal.root");
