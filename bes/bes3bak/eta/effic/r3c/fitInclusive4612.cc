...
int fitInclusive4612()
{
  ...
  chain_shape->Add("../shape/cutmassroot/4612shape_mass.root");
  ...
  RooRealVar mean("mean", "mean", 0.00015, -0.0, 0.005);
  ...
  chain_data->Add("../signal/cutmassroot/4612signal_mass.root");
