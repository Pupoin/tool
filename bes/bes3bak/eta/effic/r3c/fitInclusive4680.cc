...
int fitInclusive4680()
{
  ...
  chain_shape->Add("../shape/cutmassroot/4680shape_mass.root");
  ...
  RooRealVar sigma("sigma", "sigma", 0.001, 0, 0.002);
  RooRealVar mean("mean", "mean", 3.5952e-04);
  ...
  chain_data->Add("../signal/cutmassroot/4680signal_mass.root");
  ...
  data->plotOn(frame, LineWidth(3), Binning(xbins));
