...
int fitInclusive4660()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2/4660signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/eta/pdf/tightcut_r3c_minchi2/4660_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 0.000350459, 0, 0.000350459+(0.000819202*5));
  RooRealVar mean("mean", "mean", -0.000281872, -0.000281872-(1.57592e-05*5), -0.000281872+(1.57592e-05*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2/4660signal.root");
  ...
  // pt->SetLineColor(5);
  // pt->SetTextColor(5);
  pt->InsertText("#Lambda_{c}^{+} #rightarrow #Sigma^{+} #eta(#gamma#gamma)");
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4660_Lc2eta_2a.pdf");
