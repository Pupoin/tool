...
int fit_comb_chi2()
{
    ...
    // 3pi
    RooFormulaVar nsig_mode0_3pi_sig("nsig_mode0_3pi_sig", "signal of mode0_3pi sig", "Bratio * nsig_mode0* 0.115432423  *effic3pi_4600_sig/  0.503631863  /effic_4600_ref", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_3pi_sig("nbkg0_3pi_sig", "bkg number of mode0_3pi sig", 0.05 * tr_fit0_3pi_sig->GetEntries(), 0, 1.2 * tr_fit0_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode1_3pi_sig("nsig_mode1_3pi_sig", "signal of mode1_3pi sig", "Bratio * nsig_mode1* 0.115432423  *effic3pi_4612_sig/  0.503631863  /effic_4612_ref", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_3pi_sig("nbkg1_3pi_sig", "bkg number of mode1_3pi sig", 0.05 * tr_fit1_3pi_sig->GetEntries(), 0, 1.2 * tr_fit1_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode2_3pi_sig("nsig_mode2_3pi_sig", "signal of mode2_3pi sig", "Bratio * nsig_mode2* 0.115432423  *effic3pi_4620_sig/  0.503631863  /effic_4620_ref", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_3pi_sig("nbkg2_3pi_sig", "bkg number of mode2_3pi sig", 0.05 * tr_fit2_3pi_sig->GetEntries(), 0, 1.2 * tr_fit2_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode3_3pi_sig("nsig_mode3_3pi_sig", "signal of mode3_3pi sig", "Bratio * nsig_mode3* 0.115432423  *effic3pi_4640_sig/  0.503631863  /effic_4640_ref", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_3pi_sig("nbkg3_3pi_sig", "bkg number of mode3_3pi sig", 0.05 * tr_fit3_3pi_sig->GetEntries(), 0, 1.2 * tr_fit3_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode4_3pi_sig("nsig_mode4_3pi_sig", "signal of mode4_3pi sig", "Bratio * nsig_mode4* 0.115432423  *effic3pi_4660_sig/  0.503631863  /effic_4660_ref", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_3pi_sig("nbkg4_3pi_sig", "bkg number of mode4_3pi sig", 0.05 * tr_fit4_3pi_sig->GetEntries(), 0, 1.2 * tr_fit4_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode5_3pi_sig("nsig_mode5_3pi_sig", "signal of mode5_3pi sig", "Bratio * nsig_mode5* 0.115432423  *effic3pi_4680_sig/  0.503631863  /effic_4680_ref", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_3pi_sig("nbkg5_3pi_sig", "bkg number of mode5_3pi sig", 0.05 * tr_fit5_3pi_sig->GetEntries(), 0, 1.2 * tr_fit5_3pi_sig->GetEntries());
    RooFormulaVar nsig_mode6_3pi_sig("nsig_mode6_3pi_sig", "signal of mode6_3pi sig", "Bratio * nsig_mode6* 0.115432423  *effic3pi_4700_sig/  0.503631863  /effic_4700_ref", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_3pi_sig("nbkg6_3pi_sig", "bkg number of mode6_3pi sig", 0.05 * tr_fit6_3pi_sig->GetEntries(), 0, 1.2 * tr_fit6_3pi_sig->GetEntries());
