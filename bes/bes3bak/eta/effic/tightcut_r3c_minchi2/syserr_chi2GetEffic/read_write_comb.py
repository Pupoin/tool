import ROOT
from ROOT import TBranch, TTree, TFile, RDataFrame
import argparse
import os
import os.path
import importlib
...
fileName = "list_fitcomb/log.fit_comb.Br"
...
rdf=ROOT.RDataFrame("tree", "Br.root")
rdf2=rdf.Define("Br_Brnorm", "Br - 0.305185 ")
rdf2.Snapshot("tree", "Br_addBr.root")
