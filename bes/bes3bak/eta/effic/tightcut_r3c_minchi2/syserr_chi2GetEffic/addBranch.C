...
void addBranch()
{
    ROOT::RDataFrame rdf("tree", "effic.root");
    ...
    auto  rdf2 = rdf.Define("eff_norm4600", "effic_4600 - 0.0861")
                    .Define("eff_norm4612", "effic_4612 - 0.0845")
                    .Define("eff_norm4620", "effic_4620 - 0.0830")
                    .Define("eff_norm4640", "effic_4640 - 0.0818")
                    .Define("eff_norm4660", "effic_4660 - 0.0799")
                    .Define("eff_norm4680", "effic_4680 - 0.0787")
                    .Define("eff_norm4700", "effic_4700 - 0.0771")
                ;
    ...
    // rdf2.Snapshot("tree", "AAA_covGaus.root", branchList);
    rdf2.Snapshot("tree", "effic_addBr.root");
