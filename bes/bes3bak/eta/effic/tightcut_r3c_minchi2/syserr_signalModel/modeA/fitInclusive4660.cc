...
int fitInclusive4660()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2/4660signal_Costheta_sigma.root");
  ...
  RooRealVar sigma("sigma", "sigma", 8.4376e-06, 0, 8.4376e-06+(0.000899579*5));
  RooRealVar mean("mean", "mean", -0.000291816, -0.000291816-(0.000126142*5), -0.000291816+(0.000126142*5));
