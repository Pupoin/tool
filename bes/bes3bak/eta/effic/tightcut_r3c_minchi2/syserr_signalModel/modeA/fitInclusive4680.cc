...
int fitInclusive4680()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/eta/signal_new/cutmassroot/tightcut_r3c_minchi2/4680signal_Costheta_sigma.root");
  ...
  RooRealVar sigma("sigma", "sigma", 1.19439e-05, 0, 1.19439e-05+(2.93415e-07*5));
  RooRealVar mean("mean", "mean", 0.000808498, 0.000808498-(0.000495205*5), 0.000808498+(0.000495205*5));
