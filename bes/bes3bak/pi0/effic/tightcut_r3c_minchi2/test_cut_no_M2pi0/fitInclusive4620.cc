...
RooRealVar *M_BC_r3c = new RooRealVar("M_BC_r3c", "M_BC_r3c", 2.25, 2.31387, "");
...
int fitInclusive4620()
{
  ...
  TCut cut_mbc = "((M_BC_r3c>=2.25) && (M_BC_r3c<=2.31387))";
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/4620signal_adddipim.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minchi2/4620shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4620_ref_shapepdf.root");
  ...
  sumpdf.Print("t");
  M_BC_r3c->setRange("signal",  2.25, 2.31387);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/4620signal.root");
  ...
  pt->InsertText(TString::Format("#sqrt{s} = %.3f GeV", 2.31387*2) );
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4620_Lc2pi0.pdf");
  canv1->SaveAs("effic4620.png");
  return 0;
}
