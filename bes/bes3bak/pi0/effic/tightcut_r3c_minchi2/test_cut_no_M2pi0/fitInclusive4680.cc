...
RooRealVar *M_BC_r3c = new RooRealVar("M_BC_r3c", "M_BC_r3c", 2.25, 2.34079, "");
...
int fitInclusive4680()
{
  ...
  TCut cut_mbc = "((M_BC_r3c>=2.25) && (M_BC_r3c<=2.34079))";
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/4680signal_adddipim.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minchi2/4680shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4680_ref_shapepdf.root");
  ...
  sumpdf.Print("t");
  M_BC_r3c->setRange("signal",  2.25, 2.34079);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/4680signal.root");
  ...
  pt->InsertText(TString::Format("#sqrt{s} = %.3f GeV", 2.34079*2) );
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4680_Lc2pi0.pdf");
  canv1->SaveAs("effic4680.png");
  return 0;
}
