...
int fitInclusive4600()
{
  ...
  RooRealVar sigma("sigma", "sigma", 2.4275e-06, 0, 2.4275e-06+(7.08144e-07*5));
  RooRealVar mean("mean", "mean", 0.000212562, 0.000212562-(1.95726e-06*5), 0.000212562+(1.95726e-06*5));
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4600_Lc2pi0.pdf");
