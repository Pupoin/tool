...
RooRealVar *M_BC_r3c = new RooRealVar("M_BC_r3c", "M_BC_r3c", 2.25, 2.33046, "");

int fitInclusive4660()
{
  ...
  Double_t xmin = 2.25, xmax = 2.33046;
  Double_t   xbins = 50;
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/4660signal_adddipim.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minchi2/4660shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4660_ref_shapepdf.root");
  ...
  sumpdf.Print("t");
  M_BC_r3c->setRange("signal",  2.25, 2.33046);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/4660signal.root");
  ...
  pt->InsertText(TString::Format("#sqrt{s} = %.3f GeV", 2.33046*2) );
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4660_Lc2pi0.pdf");
  canv1->SaveAs("effic4660.png");
  return 0;
}
