...
int fitInclusive4600()
{
  ...
  // RooRealVar *M_BC_r3c = new RooRealVar("M_BC_r3c", "M_BC_r3c", 2.25, 2.3, "");
  ...
  RooRealVar sigma("sigma", "sigma", 1.41255e-06, 0, 1.41255e-06+(1.58731e-09*5));
  RooRealVar mean("mean", "mean", 6.6592e-06, 6.6592e-06-(4.44366e-06*5), 6.6592e-06+(4.44366e-06*5));
