...
int fitInclusive4700()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/4700signal_adddipim.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minchi2/4700shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/4700_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 1.63517e-05, 0, 1.63517e-05+(5.53829e-08*5));
  RooRealVar mean("mean", "mean", 0.000272949, 0.000272949-(8.89732e-06*5), 0.000272949+(8.89732e-06*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/4700signal.root");
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4700_Lc2pi0.pdf");
