...
int fitInclusive4700()
{
  ...
  RooRealVar sigma("sigma", "sigma", 0.000694505, 0, 0.000694505+(4.23576e-05*5));
  RooRealVar mean("mean", "mean", 8.40629e-07, 8.40629e-07-(1.20063e-05*5), 8.40629e-07+(1.20063e-05*5));
