...
int fitInclusive4700()
{
  ...
  RooRealVar sigma("sigma", "sigma", 1.63048e-06, 0, 1.63048e-06+(1.16282e-09*5));
  RooRealVar mean("mean", "mean", 2.10682e-05, 2.10682e-05-(5.9365e-06*5), 2.10682e-05+(5.9365e-06*5));
