...
int fitInclusive_energy_()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/_energy_signal_adddipim.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minchi2/_energy_shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/pdf/tightcut_r3c_minchi2/_energy__ref_shapepdf.root");
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/signal/cutmassroot/tightcut_r3c_minchi2/_energy_signal.root");
