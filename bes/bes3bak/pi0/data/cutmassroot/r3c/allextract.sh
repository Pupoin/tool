...
sed -i "s|shape|4600data|" -i extract_dipi4600.C
...
sed -i "s|shape|4612data|" -i extract_dipi4612.C
...
sed -i "s|shape|4620data|" -i extract_dipi4620.C
...
sed -i "s|shape|4640data|" -i extract_dipi4640.C
...
sed -i "s|shape|4660data|" -i extract_dipi4660.C
...
sed -i "s|shape|4680data|" -i extract_dipi4680.C
...
sed -i "s|shape|4700data|" -i extract_dipi4700.C
