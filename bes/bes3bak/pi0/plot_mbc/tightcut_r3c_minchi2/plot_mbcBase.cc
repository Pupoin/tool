...
using namespace std;
int plot_mbc_energy_()
{

    // setStyle();
    // setPad();
    double factor[2] = {0.0320, 0.0340};
    ...
    double xmin = 2.25, xmax = _endpoint_;
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/LL/cutmassroot/tightcut_r3c_minchi2/_energy_LL_adddipim.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/data/cutmassroot/tightcut_r3c_minchi2/_energy_data_adddipim.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/pi0/hadron/cutmassroot/tightcut_r3c_minchi2/_energy_hadron_rmLc.root");
    ...
    TLegend *legend = new TLegend(0.2, 0.58, 0.46, 0.84);
    legend->SetHeader(TString::Format("#sqrt{s} = %.3f GeV", _endpoint_*2 ));
    ...
    canv1->Update();
    canv1->SaveAs("stack_energy_.pdf");
    canv1->SaveAs("stack_energy_.png");
    return 0;
}
