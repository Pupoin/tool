...
void extract_dipi() 
{
  ...
  Double_t deltaE_min_r3c, M_BC_r3c, pi0m, pi0mORetam1m, sigmamR1c, chi2_min_r1c, g1[4], g2[4], g3[4], g4[4];
  Int_t event, signal, indexmc, pdgid[200], np, npbar;
  Int_t flag1;

  TChain *chain = new TChain("tree");
  chain->Add("../shape.root");
  ...
  t->SetBranchAddress("deltaE_min_r3c", &deltaE_min_r3c);
  t->SetBranchAddress("M_BC_r3c", &M_BC_r3c);
  ...
  t->SetBranchAddress("flag1", &flag1);

  // new file
  TFile *f_new = new TFile("shape_cut_mass_dipi.root", "recreate");
  TTree *tree = new TTree("tree", "");

  Int_t m_event, m_indexmc, m_pdgid[200], m_Lc, m_np, m_npbar, m_signal;
  Double_t m_deltaE_min_r3c, m_M_BC_r3c, m_pi0mORetam1m, m_pi0m, m_dipim, m_sigmamR1c, m_chi2_min_r1c;
  Int_t m_flag1=0;
  ...
  for (int i = 0; i < n; i++) {
    ...
    m_event = event;
    m_deltaE_min_r3c = deltaE_min_r3c;
    m_M_BC_r3c = M_BC_r3c;
    m_indexmc = indexmc;
    m_np = np;
    m_npbar = npbar;
