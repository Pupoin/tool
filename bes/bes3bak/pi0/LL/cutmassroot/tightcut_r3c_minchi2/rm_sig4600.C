...
void rm_sig4600()
{
    ROOT::RDataFrame rdf("tree", "4600LL_adddipim.root");
    ...
    // rdf2.Snapshot("tree", "4600LL_adddipim_rmsig.root", branchList );
    rdf2.Snapshot("tree", "4600LL_adddipim_rmsig.root" );
    //rdf2.Snapshot("tree", "4600LL_rmLc.root");
