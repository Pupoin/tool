...
void rm_sig4680()
{
    ROOT::RDataFrame rdf("tree", "4680LL_adddipim.root");
    ...
    // rdf2.Snapshot("tree", "4680LL_adddipim_rmsig.root", branchList );
    rdf2.Snapshot("tree", "4680LL_adddipim_rmsig.root" );
    //rdf2.Snapshot("tree", "4680LL_rmLc.root");
