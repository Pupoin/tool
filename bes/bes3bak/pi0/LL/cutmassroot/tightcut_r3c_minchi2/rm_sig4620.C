...
void rm_sig4620()
{
    ROOT::RDataFrame rdf("tree", "4620LL_adddipim.root");
    ...
    // rdf2.Snapshot("tree", "4620LL_adddipim_rmsig.root", branchList );
    rdf2.Snapshot("tree", "4620LL_adddipim_rmsig.root" );
    //rdf2.Snapshot("tree", "4620LL_rmLc.root");
