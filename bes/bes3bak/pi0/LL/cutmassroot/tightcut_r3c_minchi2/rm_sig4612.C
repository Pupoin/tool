...
void rm_sig4612()
{
    ROOT::RDataFrame rdf("tree", "4612LL_adddipim.root");
    ...
    // rdf2.Snapshot("tree", "4612LL_adddipim_rmsig.root", branchList );
    rdf2.Snapshot("tree", "4612LL_adddipim_rmsig.root" );
    //rdf2.Snapshot("tree", "4612LL_rmLc.root");
