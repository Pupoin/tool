...
void rm_sig4700()
{
    ROOT::RDataFrame rdf("tree", "4700LL_adddipim.root");
    ...
    // rdf2.Snapshot("tree", "4700LL_adddipim_rmsig.root", branchList );
    rdf2.Snapshot("tree", "4700LL_adddipim_rmsig.root" );
    //rdf2.Snapshot("tree", "4700LL_rmLc.root");
