...
void rm_sig4660()
{
    ROOT::RDataFrame rdf("tree", "4660LL_adddipim.root");
    ...
    // rdf2.Snapshot("tree", "4660LL_adddipim_rmsig.root", branchList );
    rdf2.Snapshot("tree", "4660LL_adddipim_rmsig.root" );
    //rdf2.Snapshot("tree", "4660LL_rmLc.root");
