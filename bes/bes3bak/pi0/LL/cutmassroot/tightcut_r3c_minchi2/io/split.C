...
void split()
{
    ...
    string files[]={
"../4600LL_adddipim.root", 
"../4612LL_adddipim.root", 
"../4620LL_adddipim.root", 
"../4640LL_adddipim.root", 
"../4660LL_adddipim.root", 
"../4680LL_adddipim.root", 
"../4700LL_adddipim.root"
    };
    ...
    {   
        ...
        for(int i=0; i<7; i++)
        {
            ...
            auto num = rdf0.Count();
            double numm = *num;
            auto rdf = rdf0//.Range(int(numm*0.7))                        
                            .Filter("(chi2_min_r3c<17) &&((M_BC_r3c>=2.25) && (M_BC_r3c<=2.34919)) && (np !=0 && npbar != 0) && (dipim<0.44 || dipim>0.52) ");
