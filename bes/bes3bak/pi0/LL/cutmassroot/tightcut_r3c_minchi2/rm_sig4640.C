...
void rm_sig4640()
{
    ROOT::RDataFrame rdf("tree", "4640LL_adddipim.root");
    ...
    // rdf2.Snapshot("tree", "4640LL_adddipim_rmsig.root", branchList );
    rdf2.Snapshot("tree", "4640LL_adddipim_rmsig.root" );
    //rdf2.Snapshot("tree", "4640LL_rmLc.root");
