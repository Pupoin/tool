...
# can.Divide(2, 7)
sig_fileDirPath="/publicfs/ucas/user/yuanchy8/7.0.6/pi0/shape/cutmassroot/tightcut_r3c_minchi2/"
# ref_fileDirPath="/publicfs/ucas/user/yuanchy8/7.0.6/pi0/shape_new/cutmassroot/tightcut_r3c_minchi2/"
#%% __ sig __

chain = TChain("tree")
for i in range(0, len(energy)):
    fff = sig_fileDirPath + "{0}shape_adddipim.root".format(energy[i])
    print fff
    chain.Add(fff)
...
wspace.writeToFile("shapepdf.root")

frame = chi2_min_r3c.frame(ROOT.RooFit.Title("pi0 chi2 shape"))
shape.plotOn(frame)
