...
def cal_Costheta_sigma(file):
    ...
    rdf2 = rdf.Filter("M_BC_r3c>2.25  && chi2_min_r3c<30 && np!=0 && npbar!=0" ) \
                ...
                .Define("Lc_px", "sigma_px + gam1_r3c[0]+gam2_r3c[0] +p_pim_r3c[0] + p_pip_r3c[0]")\
                .Define("Lc_py", "sigma_py + gam1_r3c[1]+gam2_r3c[1] +p_pim_r3c[1] + p_pip_r3c[1]")\
                .Define("Lc_pz", "sigma_pz + gam1_r3c[2]+gam2_r3c[2] +p_pim_r3c[2] + p_pip_r3c[2]")\
                .Define("Lc_e",  "sigma_e  + gam1_r3c[3]+gam2_r3c[3] +p_pim_r3c[3] + p_pip_r3c[3] ")\
...
if __name__ == "__main__":
    ...
    fileList = ["4600LL.root", "4612LL.root", "4620LL.root", "4640LL.root", "4660LL.root", "4680LL.root", "4700LL.root"]
