...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4612signal_Costheta_sigma.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minetap/4612shape.root");
