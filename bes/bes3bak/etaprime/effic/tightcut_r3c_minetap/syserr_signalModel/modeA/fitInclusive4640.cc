...
int fitInclusive4640()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4640signal_Costheta_sigma.root");
  ...
  RooRealVar sigma("sigma", "sigma", 9.39379e-06, 0, 9.39379e-06+(0.000526273*5));
  RooRealVar mean("mean", "mean", 7.27847e-05, 7.27847e-05-(2.83465*5), 7.27847e-05+(2.83465*5));
  ...
  m_fitres = sumpdf.fitTo(*data, Save(kTRUE),SumW2Error(kTRUE), Extended(kTRUE));
