...
int fitInclusive4680()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4680signal_selB.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minetap/4680shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minetap/4680_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 7.42087e-06, 0, 7.42087e-06+(5.74664e-06*5));
  RooRealVar mean("mean", "mean", 0.0004596, 0.0004596-(3.55336e-06*5), 0.0004596+(3.55336e-06*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4680signal.root");
