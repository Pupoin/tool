...
int fitInclusive4640()
{
  ...
  TString d(" MeV/#font[12]{#font[12]{c^{2}}})");
  ...
  TCut cut_sum1 = (cut_chi2 && cut_chi2 && cut_np);
  

  // get the data _______________________________
  TChain *chain_data = new TChain("tree");
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4640signal_selB.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minetap/4640shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minetap/4640_sig_shapepdf.root");
  ...
  frame->GetXaxis()->SetTitle("M_{BC} (GeV/#font[12]{#font[12]{c^{2}}})");
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4640signal.root");
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4640_Lc2etaprime.pdf");
