...
void addBranch()
{
    ...
    auto  rdf2 = rdf.Define("eff_norm4600", "effic_4600 - 0.0314")
                    .Define("eff_norm4612", "effic_4612 - 0.0284")
                    .Define("eff_norm4620", "effic_4620 - 0.0283")
                    .Define("eff_norm4640", "effic_4640 - 0.0283")
                    .Define("eff_norm4660", "effic_4660 - 0.0280")
                    .Define("eff_norm4680", "effic_4680 - 0.0280")
                    .Define("eff_norm4700", "effic_4700 - 0.0279")
                ;
