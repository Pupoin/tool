...
int fitInclusive4640()
{
  ...
  // TCut cut_deltaE = "(chi2CovGaus<30)";
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4640signal_selB_covGaus.root");
  ...
  RooRealVar sigma("sigma", "sigma", 5.4712e-06, -0.0, 0.0001);
  RooRealVar mean("mean", "mean", 2.7469e-04,  -0.001, 0.001);
