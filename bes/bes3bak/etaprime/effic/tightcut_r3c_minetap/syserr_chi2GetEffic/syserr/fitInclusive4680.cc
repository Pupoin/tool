...
int fitInclusive4680()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4680signal_selB_covGaus.root");
  ...
  RooRealVar sigma("sigma", "sigma", 1.0655e-05, -0.0, 0.001);
  RooRealVar mean("mean", "mean", 4.0667e-05, -0.00, 0.001);
