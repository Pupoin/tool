...
int fitInclusive4620()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4620signal_selB_covGaus.root");
  ...
  RooRealVar sigma("sigma", "sigma", 4.1269e-04, -0.0, 0.00151);
  RooRealVar mean("mean", "mean", 6.1488e-05, -0.001, 0.0001);
