...
int fitInclusive4660()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap/4660signal_selB_covGaus.root");
  ...
  RooRealVar sigma("sigma", "sigma", 8.6059e-06, -0.00, 0.0001);
  RooRealVar mean("mean", "mean", -7.7285e-05, -0.001, 0.00);
