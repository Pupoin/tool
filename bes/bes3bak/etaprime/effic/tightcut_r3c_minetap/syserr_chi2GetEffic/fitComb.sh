...
do
    ...
    then 
        ...
        do 
            ...
            sed -i "s|RooRealVar sigma_all.*$|RooRealVar sigma_all(\"sigma_all\", \"sigma_all\", $sigmav, 0, $sigmav+($sigmae*5));|" fit_comb_chi2.C 
            sed -i "s|RooRealVar mean_all.*$|RooRealVar mean_all(\"mean_all\", \"mean_all\", $meanv, $meanv-($meane*5), $meanv+($meane*5));|" fit_comb_chi2.C 
            root -l -b -q fit_comb_chi2.C > log.fit_comb  
