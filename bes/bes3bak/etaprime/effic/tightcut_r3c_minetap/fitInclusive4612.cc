...
int fitInclusive4612()
{
  ...
  RooRealVar sigma("sigma", "sigma", 1.73389e-06, 0, 1.73389e-06+(2.12259e-08*5));
  RooRealVar mean("mean", "mean", -5.83322e-05, -5.83322e-05-(1.96059e-06*5), -5.83322e-05+(1.96059e-06*5));
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4612_Lc2etaprime.pdf");
