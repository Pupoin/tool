...
int fitInclusive4640()
{
  ...
  chain_data->Add("../../signal/cutmassroot/zhou/4640signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/zhou/4640shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("../../pdf/zhou/4640_sig_shapepdf.root");
  ...
  // pt->SetLineColor(5);
  // pt->SetTextColor(5);
  TText *text = pt->AddText("E=4.640 GeV");
  pt->Draw();
  c1->Update();
  ...
  c1->SaveAs("pic_fitInclusive4640.svg");
  return 0;
}
