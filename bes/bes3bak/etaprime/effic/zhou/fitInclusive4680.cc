...
int fitInclusive4680()
{
  ...
  chain_data->Add("../../signal/cutmassroot/zhou/4680signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/zhou/4680shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("../../pdf/zhou/4680_sig_shapepdf.root");
  ...
  // pt->SetLineColor(5);
  // pt->SetTextColor(5);
  TText *text = pt->AddText("E=4.680 GeV");
  pt->Draw();
  c1->Update();
  ...
  c1->SaveAs("pic_fitInclusive4680.svg");
  return 0;
}
