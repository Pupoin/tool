...
int fitInclusive4660()
{
  ...
  chain_data->Add("../../signal/cutmassroot/zhou/4660signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/zhou/4660shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("../../pdf/zhou/4660_sig_shapepdf.root");
  ...
  // pt->SetLineColor(5);
  // pt->SetTextColor(5);
  TText *text = pt->AddText("E=4.660 GeV");
  pt->Draw();
  c1->Update();
  ...
  c1->SaveAs("pic_fitInclusive4660.svg");
  return 0;
}
