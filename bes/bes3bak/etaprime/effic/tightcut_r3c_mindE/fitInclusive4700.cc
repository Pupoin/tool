...
int fitInclusive4700()
{
  ...
  TFile *file_sig_pdf = TFile::Open("../../pdf/tightcut_r3c_mindE/4700_sig_shapepdf.root");
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_mindE/4700signal.root");
