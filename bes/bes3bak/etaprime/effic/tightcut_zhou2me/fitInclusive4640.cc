...
int fitInclusive4640()
{
  ...
  TCut cut_mbc = "((M_BC>=2.25) && (M_BC<=2.320255))";
  TCut cut_sum1 = (cut_deltaE && cut_mbc);
  

  // get the data _______________________________
  TChain *chain_data = new TChain("tree");
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_zhou2me/4640signal_removedouble.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_zhou2me/4640shape_removedouble.root");
  // TTree *tr_fit = chain_shape->CopyTree(cut_sum1, "");
  // RooRealVar *M_BC = new RooRealVar("M_BC", "M_BC", 2.25, 2.320255, "");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_zhou2me/4640_sig_shapepdf.root");
  ...
  sumpdf.Print("t");
  M_BC->setRange("signal", 2.25, 2.320255);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_zhou2me/4640signal.root");
