...
int fitInclusive4700()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_zhou2me/4700signal_removedouble.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_zhou2me/4700shape_removedouble.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_zhou2me/4700_sig_shapepdf.root");
  ...
  sumpdf.Print("t");
  M_BC->setRange("signal", 2.25, 2.34919);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_zhou2me/4700signal.root");
