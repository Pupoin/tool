...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_zhou2me/4612signal_removedouble.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_zhou2me/4612_sig_shapepdf.root");
  ...
  RooRealVar mean("mean", "mean", -2.6278e-05);//, -0.001, 0.001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_zhou2me/4612signal.root");
