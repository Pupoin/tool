...
int fitInclusive4660()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_zhou2me/4660signal_removedouble.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_zhou2me/4660shape_removedouble.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_zhou2me/4660_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 0.0003076298, -0.0, 0.003);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_zhou2me/4660signal.root");
