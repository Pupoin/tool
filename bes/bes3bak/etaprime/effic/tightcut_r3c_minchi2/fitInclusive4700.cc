...
int fitInclusive4700()
{
  ...
  chain_data->Add("../../signal/cutmassroot/tightcut_r3c_minchi2/4700signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("../../pdf/tightcut_r3c_minchi2/4700_sig_shapepdf.root");
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minchi2/4700signal.root");
