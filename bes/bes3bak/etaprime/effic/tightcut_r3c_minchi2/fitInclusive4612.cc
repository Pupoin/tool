...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minchi2/4612signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minchi2/4612_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 4.5296e-05, -0.0, 0.0001);
  RooRealVar mean("mean", "mean", 6.9299e-07, 0, 0.00001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minchi2/4612signal.root");
