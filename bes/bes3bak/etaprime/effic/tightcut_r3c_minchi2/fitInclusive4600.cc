...
int fitInclusive4600()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minchi2/4600signal.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minchi2/4600shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minchi2/4600_sig_shapepdf.root");
  ...
  RooRealVar mean("mean", "mean", 8.5628e-05, -0.00, 0.001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minchi2/4600signal.root");
