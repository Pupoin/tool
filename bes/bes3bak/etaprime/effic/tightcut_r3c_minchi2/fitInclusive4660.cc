...
int fitInclusive4660()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minchi2/4660signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minchi2/4660_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 3.5729e-06, -0.00, 0.0001);
  RooRealVar mean("mean", "mean", -2.3119e-05, -0.001, 0.00);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minchi2/4660signal.root");
