...
int fitInclusive4640()
{
  ...
  // TCut cut_deltaE = "(chi2_min_r3c<29)";
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minchi2/4640signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minchi2/4640_sig_shapepdf.root");
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minchi2/4640signal.root");
