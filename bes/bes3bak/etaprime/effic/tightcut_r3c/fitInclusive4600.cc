...
int fitInclusive4600()
{
  ...
  TCut cut_deltaE = "(chi2_min_r3c<20)";
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c/4600signal.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c/4600shape_mass.root");
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c/4600signal.root");
