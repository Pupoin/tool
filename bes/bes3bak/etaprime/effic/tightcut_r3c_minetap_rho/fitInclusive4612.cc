...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap_rho/4612signal_selB.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minetap_rho/4612_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 3.39555e-06, 0, 3.39555e-06+(0.000506531*5));
  RooRealVar mean("mean", "mean", -0.000101364, -0.000101364-(1.43727e-05*5), -0.000101364+(1.43727e-05*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap_rho/4612signal.root");
