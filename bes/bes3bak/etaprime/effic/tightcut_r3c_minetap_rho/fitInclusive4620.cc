...
int fitInclusive4620()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap_rho/4620signal_selB.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minetap_rho/4620_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 7.21471e-07, 0, 7.21471e-07+(4.08818e-09*5));
  RooRealVar mean("mean", "mean", -0.00012259, -0.00012259-(1.42784e-05*5), -0.00012259+(1.42784e-05*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap_rho/4620signal.root");
