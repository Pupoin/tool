...
int fitInclusive4700()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap_rho/4700signal_selB.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minetap/4700shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minetap_rho/4700_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 1.34825e-05, 0, 1.34825e-05+(0.00058029*5));
  RooRealVar mean("mean", "mean", 8.66138e-05, 8.66138e-05-(0.000190219*5), 8.66138e-05+(0.000190219*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/tightcut_r3c_minetap_rho/4700signal.root");
