...
int fitInclusive4620()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/minetaprime/4620signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/minetaprime/4620shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/minetaprime/4620_sig_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 2.8608e-05, -0.0, 0.001);
  RooRealVar mean("mean", "mean", 2.4101e-06, -0.001, 0.001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/minetaprime/4620signal.root");
