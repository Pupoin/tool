...
int fitInclusive4660()
{
  ...
  TCut cut_mbc = "((M_BC_1c>=2.25) && (M_BC_1c<=2.33046))";
  TCut cut_sum1 = (cut_deltaE && cut_mbc);
  

  // get the data _______________________________
  TChain *chain_data = new TChain("tree");
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/minetaprime/4660signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/minetaprime/4660shape_mass.root");
  // TTree *tr_fit = chain_shape->CopyTree(cut_sum1, "");
  // RooRealVar *M_BC_1c = new RooRealVar("M_BC_1c", "M_BC_1c", 2.25, 2.33046, "");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/minetaprime/4660_sig_shapepdf.root");
  ...
  sumpdf.Print("t");
  M_BC_1c->setRange("signal", 2.25, 2.33046);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/signal/cutmassroot/minetaprime/4660signal.root");
