...
#cut_deltaE_sig = "(chi2_min_r3c<30 )"
#cut_deltaE_ref = "(chi2_min_r3c<30 )"
...
can.Divide(2, 7)
sig_fileDirPath="/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/shape/cutmassroot/tightcut_r3c_minetap_eta2pipipi0/"
...
#%% __ ref __
# ref_filepath=[]
# ref_filepath.append(ref_fileDirPath + "4600shape_selB.root")
# ref_filepath.append(ref_fileDirPath + "4612shape_selB.root")
# ref_filepath.append(ref_fileDirPath + "4620shape_selB.root")
# ref_filepath.append(ref_fileDirPath + "4640shape_selB.root")
# ref_filepath.append(ref_fileDirPath + "4660shape_selB.root")
# ref_filepath.append(ref_fileDirPath + "4680shape_selB.root")
# ref_filepath.append(ref_fileDirPath + "4700shape_selB.root")

# for sig
for i in range(6, len(sig_filepath)):
    ...
    wspace_sig.writeToFile(sig_fileDirPath + "../../../pdf/tightcut_r3c_minetap_eta2pipipi0//{}_sig_shapepdf.root".format(str(energy[i])))
...
#     wspace_ref.writeToFile( ref_fileDirPath+ "../../../pdf/tightcut_r3c_minomega//{}_ref_shapepdf.root".format(str(energy[i])))
