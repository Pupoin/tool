...
cut_deltaE_sig = "(chi2_min_r3c<38 && np!=0 && npbar !=0 )"
cut_deltaE_ref = "(chi2_min_r3c<38 && np!=0 && npbar !=0 )"
...
can.Divide(2, 7)
sig_fileDirPath="/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/shape/cutmassroot/tightcut_r3c_mindE/"
ref_fileDirPath="/publicfs/ucas/user/yuanchy8/7.0.6/omega/shape/cutmassroot/tightcut_r3c_mindE/"
#%% __ sig __
sig_filepath = []
...
for i in range(0, len(sig_filepath)):
    ...
    wspace.writeToFile(sig_fileDirPath + "../../../pdf/tightcut_r3c_mindE//{}_sig_shapepdf.root".format(str(energy[i])))
...
for i in range(0, len(ref_filepath)):
    ...
    wspace.writeToFile( ref_fileDirPath+ "../../../pdf/tightcut_r3c_mindE//{}_ref_shapepdf.root".format(str(energy[i])))
