...
can.Divide(2, 7)
sig_fileDirPath="/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/shape/cutmassroot/tightcut_r3c_minetap_rho/"
...
for i in range(0, len(sig_filepath)):
    ...
    wspace_sig.writeToFile(sig_fileDirPath + "../../../pdf/tightcut_r3c_minetap_rho//{}_sig_shapepdf.root".format(str(energy[i])))
