...
int plot_mbc4680()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/LL/cutmassroot/zhou2me/4680LL_mass.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/zhou2me/4680data_mass.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/hadron/cutmassroot/zhou2me/4680hadron_mass.root");
