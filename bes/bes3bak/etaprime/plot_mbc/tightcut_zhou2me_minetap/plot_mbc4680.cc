...
int plot_mbc4680()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/LL/cutmassroot/tightcut_zhou2me_minetap/4680LL.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/tightcut_zhou2me_minetap/4680data.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/hadron/cutmassroot/tightcut_zhou2me_minetap/4680hadron_mode.root");
    ...
    TCut cut_deltaE = "((deltaE_min_1c>-0.020) && (deltaE_min_1c<0.02))";
    TCut cut_np = "(np!=0 && npbar != 0)";
    //TCut cut_chi2 = "(chi2_min_r1c<13)";
    TCut cut_mbc = "((M_BC_1c>=2.25) && (M_BC_1c<=2.3407900))";
    TCut cut_sum1 = (cut_mbc && cut_deltaE && cut_np  && "etaprimem1c>0.946 && etaprimem1c<0.968");
    ...
    chain_hardon->Project("hist_hardon", "M_BC_1c", cut_sum1);
