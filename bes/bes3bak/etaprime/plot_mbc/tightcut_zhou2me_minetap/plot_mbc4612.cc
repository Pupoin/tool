...
int plot_mbc4612()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/LL/cutmassroot/tightcut_zhou2me/4612LL_removedouble.root");
    chain_data->Add(     "/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/tightcut_zhou2me/4612data_removedouble.root");
    chain_hardon->Add(   "/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/hadron/cutmassroot/tightcut_zhou2me/4612hadron_removedouble_mode.root");
