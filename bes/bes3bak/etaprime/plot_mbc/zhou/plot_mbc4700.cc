...
int plot_mbc4700()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/zhou/4700LL_mass.root");
    chain_data->Add("../data/cutmassroot/zhou/4700data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/zhou/4700hadron_mass.root");
