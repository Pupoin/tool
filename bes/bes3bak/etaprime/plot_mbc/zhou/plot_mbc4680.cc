...
int plot_mbc4680()
{
    ...
    // setStyle();
    // setPad();
    double factor[2] = {0.01250, 0.0250};
    ...
    chain_inclusive->Add("../LL/cutmassroot/zhou/4680LL_mass.root");
    chain_data->Add("../data/cutmassroot/zhou/4680data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/zhou/4680hadron_mass.root");
