...
int plot_mbc4640()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/zhou/4640LL_mass.root");
    chain_data->Add("../data/cutmassroot/zhou/4640data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/zhou/4640hadron_mass.root");
