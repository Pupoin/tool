...
int plot_mbc4660()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/zhou/4660LL_mass.root");
    chain_data->Add("../data/cutmassroot/zhou/4660data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/zhou/4660hadron_mass.root");
