...
int plot_mbc4612()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/zhou/4612LL_mass.root");
    chain_data->Add("../data/cutmassroot/zhou/4612data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/zhou/4612hadron_mass.root");
