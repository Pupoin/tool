...
int plot_mbc4620()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/zhou/4620LL_mass.root");
    chain_data->Add("../data/cutmassroot/zhou/4620data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/zhou/4620hadron_mass.root");
