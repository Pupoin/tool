...
int plot_mbc4600()
{
    ...
    chain_inclusive->Add("../LL/cutmassroot/zhou/4600LL_mass.root");
    chain_data->Add("../data/cutmassroot/zhou/4600data_mass.root");
    chain_hardon->Add("../hadron/cutmassroot/zhou/4600hadron_mass.root");
