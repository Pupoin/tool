...
using namespace std;
int plot_mbcall_noproton()
{

    // setStyle();
    // setPad();
    double factor[2] = {0.01050, 0.0690};
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/LL/cutmassroot/tightcut_r3c_minetap/LL.root");
    ...
    TCut cut_sum1 = (cut_mbc && cut_chi2);
    ...
    canv1->SaveAs("stackall_noproton.png");
    canv1->SaveAs("stackall_noproton.pdf");
    return 0;
}
