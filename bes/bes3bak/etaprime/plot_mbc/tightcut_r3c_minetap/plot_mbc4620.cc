...
int plot_mbc4620()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/LL/cutmassroot/tightcut_r3c_minetap/4620LL_selB.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/tightcut_r3c_minetap/4620data_selB.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/hadron/cutmassroot/tightcut_r3c_minetap/4620hadron_selB.root");
    ...
    legend->SetHeader(TString::Format("#sqrt{s} = %.3f GeV", 2.31387*2 ));
    ...
    canv1->Update();
    canv1->SaveAs("stack4620.pdf");
    canv1->SaveAs("stack4620.png");
    return 0;
}
