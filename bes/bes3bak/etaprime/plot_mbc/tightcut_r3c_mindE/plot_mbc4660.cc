...
int plot_mbc4660()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/LL/cutmassroot/tightcut_r3c_mindE/4660LL.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/tightcut_r3c_mindE/4660data.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/hadron/cutmassroot/tightcut_r3c_mindE/4660hadron_mode.root");
    ...
    TCut cut_mbc = "((M_BC_r3c>=2.25) && (M_BC_r3c<=2.3304600))";
