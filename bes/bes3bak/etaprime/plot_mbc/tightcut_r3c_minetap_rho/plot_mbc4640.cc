...
int plot_mbc4640()
{
    ...
    double xmin = 2.25, xmax = 2.320255;
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/LL/cutmassroot/tightcut_r3c_minetap/4640LL_selB.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/tightcut_r3c_minetap/4640data_selB.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/hadron/cutmassroot/tightcut_r3c_minetap/4640hadron_selB.root");
    ...
    legend->SetHeader(TString::Format("#sqrt{s} = %.3f GeV", 2.320255*2 ));
    ...
    canv1->Update();
    canv1->SaveAs("stack4640.pdf");
    canv1->SaveAs("stack4640.png");
    return 0;
}
