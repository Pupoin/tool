...
int plot_mbc4600()
{
    ...
    double xmin = 2.25, xmax = 2.299765;
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/LL/cutmassroot/tightcut_r3c_minetap/4600LL_selB.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/tightcut_r3c_minetap/4600data_selB.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/hadron/cutmassroot/tightcut_r3c_minetap/4600hadron_selB.root");
    ...
    legend->SetHeader(TString::Format("#sqrt{s} = %.3f GeV", 2.299765*2 ));
