...
int massetap()
{
    ...
    hist_massetap->GetXaxis()->SetTitle(" m_{#eta'(#rho#gamma)} (GeV/#font[12]{c^{2}})");
    ...
    TArrow *ar2 = new TArrow(0.946,50,0.946,3000,0.02,"<|");
    ar2->SetAngle(40);
    ar2->SetLineWidth(2);
    ar2->SetLineColor(4);
    ar2->SetFillColor(4);
    ...
    TArrow *ar3 = new TArrow(0.968,50,0.968,3000,0.02,"<|");
    ar3->SetAngle(40);
    ar3->SetLineWidth(2);
    ar3->SetLineColor(4);
    ar3->SetFillColor(4);
