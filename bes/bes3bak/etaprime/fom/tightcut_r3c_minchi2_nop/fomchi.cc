...
int fomchi()
{
    ...
    chain->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/LL/cutmassroot/tightcut_r3c_minchi2/LL.root"); 
    chain->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/hadron/cutmassroot/tightcut_r3c_minchi2/hadron.root"); 
