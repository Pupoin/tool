...
int plot_dE1D()
{
    ...
    TCanvas *canva1 = new TCanvas("canva1", "mbc", 700, 600);
    ...
    auto *hist = new TH1F("hist", "", 49, 1, 50);
    ...
    hist->SetLabelSize(0.045,"xy");

    TArrow *ar2 = new TArrow(10 ,35, 10, 24 ,0.025,"|>");
    ar2->SetAngle(40);
    ar2->SetLineWidth(2);
    ar2->SetLineColor(4);
    ar2->Draw();
    ...
    canva1->SaveAs("pic_fom.png");
    canva1->SaveAs("pic_fom.pdf");
