...
TCut cut_deltaE_sig = "((deltaE_min_1c>-0.023) && (deltaE_min_1c<0.02))";  TCut cut_sig = (cut_mbc && cut_deltaE_sig);
TCut cut_deltaE_ref = "((deltaE_min_1c>-0.023) && (deltaE_min_1c<0.015))"; TCut cut_ref = (cut_mbc && cut_deltaE_ref);
...
int fit_comb()
{
	...
	//
	// sig 
	TChain *tr_data0_sig = new TChain("tree");    tr_data0_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/minetaprime/4600data_mass.root");
	TChain *tr_data1_sig = new TChain("tree");    tr_data1_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/minetaprime/4612data_mass.root");
	TChain *tr_data2_sig = new TChain("tree");    tr_data2_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/minetaprime/4620data_mass.root");
	TChain *tr_data3_sig = new TChain("tree");	  tr_data3_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/minetaprime/4640data_mass.root");
	TChain *tr_data4_sig = new TChain("tree");	  tr_data4_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/minetaprime/4660data_mass.root");
	TChain *tr_data5_sig = new TChain("tree");	  tr_data5_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/minetaprime/4680data_mass.root");
	TChain *tr_data6_sig = new TChain("tree");    tr_data6_sig->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/minetaprime/4700data_mass.root");

	// ref
	TChain *tr_data0 = new TChain("tree");    tr_data0->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4600data_mass.root");
	TChain *tr_data1 = new TChain("tree");    tr_data1->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4612data_mass.root");
	TChain *tr_data2 = new TChain("tree");    tr_data2->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4620data_mass.root");
	TChain *tr_data3 = new TChain("tree");	  tr_data3->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4640data_mass.root");
	TChain *tr_data4 = new TChain("tree");	  tr_data4->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4660data_mass.root");
	TChain *tr_data5 = new TChain("tree");	  tr_data5->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4680data_mass.root");
	TChain *tr_data6 = new TChain("tree");    tr_data6->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4700data_mass.root");
	...
	*/
	RooRealVar mean_sig("mean_sig", "mean_sig",  4.0819e-05, -0.001, 0.001);
	RooRealVar sigma_sig("sigma_sig", "sigma_sig",  1.1335e-05, 0, 0.003);
	RooGaussModel gauss_sig("gauss_sig", "gauss_sig", *M_BC_1c, mean_sig, sigma_sig);
	
	RooRealVar mean_ref("mean_ref", "mean_ref",  4.0819e-05, -0.001, 0.001);
	RooRealVar sigma_ref("sigma_ref", "sigma_ref",  1.1335e-05, 0, 0.003);
	RooGaussModel gauss_ref("gauss_ref", "gauss_ref", *M_BC_1c, mean_ref, sigma_ref);

	// sig-- shape
	TFile *pdf0_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/minetaprime/4600_sig_shapepdf.root"); RooWorkspace *wspace0_sig = (RooWorkspace *)pdf0_sig->Get("wspace"); RooAbsPdf *shapepdf0_sig = wspace0_sig->pdf("modelPdf");
	TFile *pdf1_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/minetaprime/4612_sig_shapepdf.root"); RooWorkspace *wspace1_sig = (RooWorkspace *)pdf1_sig->Get("wspace"); RooAbsPdf *shapepdf1_sig = wspace1_sig->pdf("modelPdf");
	TFile *pdf2_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/minetaprime/4620_sig_shapepdf.root"); RooWorkspace *wspace2_sig = (RooWorkspace *)pdf2_sig->Get("wspace"); RooAbsPdf *shapepdf2_sig = wspace2_sig->pdf("modelPdf");
	TFile *pdf3_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/minetaprime/4640_sig_shapepdf.root"); RooWorkspace *wspace3_sig = (RooWorkspace *)pdf3_sig->Get("wspace"); RooAbsPdf *shapepdf3_sig = wspace3_sig->pdf("modelPdf");
	TFile *pdf4_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/minetaprime/4660_sig_shapepdf.root"); RooWorkspace *wspace4_sig = (RooWorkspace *)pdf4_sig->Get("wspace"); RooAbsPdf *shapepdf4_sig = wspace4_sig->pdf("modelPdf");
	TFile *pdf5_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/minetaprime/4680_sig_shapepdf.root"); RooWorkspace *wspace5_sig = (RooWorkspace *)pdf5_sig->Get("wspace"); RooAbsPdf *shapepdf5_sig = wspace5_sig->pdf("modelPdf");
	TFile *pdf6_sig = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/minetaprime/4700_sig_shapepdf.root"); RooWorkspace *wspace6_sig = (RooWorkspace *)pdf6_sig->Get("wspace"); RooAbsPdf *shapepdf6_sig = wspace6_sig->pdf("modelPdf");

	// ref-- shape
	TFile *pdf0 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4612_ref_shapepdf.root"); RooWorkspace *wspace0 = (RooWorkspace *)pdf0->Get("wspace"); RooAbsPdf *shapepdf0 = wspace0->pdf("modelPdf");
	TFile *pdf1 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4612_ref_shapepdf.root"); RooWorkspace *wspace1 = (RooWorkspace *)pdf1->Get("wspace"); RooAbsPdf *shapepdf1 = wspace1->pdf("modelPdf");
	TFile *pdf2 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4620_ref_shapepdf.root"); RooWorkspace *wspace2 = (RooWorkspace *)pdf2->Get("wspace"); RooAbsPdf *shapepdf2 = wspace2->pdf("modelPdf");
	TFile *pdf3 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4640_ref_shapepdf.root"); RooWorkspace *wspace3 = (RooWorkspace *)pdf3->Get("wspace"); RooAbsPdf *shapepdf3 = wspace3->pdf("modelPdf");
	TFile *pdf4 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4660_ref_shapepdf.root"); RooWorkspace *wspace4 = (RooWorkspace *)pdf4->Get("wspace"); RooAbsPdf *shapepdf4 = wspace4->pdf("modelPdf");
	TFile *pdf5 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4680_ref_shapepdf.root"); RooWorkspace *wspace5 = (RooWorkspace *)pdf5->Get("wspace"); RooAbsPdf *shapepdf5 = wspace5->pdf("modelPdf");
	TFile *pdf6 = new TFile("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4700_ref_shapepdf.root"); RooWorkspace *wspace6 = (RooWorkspace *)pdf6->Get("wspace"); RooAbsPdf *shapepdf6 = wspace6->pdf("modelPdf");

	// sig-- shape x guass
	RooAbsPdf *sigpdf0_sig = new RooFFTConvPdf("sigpdf0_sig", "modelPdf (X) gauss", *M_BC_1c, *shapepdf0_sig, gauss_sig);
	RooAbsPdf *sigpdf1_sig = new RooFFTConvPdf("sigpdf1_sig", "modelPdf (X) gauss", *M_BC_1c, *shapepdf1_sig, gauss_sig);
	RooAbsPdf *sigpdf2_sig = new RooFFTConvPdf("sigpdf2_sig", "modelPdf (X) gauss", *M_BC_1c, *shapepdf2_sig, gauss_sig);
	RooAbsPdf *sigpdf3_sig = new RooFFTConvPdf("sigpdf3_sig", "modelPdf (X) gauss", *M_BC_1c, *shapepdf3_sig, gauss_sig);
	RooAbsPdf *sigpdf4_sig = new RooFFTConvPdf("sigpdf4_sig", "modelPdf (X) gauss", *M_BC_1c, *shapepdf4_sig, gauss_sig);
	RooAbsPdf *sigpdf5_sig = new RooFFTConvPdf("sigpdf5_sig", "modelPdf (X) gauss", *M_BC_1c, *shapepdf5_sig, gauss_sig);
	RooAbsPdf *sigpdf6_sig = new RooFFTConvPdf("sigpdf6_sig", "modelPdf (X) gauss", *M_BC_1c, *shapepdf6_sig, gauss_sig);


	// ref-- shape x guass
	RooAbsPdf *sigpdf0 = new RooFFTConvPdf("sigpdf0", "modelPdf (X) gauss", *M_BC_1c, *shapepdf0, gauss_ref);
	RooAbsPdf *sigpdf1 = new RooFFTConvPdf("sigpdf1", "modelPdf (X) gauss", *M_BC_1c, *shapepdf1, gauss_ref);
	RooAbsPdf *sigpdf2 = new RooFFTConvPdf("sigpdf2", "modelPdf (X) gauss", *M_BC_1c, *shapepdf2, gauss_ref);
	RooAbsPdf *sigpdf3 = new RooFFTConvPdf("sigpdf3", "modelPdf (X) gauss", *M_BC_1c, *shapepdf3, gauss_ref);
	RooAbsPdf *sigpdf4 = new RooFFTConvPdf("sigpdf4", "modelPdf (X) gauss", *M_BC_1c, *shapepdf4, gauss_ref);
	RooAbsPdf *sigpdf5 = new RooFFTConvPdf("sigpdf5", "modelPdf (X) gauss", *M_BC_1c, *shapepdf5, gauss_ref);
	RooAbsPdf *sigpdf6 = new RooFFTConvPdf("sigpdf6", "modelPdf (X) gauss", *M_BC_1c, *shapepdf6, gauss_ref);
	...
	RooFormulaVar nsig_mode0_sig("nsig_mode0_sig", "signal of mode0 sig", "Bratio * nsig_mode0* 0.085560  *0.0366/  0.44924  /0.0266", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", /*23, 10, 50  */ 0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries());
	RooFormulaVar nsig_mode1_sig("nsig_mode1_sig", "signal of mode1 sig", "Bratio * nsig_mode1* 0.085560  *0.0336/  0.44924  /0.0252", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", /*23, 10, 50  */ 0.05 * tr_fit1_sig->GetEntries(), 0, 1.1 * tr_fit1_sig->GetEntries());
	RooFormulaVar nsig_mode2_sig("nsig_mode2_sig", "signal of mode2 sig", "Bratio * nsig_mode2* 0.085560  *0.0352/  0.44924  /0.0240", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", /*23, 10, 50  */ 0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries());
	RooFormulaVar nsig_mode3_sig("nsig_mode3_sig", "signal of mode3 sig", "Bratio * nsig_mode3* 0.085560  *0.0360/  0.44924  /0.0247", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", /*19, 10, 50  */ 0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries());
	RooFormulaVar nsig_mode4_sig("nsig_mode4_sig", "signal of mode4 sig", "Bratio * nsig_mode4* 0.085560  *0.0361/  0.44924  /0.0251", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", /*28, 10, 50  */ 0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries());
	RooFormulaVar nsig_mode5_sig("nsig_mode5_sig", "signal of mode5 sig", "Bratio * nsig_mode5* 0.085560  *0.0369/  0.44924  /0.0246", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", /*102, 10, 150*/ 0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries());
	RooFormulaVar nsig_mode6_sig("nsig_mode6_sig", "signal of mode6 sig", "Bratio * nsig_mode6* 0.085560  *0.0372/  0.44924  /0.0245", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", /*30, 10, 50  */ 0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries());
	...
	RooDataSet *combData = new RooDataSet("combData", "combined data", *M_BC_1c, Index(combine), 
	...
	RooRealVar frac("frac", "fraction of component in signal", 1/7.);
	RooAddPdf *pdf_sig = new RooAddPdf("pdf_sig", "pdf_sig", RooArgList(*model0_sig, *model1_sig, *model2_sig, *model3_sig, *model4_sig, *model5_sig, *model6_sig ), 
																      RooArgList(frac, frac, frac, frac, frac, frac, frac));
	
	// RooAddPdf *pdf_sig = new RooAddPdf("pdf_sig", "pdf_sig", RooArgList( *model6_sig ), 
																    //   RooArgList( frac));

	
	RooRealSumFunc *pdf_ref = new RooRealSumFunc("pdf_ref", "pdf_ref", RooArgList(*model0, *model1, *model2, *model3, *model4, *model5, *model6 ), 
																      RooArgList(frac, frac, frac, frac, frac, frac, frac));

	RooPlot *frame_mode_sig = M_BC_1c->frame( xmin, 2.34919, 25);
	frame_mode_sig->SetXTitle("M_BC_1c (GeV)");
	frame_mode_sig->SetYTitle(ytitle);
	// frame_mode_sig->SetTitle("#sqrt{s}=4.70 GeV, 532 pb^{-1}");
	...
	pdf_sig->plotOn(frame_mode_sig, LineColor(kRed), LineWidth(3));
	pdf_sig->plotOn(frame_mode_sig, Components("*sigpdf*"), LineColor(kGreen), LineWidth(3), LineStyle(kDashed));
	pdf_sig->plotOn(frame_mode_sig, Components("*argus*"),LineColor(kBlue), LineWidth(3), LineStyle(kDashed));

	RooAbsReal *isig2 = sigpdf6_sig->createIntegral(*M_BC_1c, NormSet(*M_BC_1c), Range(2.276, 2.293));
	RooAbsReal *ibkg = argus6_sig.createIntegral(*M_BC_1c, NormSet(*M_BC_1c), Range(2.276, 2.293));
	cout << __LINE__ <<  " nsig_4700: " <<  sigpdf6_sig->getVal()<< endl;
	cout << __LINE__ << " nbkg_4700: " << argus6_sig.getVal() << endl;


	model6_sig->plotOn(frame_mode_sig, LineColor(kRed), LineWidth(3));
	model6_sig->plotOn(frame_mode_sig, Components("*sigpdf6_sig"), LineColor(kGreen), LineWidth(3), LineStyle(kDashed));
	model6_sig->plotOn(frame_mode_sig, Components("argus6_sig"), LineColor(kBlue), LineWidth(3), LineStyle(kDashed));

	 isig2 = sigpdf6_sig->createIntegral(*M_BC_1c, NormSet(*M_BC_1c), Range(2.276, 2.293));
	 ibkg = argus6_sig.createIntegral(*M_BC_1c, NormSet(*M_BC_1c), Range(2.276, 2.293));
	cout << __LINE__ <<  " nsig_4700: " <<  sigpdf6_sig->getVal() << endl;
	cout << __LINE__ << " nbkg_4700: " << argus6_sig.getVal() << endl;
