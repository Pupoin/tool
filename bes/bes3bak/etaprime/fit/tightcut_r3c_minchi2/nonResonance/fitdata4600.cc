...
RooRealVar *M_BC_r3c = new RooRealVar("M_BC_r3c", "M_BC_r3c", 2.25, energy[0], "");

int fitdata4600()
{
  Double_t xmin = 2.25, xmax = energy[0];
  Double_t   xbins = 20;
...
TCut cut_sig = (cut_mbc && "(chi2_min_r3c< 30)" && cut_np);  
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/tightcut_r3c_minetap/4600data_selB2.root");
