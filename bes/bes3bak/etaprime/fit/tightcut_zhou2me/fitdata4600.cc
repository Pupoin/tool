...
int fitdata4600()
{
  ...
  TCut cut_deltaE = "((deltaE_min>-0.02) && (deltaE_min<0.02))";
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/data/cutmassroot/tightcut_zhou2me/4600data.root");
  ...
  RooRealVar sigma("sigma", "sigma", 8.4505e-06, -0.001, 0.001);
  RooRealVar mean("mean", "mean", 4.6652e-04, -0.00, 0.001);
  ...
  c1->SaveAs("pic_fitInclusive4600.png");
  return 0;
}
