...
TCut cut_ref = (cut_mbc && "(chi2_min_r3c< 30)" );
TCut cut_sig = (cut_mbc && "(chi2_min_r3c< 30)");
...
// 15 3.9
// 10 3.6
Double_t FCN_bkg = -58748.6;
RooRealVar Bratio("Bratio", "Br of sig/ref", 0.37574, 0., 0.7);	
// RooRealVar Bratio("Bratio", "Br of sig/ref", 0);	

int fit_comb_nodemandp()
{
    ...
    RooRealVar sigma_all("sigma_all", "sigma_all",  5.3322e-05, 0, 0.001);
    ...
    RooFormulaVar nsig_mode0_sig("nsig_mode0_sig", "signal of mode0 sig", "Bratio * nsig_mode0* 0.085359238  *0.0646/  0.449239622  /0.0680", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", 0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries());
    RooFormulaVar nsig_mode1_sig("nsig_mode1_sig", "signal of mode1 sig", "Bratio * nsig_mode1* 0.085359238  *0.0595/  0.449239622  /0.0639", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", 0.05 * tr_fit1_sig->GetEntries(), 0, 1.2 * tr_fit1_sig->GetEntries());
    RooFormulaVar nsig_mode2_sig("nsig_mode2_sig", "signal of mode2 sig", "Bratio * nsig_mode2* 0.085359238  *0.0587/  0.449239622  /0.0631", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", 0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries());
    RooFormulaVar nsig_mode3_sig("nsig_mode3_sig", "signal of mode3 sig", "Bratio * nsig_mode3* 0.085359238  *0.0591/  0.449239622  /0.0627", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", 0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries());
    RooFormulaVar nsig_mode4_sig("nsig_mode4_sig", "signal of mode4 sig", "Bratio * nsig_mode4* 0.085359238  *0.0580/  0.449239622  /0.0612", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", 0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries());
    RooFormulaVar nsig_mode5_sig("nsig_mode5_sig", "signal of mode5 sig", "Bratio * nsig_mode5* 0.085359238  *0.0579/  0.449239622  /0.0608", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", 0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries());
    RooFormulaVar nsig_mode6_sig("nsig_mode6_sig", "signal of mode6 sig", "Bratio * nsig_mode6* 0.085359238  *0.0573/  0.449239622  /0.0601", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", 0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries());
    ...
    if(1)
    {
        ...
        can->SaveAs("svg_fit_comb_nodemandp.pdf");
        can->SaveAs("svg_fit_comb_nodemandp.png");
    }
    ...
    if(1)
    {
        ...
        RooPlot *frame_mode_sig = M_BC_r3c->frame( mbcmin, mbcmax, 30);
        ...
        can3->SaveAs("svg_fit_comb_sig_nodemandp.png");
        can3->SaveAs("svg_fit_comb_sig_nodemandp.pdf");
        ...
        can4->SaveAs("svg_fit_comb_ref_nodemandp.png");
        can4->SaveAs("svg_fit_comb_ref_nodemandp.pdf");
    }
