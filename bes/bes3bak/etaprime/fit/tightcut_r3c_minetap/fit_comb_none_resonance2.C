...
RooRealVar Bratio("Bratio", "Br of sig/ref", 0.37574, 0., 100);	
// RooRealVar Bratio("Bratio", "Br of sig/ref", 0);	

int fit_comb_none_resonance()
{
    ...
    RooRealVar nsig_mode0_sig("nsig_mode0_sig", "signal of mode0 sig", 0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries());	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", 0.05 * tr_fit0_sig->GetEntries(), 0, 1.2 * tr_fit0_sig->GetEntries());
    RooRealVar nsig_mode1_sig("nsig_mode1_sig", "signal of mode1 sig", 0.05 * tr_fit1_sig->GetEntries(), 0, 1.2 * tr_fit1_sig->GetEntries());	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", 0.05 * tr_fit1_sig->GetEntries(), 0, 1.2 * tr_fit1_sig->GetEntries());
    RooRealVar nsig_mode2_sig("nsig_mode2_sig", "signal of mode2 sig", 0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries());	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", 0.05 * tr_fit2_sig->GetEntries(), 0, 1.2 * tr_fit2_sig->GetEntries());
    RooRealVar nsig_mode3_sig("nsig_mode3_sig", "signal of mode3 sig", 0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries());	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", 0.05 * tr_fit3_sig->GetEntries(), 0, 1.2 * tr_fit3_sig->GetEntries());
    RooRealVar nsig_mode4_sig("nsig_mode4_sig", "signal of mode4 sig", 0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries());	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", 0.05 * tr_fit4_sig->GetEntries(), 0, 1.2 * tr_fit4_sig->GetEntries());
    RooRealVar nsig_mode5_sig("nsig_mode5_sig", "signal of mode5 sig", 0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries());	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", 0.05 * tr_fit5_sig->GetEntries(), 0, 1.2 * tr_fit5_sig->GetEntries());
    RooRealVar nsig_mode6_sig("nsig_mode6_sig", "signal of mode6 sig", 0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries());	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", 0.05 * tr_fit6_sig->GetEntries(), 0, 1.2 * tr_fit6_sig->GetEntries());
    ...
    model0_sig->fitTo(*data0_sig, Save(kTRUE), Extended(kTRUE));
    model1_sig->fitTo(*data1_sig, Save(kTRUE), Extended(kTRUE));
    model2_sig->fitTo(*data2_sig, Save(kTRUE), Extended(kTRUE));
    model3_sig->fitTo(*data3_sig, Save(kTRUE), Extended(kTRUE));
    model4_sig->fitTo(*data4_sig, Save(kTRUE), Extended(kTRUE));
    model5_sig->fitTo(*data5_sig, Save(kTRUE), Extended(kTRUE));
    model6_sig->fitTo(*data6_sig, Save(kTRUE), Extended(kTRUE));

    model0->fitTo(*data0, Save(kTRUE), Extended(kTRUE));
    model1->fitTo(*data1, Save(kTRUE), Extended(kTRUE));
    model2->fitTo(*data2, Save(kTRUE), Extended(kTRUE));
    model3->fitTo(*data3, Save(kTRUE), Extended(kTRUE));
    model4->fitTo(*data4, Save(kTRUE), Extended(kTRUE));
    model5->fitTo(*data5, Save(kTRUE), Extended(kTRUE));
    model6->fitTo(*data6, Save(kTRUE), Extended(kTRUE));
    ...
    */
    ...
    if(1)
    {
        ...
        can3->SaveAs("svg_fit_comb_sig_noresonance.png");
        ...
        can4->SaveAs("svg_fit_comb_ref_noresonance.png");
