...
int fit_comb()
{
    ...
    double Br_sig_inter = 0.085250942; // pdg 2022
    ...
    if(1)
    {
        ...
        frame_mode_sig->SetXTitle("M_{BC} (GeV/#font[12]{#font[12]{c^{2}}})");
        ...
        frame_mode_ref->SetXTitle("M_{BC} (GeV/#font[12]{#font[12]{c^{2}}})");
...
cout << __LINE__ << "@@@@ " << total_sig_sig << " " << " " <<" " << total_bkg_sig_left <<" " <<  " " << " " << total_bkg_sig_right <<" " <<  " " << endl; 
cout << __LINE__ << "@@@@ sig/bkg_sid " << total_sig_sig/(total_bkg_sig_right+total_bkg_sig_left)  << endl; 
