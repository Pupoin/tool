...
void fitpull()
{
   ...
   RooPlot *frame = x.frame(Title(" "), Bins(12));
   data->plotOn(frame);
   ...
   c->SaveAs("toy_etapio_pullfit.png");
   c->SaveAs("toy_etapio_pullfit.pdf");
