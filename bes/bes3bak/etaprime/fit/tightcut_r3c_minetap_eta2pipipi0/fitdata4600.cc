...
int fitdata4600()
{
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/pdf/tightcut_r3c_minetap_eta2pipipi0/4700_sig_shapepdf.root");
  ...
  c1->Update();
     ...
     TArrow *ar2 = new TArrow(2.276 , 8, 2.276, 0 ,0.025,"|>");
    ar2->SetAngle(40);
    ar2->SetLineColor(2);
    ar2->SetLineWidth(2);
    ar2->Draw();

       TArrow *ar = new TArrow(2.294, 8, 2.294, 0 ,0.025,"|>");
    ar->SetAngle(40);
    ar->SetLineColor(2);
    ar->SetLineWidth(2);
    ar->Draw();
  ...
  c1->SaveAs("pic_fitInclusive.png");  
  c1->SaveAs("pic_fitInclusive.pdf");
