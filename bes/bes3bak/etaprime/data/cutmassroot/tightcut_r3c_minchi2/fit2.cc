...
int fit2()
{
  ...
  chain_shape->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/shape/cutmassroot/tightcut_r3c_minchi2/4700shape.root");
  ...
  RooRealVar sigma("sigma", "sigma", 3.8880e-05, 0, 0.001);
  RooRealVar mean("mean", "mean", 4.4283e-04, -0.00, 0.001);
  RooGaussian gauss("gauss", "gauss", *M_BC_r3c, mean, sigma);

  // convoluted shapePdf with gauss_________________
  RooAbsPdf *SignalPdf = new RooFFTConvPdf("sig", "modelPdf (X) gauss", *M_BC_r3c, *modelPdf, gauss);
  ...
  cout << "m_fitres->minNll(): " <<m_fitres->minNll() << endl;
    ...
    // -756.454
    double sb = m_fitres->minNll(), bbb = -874.492;
