int plot()
{
    ...
    // np!=0 && npbar!=0
    TCut cut="M_BC_r3c>2.25 && chi2_min_r3c<30 && etaprimemr3c>0.946 && etaprimemr3c<0.968";
    c.Project("h1", "M_BC_r3c", cut); 

    TCut cut2="M_BC_r3c>2.25 && (np !=0 && npbar != 0) && chi2_min_r3c<30 && etaprimemr3c>0.946 && etaprimemr3c<0.968";
    c.Project("h2", "M_BC_r3c", cut2); 
    ...
    h1->SetTitle("");
    h1->GetYaxis()->SetTitle(TString::Format("Events(%.2fMeV/#font[12]{c^{2}})", (2.35-2.25)/xbin*1000));
    ...
    legend->AddEntry("h2", "request proton\n recoiled", "l");
    legend->AddEntry("h1", "not request proton recoiled", "l");
