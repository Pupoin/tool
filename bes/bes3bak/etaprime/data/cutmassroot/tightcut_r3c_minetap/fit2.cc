...
int fit2()
{
  ...
  chain_shape->Add("/publicfs/ucas/user/yuanchy8/7.0.6/etaprime/shape/cutmassroot/tightcut_r3c_minetap/4700shape_selB.root");
  ...
  RooRealVar mean("mean", "mean", 3.2876e-05, -0.00, 0.001);
  ...
  cout << "m_fitres->minNll(): " <<m_fitres->minNll() << endl;
    ...
    // -756.454
    double sb = m_fitres->minNll(), bbb = -769.36;
