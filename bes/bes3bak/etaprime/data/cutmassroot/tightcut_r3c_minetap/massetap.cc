...
int massetap()
{
    ...
    chain_massetap->Project("hist_massetap", "etaprimemr3c", "M_BC_r3c>2.25 && etaprimemr3c>0.9&&etaprimemr3c<1.04 && (chi2_min_r3c<30 && np!=0 && npbar !=0 )");
    ...
    hist_massetap->GetXaxis()->SetTitle(" m_{#eta'(#pi^{+}#pi^{-}#eta)} (GeV/#font[12]{c^{2}})");
    ...
    TArrow *arrow1 = new TArrow(0.91, 30., 0.91, 0., 0.05, ">");
    arrow1 -> SetLineWidth(4);
    arrow1 -> SetLineColor(4);
    //arrow1 -> SetAngle(40);
    TArrow *arrow2 = new TArrow(0.93, 30., 0.93, 0., 0.05, ">");
    arrow2 -> SetLineWidth(4);
    arrow2 -> SetLineColor(4);
	arrow1 -> Draw();
	arrow2 -> Draw();
	TArrow *arrow3 = new TArrow(1, 30., 1, 0., 0.05, ">");
    arrow3 -> SetLineWidth(4);
    arrow3 -> SetLineColor(4);
    TArrow *arrow4 = new TArrow(1.02, 30., 1.02, 0., 0.05, ">");
    arrow4 -> SetLineWidth(4);
    arrow4 -> SetLineColor(4);
	arrow3 -> Draw();
	arrow4 -> Draw();
	TArrow *arrow5 = new TArrow(0.946, 30., 0.946, 0., 0.05, ">");
    arrow5 -> SetLineWidth(4);
    arrow5 -> SetLineColor(2);
    TArrow *arrow6 = new TArrow(0.968, 30., 0.968, 0., 0.05, ">");
    ...
    canva1->SaveAs("pic_massetap_indata.png");
    canva1->SaveAs("pic_massetap_indata.pdf");
