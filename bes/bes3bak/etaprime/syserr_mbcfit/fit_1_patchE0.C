...
int main(int args, char **argv )
{
    ...
    // sig
    RooDataSet *data0_sig = (RooDataSet*) dataspace->data("data_etaprime_4600_bootstrap");
    RooDataSet *data1_sig = (RooDataSet*) dataspace->data("data_etaprime_4612_bootstrap");
    RooDataSet *data2_sig = (RooDataSet*) dataspace->data("data_etaprime_4620_bootstrap");
    RooDataSet *data3_sig = (RooDataSet*) dataspace->data("data_etaprime_4640_bootstrap");
    RooDataSet *data4_sig = (RooDataSet*) dataspace->data("data_etaprime_4660_bootstrap");
    RooDataSet *data5_sig = (RooDataSet*) dataspace->data("data_etaprime_4680_bootstrap");
    RooDataSet *data6_sig = (RooDataSet*) dataspace->data("data_etaprime_4700_bootstrap");
    // ref
    RooDataSet *data0 = (RooDataSet*) dataspace->data("data_omega_4600_bootstrap");
    RooDataSet *data1 = (RooDataSet*) dataspace->data("data_omega_4612_bootstrap");
    RooDataSet *data2 = (RooDataSet*) dataspace->data("data_omega_4620_bootstrap");
    RooDataSet *data3 = (RooDataSet*) dataspace->data("data_omega_4640_bootstrap");
    RooDataSet *data4 = (RooDataSet*) dataspace->data("data_omega_4660_bootstrap");
    RooDataSet *data5 = (RooDataSet*) dataspace->data("data_omega_4680_bootstrap");
    RooDataSet *data6 = (RooDataSet*) dataspace->data("data_omega_4700_bootstrap");
    ...
    RooRealVar m0_sig("m0_sig", "m0_sig", -0.0005*rnd->Integer(2) + 2.299765);   RooRealVar c0_sig("c0_sig", "c0_sig", -2.1266e+01, -70, 20);    RooArgusBG argus0_sig("argus0_sig", "argus0 sig", *var_4600, m0_sig, c0_sig);
    RooRealVar m1_sig("m1_sig", "m1_sig", -0.0005*rnd->Integer(2) + 2.30579);    RooRealVar c1_sig("c1_sig", "c1_sig", -6.0660e+00, -70, 20);    RooArgusBG argus1_sig("argus1_sig", "argus1 sig", *var_4612, m1_sig, c1_sig);
    RooRealVar m2_sig("m2_sig", "m2_sig", -0.0005*rnd->Integer(2) + 2.31387);    RooRealVar c2_sig("c2_sig", "c2_sig", -4.9716e+00, -70, 20);    RooArgusBG argus2_sig("argus2_sig", "argus2 sig", *var_4620, m2_sig, c2_sig);
    RooRealVar m3_sig("m3_sig", "m3_sig", -0.0005*rnd->Integer(2) + 2.320255);   RooRealVar c3_sig("c3_sig", "c3_sig", -2.4289e+00, -70, 20);    RooArgusBG argus3_sig("argus3_sig", "argus3 sig", *var_4640, m3_sig, c3_sig);
    RooRealVar m4_sig("m4_sig", "m4_sig", -0.0005*rnd->Integer(2) + 2.33046);    RooRealVar c4_sig("c4_sig", "c4_sig", -2.2689e+01, -70, 20);    RooArgusBG argus4_sig("argus4_sig", "argus4 sig", *var_4660, m4_sig, c4_sig);
    RooRealVar m5_sig("m5_sig", "m5_sig", -0.0005*rnd->Integer(2) + 2.34079);    RooRealVar c5_sig("c5_sig", "c5_sig", -9.3432e+00, -70, 20);    RooArgusBG argus5_sig("argus5_sig", "argus5 sig", *var_4680, m5_sig, c5_sig);
    RooRealVar m6_sig("m6_sig", "m6_sig", -0.0005*rnd->Integer(2) + 2.34919);    RooRealVar c6_sig("c6_sig", "c6_sig", -7.9593e+00, -70, 20);    RooArgusBG argus6_sig("argus6_sig", "argus6 sig", *var_4700, m6_sig, c6_sig);

    // ____________________ ref argus background
    RooRealVar m0("m0", "m0", -0.0005*rnd->Integer(2) + 2.299765);   RooRealVar c0("c0", "c0", -7.5954e+0,  -70, 20);    RooArgusBG argus0("argus0", "argus0", *var_4600, m0, c0);
    RooRealVar m1("m1", "m1", -0.0005*rnd->Integer(2) + 2.30579);    RooRealVar c1("c1", "c1", 1.4943e+01,  -70, 20);    RooArgusBG argus1("argus1", "argus1", *var_4612, m1, c1);
    RooRealVar m2("m2", "m2", -0.0005*rnd->Integer(2) + 2.31387);    RooRealVar c2("c2", "c2", 2.9315e+00,  -70, 20);    RooArgusBG argus2("argus2", "argus2", *var_4620, m2, c2);
    RooRealVar m3("m3", "m3", -0.0005*rnd->Integer(2) + 2.320255);   RooRealVar c3("c3", "c3", -3.1054e+00, -70, 20);    RooArgusBG argus3("argus3", "argus3", *var_4640, m3, c3);
    RooRealVar m4("m4", "m4", -0.0005*rnd->Integer(2) + 2.33046);    RooRealVar c4("c4", "c4", -4.8423e+00, -70, 20);    RooArgusBG argus4("argus4", "argus4", *var_4660, m4, c4);
    RooRealVar m5("m5", "m5", -0.0005*rnd->Integer(2) + 2.34079);    RooRealVar c5("c5", "c5", -4.3007e+00, -70, 20);    RooArgusBG argus5("argus5", "argus5", *var_4680, m5, c5);
    RooRealVar m6("m6", "m6", -0.0005*rnd->Integer(2) + 2.34919);    RooRealVar c6("c6", "c6", -5.4013e+00, -70, 20);    RooArgusBG argus6("argus6", "argus6", *var_4700, m6, c6);
    ...
    RooFormulaVar nsig_mode0_sig("nsig_mode0_sig", "signal of mode0 sig", "Bratio * nsig_mode0* 0.085359238  *0.0314/  0.449239622  /0.0322", RooArgSet(Bratio, nsig_mode0 ));	RooRealVar nbkg0_sig("nbkg0_sig", "bkg number of mode0 sig", 0.05 * data0_sig->numEntries(), 0, 1.2 * data0_sig->numEntries());
    RooFormulaVar nsig_mode1_sig("nsig_mode1_sig", "signal of mode1 sig", "Bratio * nsig_mode1* 0.085359238  *0.0284/  0.449239622  /0.0299", RooArgSet(Bratio, nsig_mode1 ));	RooRealVar nbkg1_sig("nbkg1_sig", "bkg number of mode1 sig", 0.05 * data1_sig->numEntries(), 0, 1.2 * data1_sig->numEntries());
    RooFormulaVar nsig_mode2_sig("nsig_mode2_sig", "signal of mode2 sig", "Bratio * nsig_mode2* 0.085359238  *0.0283/  0.449239622  /0.0299", RooArgSet(Bratio, nsig_mode2 ));	RooRealVar nbkg2_sig("nbkg2_sig", "bkg number of mode2 sig", 0.05 * data2_sig->numEntries(), 0, 1.2 * data2_sig->numEntries());
    RooFormulaVar nsig_mode3_sig("nsig_mode3_sig", "signal of mode3 sig", "Bratio * nsig_mode3* 0.085359238  *0.0283/  0.449239622  /0.0297", RooArgSet(Bratio, nsig_mode3 ));	RooRealVar nbkg3_sig("nbkg3_sig", "bkg number of mode3 sig", 0.05 * data3_sig->numEntries(), 0, 1.2 * data3_sig->numEntries());
    RooFormulaVar nsig_mode4_sig("nsig_mode4_sig", "signal of mode4 sig", "Bratio * nsig_mode4* 0.085359238  *0.0280/  0.449239622  /0.0290", RooArgSet(Bratio, nsig_mode4 ));	RooRealVar nbkg4_sig("nbkg4_sig", "bkg number of mode4 sig", 0.05 * data4_sig->numEntries(), 0, 1.2 * data4_sig->numEntries());
    RooFormulaVar nsig_mode5_sig("nsig_mode5_sig", "signal of mode5 sig", "Bratio * nsig_mode5* 0.085359238  *0.0280/  0.449239622  /0.0289", RooArgSet(Bratio, nsig_mode5 ));	RooRealVar nbkg5_sig("nbkg5_sig", "bkg number of mode5 sig", 0.05 * data5_sig->numEntries(), 0, 1.2 * data5_sig->numEntries());
    RooFormulaVar nsig_mode6_sig("nsig_mode6_sig", "signal of mode6 sig", "Bratio * nsig_mode6* 0.085359238  *0.0279/  0.449239622  /0.0289", RooArgSet(Bratio, nsig_mode6 ));	RooRealVar nbkg6_sig("nbkg6_sig", "bkg number of mode6 sig", 0.05 * data6_sig->numEntries(), 0, 1.2 * data6_sig->numEntries());
    ...
    if(0)
    {
        ...
        frame_mode_ref->SetXTitle("M_{BC} (GeV)");
