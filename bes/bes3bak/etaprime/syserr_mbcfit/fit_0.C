...
int main(int args, char **argv )
{
    ...
    RooRealVar m0_sig("m0_sig", "m0_sig", 0.0005 + 2.299765);   RooRealVar c0_sig("c0_sig", "c0_sig", -2.1266e+01, -70, 20);    RooArgusBG argus0_sig("argus0_sig", "argus0 sig", *var_4600, m0_sig, c0_sig);
    RooRealVar m1_sig("m1_sig", "m1_sig", 0.0005 + 2.30579);    RooRealVar c1_sig("c1_sig", "c1_sig", -6.0660e+00, -70, 20);    RooArgusBG argus1_sig("argus1_sig", "argus1 sig", *var_4612, m1_sig, c1_sig);
    RooRealVar m2_sig("m2_sig", "m2_sig", 0.0005 + 2.31387);    RooRealVar c2_sig("c2_sig", "c2_sig", -4.9716e+00, -70, 20);    RooArgusBG argus2_sig("argus2_sig", "argus2 sig", *var_4620, m2_sig, c2_sig);
    RooRealVar m3_sig("m3_sig", "m3_sig", 0.0005 + 2.320255);   RooRealVar c3_sig("c3_sig", "c3_sig", -2.4289e+00, -70, 20);    RooArgusBG argus3_sig("argus3_sig", "argus3 sig", *var_4640, m3_sig, c3_sig);
    RooRealVar m4_sig("m4_sig", "m4_sig", 0.0005 + 2.33046);    RooRealVar c4_sig("c4_sig", "c4_sig", -2.2689e+01, -70, 20);    RooArgusBG argus4_sig("argus4_sig", "argus4 sig", *var_4660, m4_sig, c4_sig);
    RooRealVar m5_sig("m5_sig", "m5_sig", 0.0005 + 2.34079);    RooRealVar c5_sig("c5_sig", "c5_sig", -9.3432e+00, -70, 20);    RooArgusBG argus5_sig("argus5_sig", "argus5 sig", *var_4680, m5_sig, c5_sig);
    RooRealVar m6_sig("m6_sig", "m6_sig", 0.0005 + 2.34919);    RooRealVar c6_sig("c6_sig", "c6_sig", -7.9593e+00, -70, 20);    RooArgusBG argus6_sig("argus6_sig", "argus6 sig", *var_4700, m6_sig, c6_sig);

    // ____________________ ref argus background
    RooRealVar m0("m0", "m0", 0.0005 + 2.299765);   RooRealVar c0("c0", "c0", -7.5954e+0,  -70, 20);    RooArgusBG argus0("argus0", "argus0", *var_4600, m0, c0);
    RooRealVar m1("m1", "m1", 0.0005 + 2.30579);    RooRealVar c1("c1", "c1", 1.4943e+01,  -70, 20);    RooArgusBG argus1("argus1", "argus1", *var_4612, m1, c1);
    RooRealVar m2("m2", "m2", 0.0005 + 2.31387);    RooRealVar c2("c2", "c2", 2.9315e+00,  -70, 20);    RooArgusBG argus2("argus2", "argus2", *var_4620, m2, c2);
    RooRealVar m3("m3", "m3", 0.0005 + 2.320255);   RooRealVar c3("c3", "c3", -3.1054e+00, -70, 20);    RooArgusBG argus3("argus3", "argus3", *var_4640, m3, c3);
    RooRealVar m4("m4", "m4", 0.0005 + 2.33046);    RooRealVar c4("c4", "c4", -4.8423e+00, -70, 20);    RooArgusBG argus4("argus4", "argus4", *var_4660, m4, c4);
    RooRealVar m5("m5", "m5", 0.0005 + 2.34079);    RooRealVar c5("c5", "c5", -4.3007e+00, -70, 20);    RooArgusBG argus5("argus5", "argus5", *var_4680, m5, c5);
    RooRealVar m6("m6", "m6", 0.0005 + 2.34919);    RooRealVar c6("c6", "c6", -5.4013e+00, -70, 20);    RooArgusBG argus6("argus6", "argus6", *var_4700, m6, c6);
