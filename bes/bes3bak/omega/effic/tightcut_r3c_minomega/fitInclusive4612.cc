...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4612signal_selB.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minomega/4612shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_minomega/4612_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 6.62037e-07, 0, 6.62037e-07+(4.02009e-09*5));
  RooRealVar mean("mean", "mean", -3.18072e-05, -3.18072e-05-(2.95195e-07*5), -3.18072e-05+(2.95195e-07*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4612signal.root");
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4612_Lc2omega.pdf");
