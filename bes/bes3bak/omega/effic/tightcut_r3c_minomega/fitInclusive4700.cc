...
int fitInclusive4700()
{
  ...
  RooRealVar sigma("sigma", "sigma", 4.57816e-06, 0, 4.57816e-06+(0.000550236*5));
  RooRealVar mean("mean", "mean", 5.72757e-05, 5.72757e-05-(0.000188403*5), 5.72757e-05+(0.000188403*5));
  ...
  pt->Draw();
  canv1->Update();
  canv1->SaveAs("effic4700_Lc2omega.pdf");
