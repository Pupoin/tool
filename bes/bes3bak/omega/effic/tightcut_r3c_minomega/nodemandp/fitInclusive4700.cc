...
int fitInclusive4700()
{
  ...
  RooRealVar sigma("sigma", "sigma", 3.98604e-07, 0, 3.98604e-07+(2.08213e-10*5));
  RooRealVar mean("mean", "mean", 6.49713e-05, 6.49713e-05-(3.02217e-07*5), 6.49713e-05+(3.02217e-07*5));
