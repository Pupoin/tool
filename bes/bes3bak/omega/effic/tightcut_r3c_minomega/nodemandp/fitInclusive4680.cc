...
int fitInclusive4680()
{
  ...
  RooRealVar sigma("sigma", "sigma", 6.79878e-06, 0, 6.79878e-06+(0.00088626*5));
  RooRealVar mean("mean", "mean", -5.09197e-05, -5.09197e-05-(0.000109922*5), -5.09197e-05+(0.000109922*5));
