...
int fitInclusive4680()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4680signal_selB_covGaus.root");
  ...
  RooRealVar sigma("sigma", "sigma", 1.4201e-05, -0.0001, 0.001);
  RooRealVar mean("mean", "mean", 6.3911e-05, -0.001, 0.002);
