...
int fitInclusive4700()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4700signal_selB_covGaus.root");
  ...
  RooRealVar mean("mean", "mean", 4.1771e-05, -0.00, 0.001);
