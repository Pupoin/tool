...
int fitInclusive4640()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4640signal_selB_covGaus.root");
  ...
  RooRealVar sigma("sigma", "sigma", 2.9389e-05, -0.0, 0.001);
  RooRealVar mean("mean", "mean", 2.5983e-05,  -0.001, 0.001);
