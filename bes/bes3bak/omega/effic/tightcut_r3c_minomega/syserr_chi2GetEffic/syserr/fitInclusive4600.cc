...
int fitInclusive4600()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4600signal_selB_covGaus.root");
  ...
  RooRealVar sigma("sigma", "sigma", 4.1999e-04, -0.000, 0.001);
  RooRealVar mean("mean", "mean", 3.2295e-05, -0.00, 0.001);
