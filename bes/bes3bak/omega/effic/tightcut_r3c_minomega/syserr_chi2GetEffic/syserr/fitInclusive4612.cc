...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4612signal_selB_covGaus.root");
  ...
  RooRealVar sigma("sigma", "sigma", 2.8238e-06, -0.0000, 0.00001);
  RooRealVar mean("mean", "mean", -1.9158e-05, -0.001, 0.00);
