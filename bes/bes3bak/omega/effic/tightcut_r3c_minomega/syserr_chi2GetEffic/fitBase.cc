...
int fitInclusive_energy_()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/_energy_signal_selB.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minomega/_energy_shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_minomega/_energy__ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 5.9140e-04, -0.0, 0.001);
  RooRealVar mean("mean", "mean", 5.4896e-05, -0.001, 0.001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/_energy_signal.root");
