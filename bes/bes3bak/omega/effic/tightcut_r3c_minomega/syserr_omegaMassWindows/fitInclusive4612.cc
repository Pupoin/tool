...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4612signal_covGausOmegaMass.root");
  ...
  RooRealVar sigma("sigma", "sigma", 3.15327e-07, 0, 3.15327e-07+(0.00010718*5));
  RooRealVar mean("mean", "mean", -3.47934e-05, -3.47934e-05-(2.64975e-08*5), -3.47934e-05+(2.64975e-08*5));
