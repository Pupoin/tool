...
int fitInclusive4660()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4660signal_covGausOmegaMass.root");
  ...
  RooRealVar sigma("sigma", "sigma", 2.86738e-06, 0, 2.86738e-06+(4.34765e-09*5));
  RooRealVar mean("mean", "mean", 7.46078e-05, 7.46078e-05-(0.00153344*5), 7.46078e-05+(0.00153344*5));
