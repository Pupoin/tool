...
int fitInclusive4700()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4700signal_selB.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minomega/4700shape.root");
  ...
  RooRealVar sigma("sigma", "sigma", 2.96292e-07, 0, 2.96292e-07+(4.34601e-09*5));
  RooRealVar mean("mean", "mean", 5.93934e-05, 5.93934e-05-(4.8279e-07*5), 5.93934e-05+(4.8279e-07*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4700signal.root");
  ...
  // pt->SetLineColor(5);
  // pt->SetTextColor(5);
  pt->InsertText("#sqrt{s}=4698 GeV");
  pt->InsertText(TString::Format("effic = %.2f %%", ISIG/all*100.));
	pt->SetTextAlign(12);

  pt->Draw();
  c1->Update();
  c1->SaveAs("effic4698.pdf");
  c1->SaveAs("effic4698.png");
