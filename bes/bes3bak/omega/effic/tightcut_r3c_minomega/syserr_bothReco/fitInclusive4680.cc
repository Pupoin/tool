...
int fitInclusive4680()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4680signal_selB.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_minomega/4680shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_minomega/4680_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 3.47606e-06, 0, 3.47606e-06+(8.94617e-05*5));
  RooRealVar mean("mean", "mean", 5.62054e-05, 5.62054e-05-(3.4514e-05*5), 5.62054e-05+(3.4514e-05*5));
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minomega/4680signal.root");
