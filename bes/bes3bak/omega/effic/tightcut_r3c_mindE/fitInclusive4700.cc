...
int fitInclusive4700()
{
  ...
  chain_data->Add("../../signal/cutmassroot/tightcut_r3c_mindE/4700signal.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_mindE/4700shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("../../pdf/tightcut_r3c_mindE/4700_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 5.9140e-04, -0.0, 0.003);
  RooRealVar mean("mean", "mean", 5.4896e-05, -0.0, 0.0001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4700signal.root");
