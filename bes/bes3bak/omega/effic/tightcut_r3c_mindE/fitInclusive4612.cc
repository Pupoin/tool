...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4612signal.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_mindE/4612shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_mindE/4612_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 4.5296e-05, -0.0, 0.00005);
  RooRealVar mean("mean", "mean", 2.6278e-05, 1.5054e-05, 0.0003);
  ...
  RooRealVar p("p", "p", 1);
  RooRealVar c("c", "c", -7.4859e+01, -100, 100);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4612signal.root");
