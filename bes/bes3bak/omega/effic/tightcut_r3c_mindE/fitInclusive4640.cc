...
int fitInclusive4640()
{
  ...
  // TCut cut_deltaE = "(chi2_min_r3c<38)";
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4640signal.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_mindE/4640shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_mindE/4640_ref_shapepdf.root");
  ...
  RooRealVar mean("mean", "mean", 2.5983e-05,  -0.00, 0.0001);
  ...
  c1->SetMargin(0.13, 0.13, 0.13, 0.1);// c1.SetFillColor( 42 )  
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4640signal.root");
