...
int fitInclusive4620()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4620signal.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_mindE/4620shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_mindE/4620_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 4.1269e-04, -0.0, 0.00051);
  RooRealVar mean("mean", "mean", 6.1488e-05, -0.00, 0.0001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4620signal.root");
