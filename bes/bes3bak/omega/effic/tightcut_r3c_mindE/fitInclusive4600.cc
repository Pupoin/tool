...
int fitInclusive4600()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4600signal.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_mindE/4600shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_mindE/4600_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 1.0199e-07, -0.00, 0.0001);
  RooRealVar mean("mean", "mean", 8.5628e-05, -0.0001, 0.00021);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4600signal.root");
