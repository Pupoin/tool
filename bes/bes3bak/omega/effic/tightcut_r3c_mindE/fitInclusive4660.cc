...
int fitInclusive4660()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4660signal.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_r3c_mindE/4660shape.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_mindE/4660_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 0.0003076298, -0.00, 0.001);
  RooRealVar mean("mean", "mean", 3.8830e-05, -0.00, 0.0001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_mindE/4660signal.root");
