void signi_eff4600()
{
	...
	//double all_1 = chain_data->GetEntries("(ndaughterAp == 11 && Ap_id[0] == 3222 && Ap_id[1] == 331 && Ap_id[2] == 2212 && Ap_id[3] == 111 && Ap_id[4] == 211 && Ap_id[5] == -211 && Ap_id[6] == 221 && Ap_id[7] == 22 && Ap_id[8] == 22 && Ap_id[9] == 22 && Ap_id[10] == 22)");
	//double all_2 = chain_data->GetEntries("(ndaughterAm == 11 && Am_id[0] == -3222 && Am_id[1] == 331 && Am_id[2] == -2212 && Am_id[3] == 111 && Am_id[4] == 211 && Am_id[5] == -211 && Am_id[6] == 221 && Am_id[7] == 22 && Am_id[8] == 22 && Am_id[9] == 22 && Am_id[10] == 22)");
