...
int fitInclusive4612()
{
  ...
  chain_data->Add("../../signal/cutmassroot/zhou/4612signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/zhou/4612shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("../../pdf/zhou/4612_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 2.0302e-04, -0.0, 0.001);
  RooRealVar mean("mean", "mean", -4.4923e-05);// -0.01, 0.01);
  ...
  // pt->SetLineColor(5);
  // pt->SetTextColor(5);
  TText *text = pt->AddText("E=4.612 GeV");
  pt->Draw();
  c1->Update();
  ...
  c1->SaveAs("pic_fitInclusive4612.svg");
  return 0;
}
