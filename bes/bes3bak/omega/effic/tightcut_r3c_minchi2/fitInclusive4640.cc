...
int fitInclusive4640()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4640signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_minchi2/4640_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 2.9389e-05, -0.0, 0.003);
  RooRealVar mean("mean", "mean", 2.5983e-05,  -0.03, 0.003);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4640signal.root");
