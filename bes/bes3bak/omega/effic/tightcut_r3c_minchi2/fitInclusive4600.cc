...
int fitInclusive4600()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4600signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_minchi2/4600_ref_shapepdf.root");
  ...
  RooRealVar mean("mean", "mean", 8.5628e-05, -0.001, 0.0021);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4600signal.root");
