...
int fitInclusive4660()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4660signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_minchi2/4660_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 1.0555e-05, -0.00, 0.0001);
  RooRealVar mean("mean", "mean", -1.5453e-05, -0.0001, 0.00);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4660signal.root");
