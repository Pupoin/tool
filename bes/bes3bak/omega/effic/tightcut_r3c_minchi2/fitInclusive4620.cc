...
int fitInclusive4620()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4620signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_minchi2/4620_ref_shapepdf.root");
  ...
  RooRealVar mean("mean", "mean", -8.4237e-05, -0.001, 0.0);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4620signal.root");
