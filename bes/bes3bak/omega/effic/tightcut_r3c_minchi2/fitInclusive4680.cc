...
int fitInclusive4680()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4680signal.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_r3c_minchi2/4680_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 7.6537e-06, -0.0, 0.003);
  RooRealVar mean("mean", "mean", -7.7961e-05, -0.003, 0.003);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4680signal.root");
