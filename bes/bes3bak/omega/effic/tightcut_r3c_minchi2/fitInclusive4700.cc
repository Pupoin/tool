...
int fitInclusive4700()
{
  ...
  TFile *file_sig_pdf = TFile::Open("../../pdf/tightcut_r3c_minchi2/4700_ref_shapepdf.root");
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_r3c_minchi2/4700signal.root");
