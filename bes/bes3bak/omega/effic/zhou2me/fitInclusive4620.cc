...
int fitInclusive4620()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/zhou2me/4620signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/zhou2me/4620shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/zhou2me/4620_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 2.4697e-06, -0.0, 0.0021);
  RooRealVar mean("mean", "mean", -3.6578e-04, -0.001, 0.00);
  ...
  sumpdf.Print("t");
  M_BC->setRange("signal", 2.25, 2.31387);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/zhou2me/4620signal.root");
