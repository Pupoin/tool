...
int fitInclusive4700()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_zhou2me/4700signal_removedouble.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_zhou2me/4700_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 0.0003076298, -0.0, 0.001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_zhou2me/4700signal.root");
