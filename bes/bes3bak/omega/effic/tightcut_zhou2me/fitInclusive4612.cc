...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_zhou2me/4612signal_removedouble.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/tightcut_zhou2me/4612shape_removedouble.root");
  // TTree *tr_fit = chain_shape->CopyTree(cut_sum1, "");
  // RooRealVar *M_BC = new RooRealVar("M_BC", "M_BC", 2.25, 2.30579, "");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/tightcut_zhou2me/4612_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 1.1913e-05, -0.0, 0.0002);
  RooRealVar mean("mean", "mean", 0, -0.001, 0.00001);
  ...
  sumpdf.Print("t");
  M_BC->setRange("signal", 2.25, 2.30579);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/tightcut_zhou2me/4612signal.root");
