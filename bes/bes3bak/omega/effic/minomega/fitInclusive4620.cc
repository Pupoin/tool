...
int fitInclusive4620()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/minomega/4620signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/minomega/4620shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4620_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 6.2107e-04, -0.0, 0.0008);
  RooRealVar mean("mean", "mean", -2.3195e-05);//, -0.001, 0.001);
  ...
  sumpdf.Print("t");
  M_BC_1c->setRange("signal", 2.25, 2.31387);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/minomega/4620signal.root");
