...
int fitInclusive4700()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/minomega/4700signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/minomega/4700shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4700_ref_shapepdf.root");
  ...
  sumpdf.Print("t");
  M_BC_1c->setRange("signal", 2.25, 2.34919);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/minomega/4700signal.root");
