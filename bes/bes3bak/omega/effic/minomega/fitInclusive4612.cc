...
int fitInclusive4612()
{
  ...
  chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/minomega/4612signal_mass.root");
  ...
  // chain_shape->Add("../shape/cutmassroot/minomega/4612shape_mass.root");
  ...
  TFile *file_sig_pdf = TFile::Open("/publicfs/ucas/user/yuanchy8/7.0.6/omega/pdf/minomega/4612_ref_shapepdf.root");
  ...
  RooRealVar sigma("sigma", "sigma", 2.9046e-04, -0.0, 0.00041);
  RooRealVar mean("mean", "mean", -3.6295e-07);//, -0.001, 0.001);
  ...
  chain_datatruth->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/signal/cutmassroot/minomega/4612signal.root");
