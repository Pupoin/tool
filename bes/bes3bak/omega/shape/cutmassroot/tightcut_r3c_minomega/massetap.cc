...
int massetap()
{
    ...
    chain_massetap->Project("hist_massetap", "etaprimemr3c", "M_BC_r3c>2.25");
    ...
    // hist_massetap->GetXaxis()->SetNdifvisions(205); 


    
    hist_massetap->Draw();

    TArrow *ar2 = new TArrow(0.76,50,0.76,6000,0.02,"<|");
    ar2->SetAngle(40);
    ar2->SetLineWidth(2);
    ar2->SetLineColor(4);
    ar2->SetFillColor(4);
    ...
    TArrow *ar3 = new TArrow(0.8,50,0.8,6000,0.02,"<|");
    ar3->SetAngle(40);
    ar3->SetLineWidth(2);
    ar3->SetLineColor(4);
    ar3->SetFillColor(4);
    ...
    canva1->SaveAs("m_omega.png");
    canva1->SaveAs("m_omega.pdf");
