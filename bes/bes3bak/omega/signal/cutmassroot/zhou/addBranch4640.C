...
void addBranch4640() {
  ...
  TFile *f = new TFile("4640signal_mass.root" , "update");
  ...
  for (int i = 0; i < t->GetEntries(); i++)
  {
    t->GetEvent(i);
    new_signal = 999;
    if (ndaughterAm == 11 && Am_id[0] == -3222 && Am_id[1] == 223 && Am_id[2] == -2212 && Am_id[3] == 111 && Am_id[4] == -211 && Am_id[5] == 211 && Am_id[6] == 111 && Am_id[7] == 22 && Am_id[8] == 22 &&Am_id[9] == 22 && Am_id[10] == 22)
    {
        new_signal = -1;
    }
    if(ndaughterAp == 11 && Ap_id[0] == 3222 && Ap_id[1] == 223 && Ap_id[2] == 2212 && Ap_id[3] == 111 &&  Ap_id[4] == -211 && Ap_id[5] == 211 && Ap_id[6] == 111 && Ap_id[7] == 22 && Ap_id[8] == 22 && Ap_id[9] == 22 && Ap_id[10] == 22)
    {
        new_signal = 1;
    }
    newBranch->Fill();
