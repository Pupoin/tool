...
// select branch
void covGausEtapMass4640()
{
    ROOT::RDataFrame rdf("tree", "4640signal.root");
    ...
    rdf2.Snapshot("tree", "4640signal_covGausOmegaMass.root", branchList );

    // rdf2.Snapshot("tree", "4640signal_covGausEtapMass.C.C.root" );
