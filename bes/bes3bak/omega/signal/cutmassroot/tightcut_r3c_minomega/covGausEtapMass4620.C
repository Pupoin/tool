...
void covGausEtapMass4620()
{
    ...
    rdf2.Snapshot("tree", "4620signal_covGausOmegaMass.root", branchList );

    // rdf2.Snapshot("tree", "4620signal_covGausEtapMass.C.C.root" );
    //rdf2.Snapshot("tree", "4620signal_rmLc.root");
