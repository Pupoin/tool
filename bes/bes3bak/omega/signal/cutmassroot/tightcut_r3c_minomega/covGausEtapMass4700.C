...
// select branch
void covGausEtapMass4700()
{
    ROOT::RDataFrame rdf("tree", "4700signal.root");
    ...
    rdf2.Snapshot("tree", "4700signal_covGausOmegaMass.root", branchList );

    // rdf2.Snapshot("tree", "4700signal_covGausEtapMass.C.C.root" );
    //rdf2.Snapshot("tree", "4700signal_rmLc.root");
