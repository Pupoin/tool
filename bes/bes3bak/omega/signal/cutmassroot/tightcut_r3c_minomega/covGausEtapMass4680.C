...
// select branch
void covGausEtapMass4680()
{
    ROOT::RDataFrame rdf("tree", "4680signal.root");
    ...
    rdf2.Snapshot("tree", "4680signal_covGausOmegaMass.root", branchList );

    // rdf2.Snapshot("tree", "4680signal_covGausEtapMass.C.C.root" );
    //rdf2.Snapshot("tree", "4680signal_rmLc.root");
