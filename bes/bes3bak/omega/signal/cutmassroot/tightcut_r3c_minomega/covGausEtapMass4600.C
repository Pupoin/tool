...
// select branch
void covGausEtapMass4600()
{
    ROOT::RDataFrame rdf("tree", "4600signal.root");
    ...
    rdf2.Snapshot("tree", "4600signal_covGausOmegaMass.root", branchList );

    // rdf2.Snapshot("tree", "4600signal_covGausEtapMass.C.C.root" );
    //rdf2.Snapshot("tree", "4600signal_rmLc.root");
