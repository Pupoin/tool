...
int plot_mbc4612()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/zhou2me/4612LL_mass.root");
    chain_data->Add(     "/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/zhou2me/4612data_mass.root");
    chain_hardon->Add(   "/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/zhou2me/4612hadron_mass.root");
    ...
    TCut cut_mbc = "((M_BC>=2.25) && (M_BC<=2.30579))";
