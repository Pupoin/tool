...
int plot_sigma()
{
    ...
    // chain_data->Project("hist_data", "sigmamr3c", cut_sum1);
    //TCut cut_mode = ("mode1==0 && mode2==0 && mode3==96");
    //chain_hardon->Project("hist_hardon", "sigmamr3c", cut_sum1 && "indexmc==0");
    // chain_hardon->Project("hist_hardon", "sigmamr3c", cut_sum1);

    auto chain_inclusive_bkg = chain_inclusive;
    auto chain_inclusive_sig = chain_inclusive;
    chain_inclusive_bkg->Project("hist_inclusive_bkg", "sigmamr3c", cut_inclusive_bkg && cut_sum1);
    chain_inclusive_sig->Project("hist_inclusive_sig", "sigmamr3c", cut_inclusive_sig && cut_sum1);
