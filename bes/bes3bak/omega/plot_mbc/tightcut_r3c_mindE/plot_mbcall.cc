...
int plot_mbcall()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/tightcut_r3c_mindE/LL.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/tightcut_r3c_mindE/data.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/tightcut_r3c_mindE/hadron.root");
