...
int plot_mbc4620()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/minomega/4620LL_mass.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4620data_mass.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/minomega/4620hadron_mass.root");
    ...
    canv1->Update();
    canv1->SaveAs("stack4628.pdf");
    canv1->SaveAs("stack4628.png");
    return 0;
}
