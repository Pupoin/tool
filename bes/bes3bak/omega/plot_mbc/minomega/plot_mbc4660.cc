...
int plot_mbc4660()
{
    ...
    // setStyle();
    // setPad();
    double factor[2] = {0.03750, 0.03750};
    ...
    double xmin = 2.25, xmax = 2.3304600;
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/minomega/4660LL_mass.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4660data_mass.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/minomega/4660hadron_mass.root");
    ...
    TCut cut_mbc = "((M_BC_1c>=2.25) && (M_BC_1c<=2.3304600))";
    ...
    legend->SetHeader("#sqrt{s}=4661 GeV");
    ...
    canv1->Update();
    canv1->SaveAs("stack4661.pdf");
    canv1->SaveAs("stack4661.png");
    return 0;
}
