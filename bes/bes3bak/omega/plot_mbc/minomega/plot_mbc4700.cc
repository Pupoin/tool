...
int plot_mbc4700()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/minomega/4700LL_mass.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4700data_mass.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/minomega/4700hadron_mass.root");
    ...
    legend->SetHeader("#sqrt{s}=4698 GeV");
    ...
    canv1->Update();
    canv1->SaveAs("stack4698.pdf");
    canv1->SaveAs("stack4698.png");
    return 0;
}
