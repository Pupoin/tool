...
int plot_mbc4612()
{
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/minomega/4612LL_mass.root");
    chain_data->Add(     "/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/minomega/4612data_mass.root");
    chain_hardon->Add(   "/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/minomega/4612hadron_mass.root");
    ...
    legend->SetHeader("#sqrt{s}=4612 GeV");
    ...
    canv1->Update();
    canv1->SaveAs("stack4612.pdf");
    canv1->SaveAs("stack4612.png");
    return 0;
}
