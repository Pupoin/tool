...
int plot_mbc4620()
{
    ...
    // setStyle();
    // setPad();
    double factor[2] = {0.018050, 0.0250};
    ...
    chain_inclusive->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/tightcut_r3c_minchi2/4620LL.root");
    chain_data->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/data/cutmassroot/tightcut_r3c_minchi2/4620data.root");
    chain_hardon->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/tightcut_r3c_minchi2/4620hadron_mode.root");
