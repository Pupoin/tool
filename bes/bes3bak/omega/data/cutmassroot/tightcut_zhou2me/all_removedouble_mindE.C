...
sed -i "s|AAA|4600data|" -i removedouble_mindE4600.C
...
sed -i "s|AAA|4612data|" -i removedouble_mindE4612.C
...
sed -i "s|AAA|4620data|" -i removedouble_mindE4620.C
...
sed -i "s|AAA|4640data|" -i removedouble_mindE4640.C
...
sed -i "s|AAA|4660data|" -i removedouble_mindE4660.C
...
sed -i "s|AAA|4680data|" -i removedouble_mindE4680.C
...
sed -i "s|AAA|4700data|" -i removedouble_mindE4700.C
