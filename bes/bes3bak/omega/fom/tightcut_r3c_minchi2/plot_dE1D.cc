...
int plot_dE1D()
{
    ...
    chain->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/fom/tightcut_r3c_minchi2/fom.root");
    ...
    hist->SetTitleSize(0.051,"xy");

    TArrow *ar2 = new TArrow(27 ,90, 27, 34 ,0.025,"|>");
    ar2->SetAngle(40);
    ar2->SetLineWidth(2);
    ar2->Draw();
