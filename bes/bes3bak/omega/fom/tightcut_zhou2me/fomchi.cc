...
int fomchi()
{
    ...
    chain->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/tightcut_zhou2me/LL.root"); 
    chain->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/tightcut_zhou2me/hadron.root"); 
    ...
    {        
        ...
        {
            char b[50];
            sprintf(b, "(%2.3f<deltaE_min && deltaE_min<%2.3f)", down, up);
            deltaE = b;
