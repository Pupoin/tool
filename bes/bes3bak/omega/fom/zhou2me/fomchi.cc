...
int fomchi()
{
    ...
    chain->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/zhou2me/LL_mass.root"); 
    chain->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/zhou2me/hadron_mass.root"); 
