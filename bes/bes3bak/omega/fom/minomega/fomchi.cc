...
int fomchi()
{
    ...
    chain->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/LL/cutmassroot/minomega/LL_mass.root"); 
    chain->Add("/publicfs/ucas/user/yuanchy8/7.0.6/omega/hadron/cutmassroot/minomega/hadron_mass.root"); 
    ...
    {        
        ...
        {
            char b[50];
            sprintf(b, "(%2.3f<deltaE_min_1c && deltaE_min_1c <%2.3f)", down, up);
            deltaE = b;
